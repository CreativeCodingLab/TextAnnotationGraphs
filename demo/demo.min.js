...
"use strict";var ___classCallCheck2_85=_$interopRequireDefault_9(_$classCallCheck_7),_createClass2=_$interopRequireDefault_9(_$createClass_8),WordTag=function(){function WordTag(val,word,config){var top=!(arguments.length>3&&void 0!==arguments[3])||arguments[3];if((0,___classCallCheck2_85.default)(this,WordTag),this.val=val,this.word=word,this.config=config,this.top=top,!word.svg)throw"Error: Trying to initialise WordTag on Word without SVG element";this.draw()}return(0,_createClass2.default)(WordTag,[{key:"draw",value:function(){var newY,_this=this;this.svg&&this.remove(),this.svg=this.word.svg.group(),this.svgText=this.svg.text(this.val).addClass("tag-element").addClass(this.top?"word-tag":"word-tag syntax-tag").leading(1),this.svgText.x(this.word.svgText.x()),newY=this.top?-this.word.svgText.bbox().height-this.svgText.bbox().height-this.config.wordTopTagPadding:this.config.wordBottomTagPadding,this.svgText.y(newY),this.ww=this.svgText.length();var mainSvg=this.word.mainSvg;this.svgText.node.oncontextmenu=function(e){e.preventDefault(),mainSvg.fire("tag-right-click",{object:_this,event:e})},this.svgText.click(function(e){return mainSvg.fire("tag-edit",{object:_this})}),this.line=this.svg.path(),this.drawTagLine()}},{key:"remove",value:function(){this.svg.remove(),this.svg=null}},{key:"drawTagLine",value:function(){if(this.top){var wordWidth=this.word.textWidth;if(wordWidth<this.config.wordBraceThreshold)this.line.plot("M 0,0, 0,"+this.config.wordTagLineLength);else{var height=this.config.wordTagLineLength,arm=wordWidth/2;this.line.plot("M0,0c"+[0,height,arm,0,arm,height]+"M0,0c"+[0,height,-arm,0,-arm,height])}this.line.cx(this.svgText.cx()),this.line.cy((this.svgText.bbox().y2+this.word.svgText.bbox().y)/2)}}},{key:"text",value:function(val){if(void 0===val)return this.svgText;if(this.val=val,this.svgText.text(this.val),this.ww=this.svgText.length(),this.editingRect){var bbox=this.svgText.bbox();bbox.width>0?this.editingRect.width(bbox.width+8).height(bbox.height+4).x(bbox.x-4).y(bbox.y-2):this.editingRect.width(10).x(-5)}}},{key:"boxWidth",value:function(){return this.svg.bbox().width}},{key:"changeEntity",value:function(word){this.word&&(this.word.tag=null),this.word=word,this.word.tag=this,this.word.svg.add(this.svg)}},{key:"listenForEdit",value:function(){this.isEditing=!0;var bbox=this.svgText.bbox();this.svg.addClass("tag-element").addClass("editing"),this.editingRect=this.svg.rect(bbox.width+8,bbox.height+4).x(bbox.x-4).y(bbox.y-2).rx(2).ry(2).back()}},{key:"stopEditing",value:function(){this.isEditing=!1,this.svg.removeClass("editing"),this.editingRect.remove(),this.editingRect=null,this.val=this.val.trim(),this.val?this.word.alignBox():this.remove()}},{key:"drawBbox",value:function(){var bbox=this.svg.bbox();this.svg.polyline([[bbox.x,bbox.y],[bbox.x2,bbox.y],[bbox.x2,bbox.y2],[bbox.x,bbox.y2],[bbox.x,bbox.y]]).fill("none").stroke({width:1})}},{key:"drawTextBbox",value:function(){var bbox=this.svgText.bbox();this.svg.polyline([[bbox.x,bbox.y],[bbox.x2,bbox.y],[bbox.x2,bbox.y2],[bbox.x,bbox.y2],[bbox.x,bbox.y]]).fill("none").stroke({width:1})}},{key:"textWidth",get:function(){return this.svgText.bbox().width}}]),WordTag}();var _$WordTag_85=WordTag;
...
"use strict";var ___classCallCheck2_86=_$interopRequireDefault_9(_$classCallCheck_7),___createClass2_86=_$interopRequireDefault_9(_$createClass_8),_wordTag=_$interopRequireDefault_9(_$WordTag_85),Word=(_$interopRequireWildcard_10(_$svg_81),_$interopRequireWildcard_10(_$svgDraggable_80),function(){function Word(text,idx){(0,___classCallCheck2_86.default)(this,Word),this.text=text,this.idx=idx,this.eventIds=[],this.syntaxId="",this.tagText="",this.syntaxTagText="",this.tag=null,this.syntaxTag=null,this.clusters=[],this.links=[],this.row=null,this.passingLinks=[],this.initialised=null,this.mainSvg=null,this.config=null,this.svg=null,this.x=0}return(0,___createClass2_86.default)(Word,[{key:"addEventId",value:function(id){this.eventIds.indexOf(id)<0&&this.eventIds.push(id)}},{key:"setSyntaxId",value:function(id){this.syntaxId=id}},{key:"setTag",value:function(tag){this.tagText=tag,this.initialised&&(this.tag instanceof _wordTag.default&&this.tag.remove(),this.tag=new _wordTag.default(tag,this,this.config),this.tag.draw())}},{key:"setSyntaxTag",value:function(tag){this.syntaxTagText=tag,this.initialised&&(this.syntaxTag instanceof _wordTag.default&&this.syntaxTag.remove(),this.syntaxTag=new _wordTag.default(tag,this,this.config,!1),this.syntaxTag.draw())}},{key:"init",value:function(mainSvg,config){var _this=this;this.mainSvg=mainSvg,this.config=config,this.svg=mainSvg.group().addClass("tag-element").addClass("word"),this.svgText=this.svg.text(this.text).addClass("tag-element").addClass("word-text").leading(1),this.svgText.x(this.svgText.bbox().width/2),this.svgText.y(-this.svgText.bbox().height),!this.tagText||this.tag instanceof _wordTag.default||(this.tag=new _wordTag.default(this.tagText,this,this.config)),!this.syntaxTagText||this.syntaxTag instanceof _wordTag.default||(this.syntaxTag=new _wordTag.default(this.syntaxTagText,this,this.config,!1)),this.clusters.forEach(function(cluster){cluster.init(_this)}),this.alignBox();var x=0,mousemove=!1;this.svgText.draggable().on("dragstart",function(e){mousemove=!1,x=e.detail.p.x,mainSvg.fire("word-move-start")}).on("dragmove",function(e){e.preventDefault();var dx=e.detail.p.x-x;x=e.detail.p.x,mainSvg.fire("word-move",{object:_this,x:dx}),0!==dx&&(mousemove=!0)}).on("dragend",function(e){mainSvg.fire("word-move-end",{object:_this,clicked:!1===mousemove})}),this.svgText.dblclick(function(e){return mainSvg.fire("build-tree",{object:_this,event:e})}),this.svgText.node.oncontextmenu=function(e){e.preventDefault(),mainSvg.fire("word-right-click",{object:_this,event:e})}}},{key:"redrawLinks",value:function(){var _this2=this;this.links.forEach(function(l){return l.draw(_this2)}),this.redrawClusters()}},{key:"redrawClusters",value:function(){var _this3=this;this.clusters.forEach(function(cluster){cluster.endpoints.indexOf(_this3)>-1&&cluster.draw()})}},{key:"move",value:function(x){this.x=x,this.svg.transform({x:this.x}),this.redrawLinks()}},{key:"dx",value:function(x){this.move(this.x+x)}},{key:"alignBox",value:function(){var diff=-this.svg.bbox().x,_iteratorNormalCompletion=!0,_didIteratorError=!1,_iteratorError=void 0;try{for(var _step,_iterator=this.svg.children()[Symbol.iterator]();!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=!0){_step.value.dx(diff)}}catch(err){_didIteratorError=!0,_iteratorError=err}finally{try{_iteratorNormalCompletion||null==_iterator.return||_iterator.return()}finally{if(_didIteratorError)throw _iteratorError}}}},{key:"drawBbox",value:function(){var bbox=this.svg.bbox();this.svg.polyline([[bbox.x,bbox.y],[bbox.x2,bbox.y],[bbox.x2,bbox.y2],[bbox.x,bbox.y2],[bbox.x,bbox.y]]).fill("none").stroke({width:1})}},{key:"drawTextBbox",value:function(){var bbox=this.svgText.bbox();this.svg.polyline([[bbox.x,bbox.y],[bbox.x2,bbox.y],[bbox.x2,bbox.y2],[bbox.x,bbox.y2],[bbox.x,bbox.y]]).fill("none").stroke({width:1})}},{key:"boxWidth",get:function(){return this.svg.bbox().width}},{key:"boxHeight",get:function(){return-this.svg.bbox().y}},{key:"descendHeight",get:function(){return this.svg.bbox().y2}},{key:"absoluteY",get:function(){return this.row?this.row.ry+this.row.rh-this.boxHeight:this.boxHeight}},{key:"absoluteDescent",get:function(){return this.row?this.row.ry+this.row.rh+this.descendHeight:this.descendHeight}},{key:"cx",get:function(){return this.x+this.boxWidth/2}},{key:"textWidth",get:function(){return this.svgText.bbox().width}},{key:"isPunct",get:function(){return 1===this.text.length&&this.text.charCodeAt(0)<65}}]),Word}());var _$Word_86=Word;
