...
"use strict";var ___classCallCheck2_85=_$interopRequireDefault_8(_$classCallCheck_6),___createClass2_85=_$interopRequireDefault_8(_$createClass_7),_wordTag=_$interopRequireDefault_8(_$WordTag_84),Word=(_$interopRequireWildcard_9(_$svg_80),_$interopRequireWildcard_9(_$svgDraggable_79),function(){function Word(text,idx){(0,___classCallCheck2_85.default)(this,Word),this.text=text,this.idx=idx,this.eventIds=[],this.syntaxId="",this.tagText="",this.syntaxTagText="",this.tag=null,this.syntaxTag=null,this.clusters=[],this.links=[],this.row=null,this.initialised=null,this.mainSvg=null,this.config=null,this.svg=null,this.x=0,this.boxWidth=0,this.boxHeight=0,this.descendHeight=0}return(0,___createClass2_85.default)(Word,[{key:"addEventId",value:function(id){this.eventIds.indexOf(id)<0&&this.eventIds.push(id)}},{key:"setSyntaxId",value:function(id){this.syntaxId=id}},{key:"setTag",value:function(tag){this.tagText=tag,this.initialised&&(this.tag instanceof _wordTag.default&&this.tag.remove(),this.tag=new _wordTag.default(tag,this,this.config),this.tag.draw())}},{key:"setSyntaxTag",value:function(tag){this.syntaxTagText=tag,this.initialised&&(this.syntaxTag instanceof _wordTag.default&&this.syntaxTag.remove(),this.syntaxTag=new _wordTag.default(tag,this,this.config,!1),this.syntaxTag.draw())}},{key:"init",value:function(mainSvg,config){var _this=this;this.mainSvg=mainSvg,this.config=config,this.svg=mainSvg.group().addClass("tag-element").addClass("word"),this.svgText=this.svg.text(this.text).addClass("tag-element").addClass("word-text").leading(1),this.svgText.x(this.svgText.bbox().width/2),this.svgText.y(-this.svgText.bbox().height),!this.tagText||this.tag instanceof _wordTag.default||(this.tag=new _wordTag.default(this.tagText,this,this.config)),!this.syntaxTagText||this.syntaxTag instanceof _wordTag.default||(this.syntaxTag=new _wordTag.default(this.syntaxTagText,this,this.config,!1)),this.clusters.forEach(function(cluster){cluster.init(_this)}),this.alignBox();var x=0,mousemove=!1;this.svgText.draggable().on("dragstart",function(e){mousemove=!1,x=e.detail.p.x,mainSvg.fire("word-move-start")}).on("dragmove",function(e){e.preventDefault();var dx=e.detail.p.x-x;x=e.detail.p.x,mainSvg.fire("word-move",{object:_this,x:dx}),0!==dx&&(mousemove=!0)}).on("dragend",function(e){mainSvg.fire("word-move-end",{object:_this,clicked:!1===mousemove})}),this.svgText.dblclick(function(e){return mainSvg.fire("build-tree",{object:_this,event:e})}),this.svgText.node.oncontextmenu=function(e){e.preventDefault(),mainSvg.fire("word-right-click",{object:_this,event:e})}}},{key:"redrawLinks",value:function(){var _this2=this;this.links.forEach(function(l){return l.draw(_this2)}),this.redrawClusters()}},{key:"redrawClusters",value:function(){var _this3=this;this.clusters.forEach(function(cluster){cluster.endpoints.indexOf(_this3)>-1&&cluster.draw()})}},{key:"move",value:function(x){this.x=x,this.svg.transform({x:this.x}),this.redrawLinks()}},{key:"dx",value:function(x){this.move(this.x+x)}},{key:"alignBox",value:function(){var diff=-this.svg.bbox().x,_iteratorNormalCompletion=!0,_didIteratorError=!1,_iteratorError=void 0;try{for(var _step,_iterator=this.svg.children()[Symbol.iterator]();!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=!0){_step.value.dx(diff)}}catch(err){_didIteratorError=!0,_iteratorError=err}finally{try{_iteratorNormalCompletion||null==_iterator.return||_iterator.return()}finally{if(_didIteratorError)throw _iteratorError}}}},{key:"drawBbox",value:function(){var bbox=this.svg.bbox();this.svg.polyline([[bbox.x,bbox.y],[bbox.x2,bbox.y],[bbox.x2,bbox.y2],[bbox.x,bbox.y2],[bbox.x,bbox.y]]).fill("none").stroke({width:1})}},{key:"drawTextBbox",value:function(){var bbox=this.svgText.bbox();this.svg.polyline([[bbox.x,bbox.y],[bbox.x2,bbox.y],[bbox.x2,bbox.y2],[bbox.x,bbox.y2],[bbox.x,bbox.y]]).fill("none").stroke({width:1})}},{key:"boxWidth",get:function(){return this.svg.bbox().width}},{key:"boxHeight",get:function(){return-this.svg.bbox().y}},{key:"descendHeight",get:function(){return this.svg.bbox().y2}},{key:"absoluteY",get:function(){return this.row?this.row.ry+this.row.rh-this.boxHeight:this.boxHeight}},{key:"absoluteDescent",get:function(){return this.row?this.row.ry+this.row.rh+this.descendHeight:this.descendHeight}},{key:"cx",get:function(){return this.x+this.boxWidth/2}},{key:"textWidth",get:function(){return this.svgText.bbox().width}},{key:"isPunct",get:function(){return 1===this.text.length&&this.text.charCodeAt(0)<65}}]),Word}());var _$Word_85=Word;

var _$util_96 = {};
"use strict";var _lodash=_$interopRequireDefault_8(_$lodash_73);function getCssRules(elements){var sheets=document.styleSheets,ret=[],importRules=[];for(var i in sheets){var rules=sheets[i].rules||sheets[i].cssRules;for(var r in rules)if(rules[r].type!=CSSRule.IMPORT_RULE){var _iteratorNormalCompletion=!0,_didIteratorError=!1,_iteratorError=void 0;try{for(var _step,_iterator=elements[Symbol.iterator]();!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=!0){var el=_step.value;if(el.matches=el.matches||el.webkitMatchesSelector||el.mozMatchesSelector||el.msMatchesSelector||el.oMatchesSelector,el.matches(rules[r].selectorText)){ret.push(rules[r].cssText);break}}}catch(err){_didIteratorError=!0,_iteratorError=err}finally{try{_iteratorNormalCompletion||null==_iterator.return||_iterator.return()}finally{if(_didIteratorError)throw _iteratorError}}}else importRules.push(rules[r].cssText)}return ret=importRules.concat(ret),_lodash.default.uniq(ret)}window.getCssRules=getCssRules,_$util_96={getCssRules:getCssRules,sortForSlotting:function(links){var sortingArray=links.map(function(link,idx){var endpoints=link.endpoints;return{idx:idx,leftAnchor:endpoints[0].idx,width:endpoints[1].idx-endpoints[0].idx+1}});return sortingArray.sort(function(a,b){return b.width-a.width}),sortingArray.sort(function(a,b){return a.leftAnchor-b.leftAnchor}),sortingArray.map(function(link){return links[link.idx]})}};

"use strict";var ___classCallCheck2_82=_$interopRequireDefault_8(_$classCallCheck_6),___createClass2_82=_$interopRequireDefault_8(_$createClass_7),___wordTag_82=_$interopRequireDefault_8(_$WordTag_84),_word=_$interopRequireDefault_8(_$Word_85),Link=function(){function Link(eventId,trigger,args,reltype){var _this=this,top=!(arguments.length>4&&void 0!==arguments[4])||arguments[4];(0,___classCallCheck2_82.default)(this,Link),this.eventId=eventId,this.trigger=trigger,this.reltype=reltype,this.arguments=args.sort(function(a,b){return a.anchor.idx-b.anchor.idx}),this.links=[],this.top=top,this.visible=!0,this.slot=null,this.calculatingSlot=!1,this.trigger&&this.trigger.links.push(this),this.arguments.forEach(function(arg){arg.anchor.links.push(_this)}),this.initialised=!1,this.main=null,this.config=null,this.mainSVG=null,this.svg=null,this.handles=[],this.line=null,this.svgTexts=[],this.lastDrawnWidth=null}return(0,___createClass2_82.default)(Link,[{key:"init",value:function(main){var _this2=this;if(this.initialised=!0,this.main=main,this.config=main.config,this.arguments.sort(function(a,b){return a.anchor.idx-b.anchor.idx}),this.mainSVG=main.svg,this.svg=main.svg.group().addClass("tag-element").addClass(this.top?"link":"link syntax-link"),this.visible||this.svg.hide(),this.trigger&&this.handles.push(new Handle(this.trigger,this)),this.arguments.forEach(function(arg){if(_this2.handles.push(new Handle(arg.anchor,_this2)),_this2.trigger){var text=_this2.svg.text(arg.type).y(-7).addClass("tag-element").addClass("link-text");_this2.svgTexts.push(text)}}),this.reltype){var text=this.svg.text(this.reltype).y(-7).addClass("tag-element").addClass("link-text");this.svgTexts.push(text)}this.svgTexts.forEach(function(text){text.node.oncontextmenu=function(e){_this2.selectedLabel=text,e.preventDefault(),_this2.mainSVG.fire("link-label-right-click",{object:_this2,type:"text",event:e})},text.click(function(e){return _this2.mainSVG.fire("link-label-edit",{object:_this2,text:text,event:e})}),text.dblclick(function(e){return _this2.mainSVG.fire("build-tree",{object:_this2,event:e})})}),this.line=this.svg.path().addClass("tag-element").addClass("polyline");var draggedHandle=null,dragStartX=0;this.line.draggable().on("dragstart",function(e){var dragX=e.detail.p.x,dragY=e.detail.p.y-_$jquery_42(window).scrollTop(),_iteratorNormalCompletion=!0,_didIteratorError=!1,_iteratorError=void 0;try{for(var _step,_iterator=_this2.handles[Symbol.iterator]();!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=!0){var handle=_step.value;if(_this2.top){if(dragY<_this2.getLineYRow(handle.row)-5||dragY>handle.y+5)continue}else if(dragY<handle.y-5||dragY>_this2.getLineYRow(handle.row)+5)continue;var distX=Math.abs(handle.x-dragX);distX>_this2.config.linkArrowWidth||(!draggedHandle||distX<Math.abs(draggedHandle.x-dragX))&&(draggedHandle=handle,dragStartX=e.detail.p.x)}}catch(err){_didIteratorError=!0,_iteratorError=err}finally{try{_iteratorNormalCompletion||null==_iterator.return||_iterator.return()}finally{if(_didIteratorError)throw _iteratorError}}}).on("dragmove",function(e){if(e.preventDefault(),draggedHandle){var dx=e.detail.p.x-dragStartX;dragStartX=e.detail.p.x,draggedHandle.offset+=dx,window.debugHandle=draggedHandle;var anchor=draggedHandle.anchor;if(anchor instanceof Link)draggedHandle.offset=Math.min(draggedHandle.offset,anchor.width),draggedHandle.offset=Math.max(draggedHandle.offset,0);else{var halfWidth=anchor.boxWidth/2;_this2.top&&anchor.tag instanceof ___wordTag_82.default?halfWidth=anchor.tag.ww/2:!_this2.top&&anchor.syntaxTag instanceof ___wordTag_82.default&&(halfWidth=anchor.syntaxTag.ww/2),draggedHandle.offset=Math.min(draggedHandle.offset,halfWidth-3),draggedHandle.offset=Math.max(draggedHandle.offset,3-halfWidth)}_this2.draw(anchor)}}).on("dragend",function(){draggedHandle=null}),this.line.dblclick(function(e){return _this2.mainSVG.fire("build-tree",{object:_this2,event:e})}),this.line.node.oncontextmenu=function(e){e.preventDefault(),_this2.mainSVG.fire("link-right-click",{object:_this2,type:"link",event:e})}}},{key:"toggle",value:function(){this.visible=!this.visible,this.visible?this.show():this.hide()}},{key:"show",value:function(){this.visible=!0,this.svg&&(this.svg.show(),this.draw())}},{key:"hide",value:function(){this.visible=!1,this.svg&&this.svg.hide()}},{key:"draw",value:function(modAnchor){var _this3=this,drawStart=performance.now();if(this.initialised&&this.visible){var calcHandles=this.handles;modAnchor&&(calcHandles=[this.handles.find(function(h){return h.anchor===modAnchor})]);var changedHandles=[],_iteratorNormalCompletion2=!0,_didIteratorError2=!1,_iteratorError2=void 0;try{for(var _step2,_iterator2=calcHandles[Symbol.iterator]();!(_iteratorNormalCompletion2=(_step2=_iterator2.next()).done);_iteratorNormalCompletion2=!0){var _handle=_step2.value,anchor=_handle.anchor;if(anchor instanceof Link){var baseLeft=anchor.leftHandle;_handle.offset=Math.min(_handle.offset,anchor.width),_handle.offset=Math.max(_handle.offset,0);for(var calcOffset=_handle.offset,calcRow=baseLeft.row,calcX=baseLeft.x;calcOffset>calcRow.rw-calcX;)calcOffset-=calcRow.rw-calcX,calcX=0,calcRow=this.main.rowManager.rows[calcRow.idx+1];var _newX=calcX+calcOffset,_newY=anchor.getLineYRow(calcRow);_handle.x===_newX&&_handle.y===_newY||(_handle.x=_newX,_handle.y=_newY,_handle.row=calcRow,changedHandles.push(_handle))}else{var newX=anchor.cx+_handle.offset,newY=this.top?anchor.absoluteY:anchor.absoluteDescent;_handle.x===newX&&_handle.y===newY||(_handle.x=newX,_handle.y=newY,changedHandles.push(_handle))}}}catch(err){_didIteratorError2=!0,_iteratorError2=err}finally{try{_iteratorNormalCompletion2||null==_iterator2.return||_iterator2.return()}finally{if(_didIteratorError2)throw _iteratorError2}}if(null===this.lastDrawnWidth)this.lastDrawnWidth=this.width;else{var growth=this.width-this.lastDrawnWidth;if(this.lastDrawnWidth=this.width,growth>500){/* removed: var _$lodash_73=require("lodash"); */;console.log(this.eventId,this.width,growth,this.lastDrawnWidth),console.log(_$lodash_73.cloneDeep(this)),console.log(_$lodash_73.cloneDeep(this.handles))}if(1===changedHandles.length&&changedHandles[0]===this.leftHandle){var _iteratorNormalCompletion3=!0,_didIteratorError3=!1,_iteratorError3=void 0;try{for(var _step3,_iterator3=this.links[Symbol.iterator]();!(_iteratorNormalCompletion3=(_step3=_iterator3.next()).done);_iteratorNormalCompletion3=!0){var parentHandle=_step3.value.handles.find(function(h){return h.anchor===_this3});parentHandle.offset+=growth,parentHandle.offset=Math.max(parentHandle.offset,0)}}catch(err){_didIteratorError3=!0,_iteratorError3=err}finally{try{_iteratorNormalCompletion3||null==_iterator3.return||_iterator3.return()}finally{if(_didIteratorError3)throw _iteratorError3}}}}var width=this.mainSVG.width(),d="",leftHandle=this.leftHandle,rightHandle=this.rightHandle;if(this.trigger)for(var triggerHandle=this.triggerHandle,pTrigger={x:triggerHandle.x,y:this.top?triggerHandle.y-this.config.linkHandlePadding:triggerHandle.y+this.config.linkHandlePadding},i=0;i<this.arguments.length;i++){var handle=this.handles[i+1],label=this.svgTexts[i],pHandle={x:handle.x,y:this.top?handle.y-this.config.linkHandlePadding:handle.y+this.config.linkHandlePadding},sameRow=handle.row.idx===triggerHandle.row.idx,textLength=label.length(),textY=this.getLineYRow(handle.row)-10,textLeft=void 0;handle.precedes(triggerHandle)?(textLeft=pHandle.x+this.config.linkCurveWidth)+textLength>handle.row.rw&&(textLeft=handle.row.rw-textLength):(textLeft=pHandle.x-this.config.linkCurveWidth-textLength,textLeft=Math.max(textLeft,0));var textCentre=textLeft+textLength/2;if(handle.precedes(triggerHandle)){d+="M"+[pHandle.x,pHandle.y];var handleY=this.getLineYRow(handle.row);if(textLeft<pHandle.x)d+="L"+[pHandle.x,handleY];else{var curveLeftX=pHandle.x+this.config.linkCurveWidth;curveLeftX=Math.min(curveLeftX,textLeft),d+="C"+[pHandle.x,handleY,pHandle.x,handleY,curveLeftX,handleY]+"L"+[textLeft,handleY]}if(sameRow)if(textLeft+textLength>pTrigger.x)d+="M"+[pTrigger.x,handleY]+"L"+[pTrigger.x,pTrigger.y];else{var curveRightX=pTrigger.x-this.config.linkCurveWidth;d+="M"+[textLeft+textLength,handleY]+"L"+[curveRightX=Math.max(curveRightX,textLeft+textLength),handleY]+"C"+[pTrigger.x,handleY,pTrigger.x,handleY,pTrigger.x,pTrigger.y]}else{d+="M"+[textLeft+textLength,handleY]+"L"+[handle.row.rw,handleY];for(var _i=handle.row.idx+1;_i<triggerHandle.row.idx;_i++){var thisRow=this.main.rowManager.rows[_i],lineY=this.getLineYRow(thisRow);d+="M"+[0,lineY]+"L"+[thisRow.rw,lineY]}var _curveRightX=pTrigger.x-this.config.linkCurveWidth;_curveRightX=Math.max(_curveRightX,0);var finalY=this.getLineYRow(triggerHandle.row);d+="M"+[0,finalY]+"L"+[_curveRightX,finalY]+"C"+[pTrigger.x,finalY,pTrigger.x,finalY,pTrigger.x,pTrigger.y]}}else{d+="M"+[pTrigger.x,pTrigger.y];var triggerY=this.getLineYRow(triggerHandle.row);if(textLeft<pTrigger.x)d+="M"+[pTrigger.x,pTrigger.y]+"L"+[pTrigger.x,triggerY];else{var _curveLeftX=pTrigger.x+this.config.linkCurveWidth;_curveLeftX=Math.min(_curveLeftX,textLeft),d+="C"+[pTrigger.x,triggerY,pTrigger.x,triggerY,_curveLeftX,triggerY]+"L"+[textLeft,triggerY]}if(sameRow)if(textLeft+textLength>pHandle.x)d+="M"+[pHandle.x,triggerY]+"L"+[pHandle.x,pHandle.y];else{var _curveRightX2=pHandle.x-this.config.linkCurveWidth;d+="M"+[textLeft+textLength,triggerY]+"L"+[_curveRightX2=Math.max(_curveRightX2,textLeft+textLength),triggerY]+"C"+[pHandle.x,triggerY,pHandle.x,triggerY,pHandle.x,pHandle.y]}else{d+="M"+[textLeft+textLength,triggerY]+"L"+[triggerHandle.row.rw,triggerY];for(var _i2=triggerHandle.row.idx+1;_i2<handle.row.idx;_i2++){var _thisRow=this.main.rowManager.rows[_i2],_lineY=this.getLineYRow(_thisRow);d+="M"+[0,_lineY]+"L"+[_thisRow.rw,_lineY]}var _curveRightX3=pHandle.x-this.config.linkCurveWidth;_curveRightX3=Math.max(_curveRightX3,0);var _finalY=this.getLineYRow(handle.row);d+="M"+[0,_finalY]+"L"+[_curveRightX3,_finalY]+"C"+[pHandle.x,_finalY,pHandle.x,_finalY,pHandle.x,pHandle.y]}}d+="M"+[pTrigger.x,pTrigger.y]+"m"+[this.config.linkArrowWidth,0]+"l"+[-2*this.config.linkArrowWidth,0],d+=this.arrowhead(pHandle),label.x(textCentre).y(textY)}else if("debug"===this.trigger)for(var y=this.getLineY(this.handles[1]),rowCrossed=!1,_i3=0,il=this.arguments.length;_i3<il;++_i3){var leftOfTrigger=this.arguments[_i3].anchor.idx<this.trigger.idx,dx=leftOfTrigger?5:-5,textlen=leftOfTrigger?this.svgTexts[_i3].length():-this.svgTexts[_i3].length(),handle1=this.handles[_i3+1];_i3>0?(rowCrossed&&(rowCrossed=!1,d+="L"+[width,y]+"M0,",d+=y=this.getLineYRow(handle1.row)),d+=leftOfTrigger?"L"+[handle1.x+dx,y]:"L"+[handle1.x+dx+textlen,y]):leftOfTrigger||(y=this.getLineYRow(this.handles[0].row),d+="M"+[this.handles[0].x,this.handles[0].y]+"C"+[this.handles[0].x,y,this.handles[0].x,y,this.handles[0].x-dx,y],this.handles[0].anchor.row.idx<this.handles[1].anchor.row.idx&&(d+="L"+[width,y]+"M0,",d+=y=this.getLineYRow(this.handles[1].row)),d+="L"+[this.handles[1].x+dx+textlen,y]),this.svgTexts[_i3].x(handle1.x+dx+textlen/2).y(y-10),d+=this.arrowhead(handle1);var handlePrecedesTrigger=leftOfTrigger&&(_i3+2>il||this.arguments[_i3+1].anchor.idx>=this.trigger.idx);if(rowCrossed=handlePrecedesTrigger&&this.handles[0].anchor.row.idx!=handle1.anchor.row.idx||!handlePrecedesTrigger&&_i3+1<il&&this.handles[_i3+2].anchor.row.idx!=handle1.anchor.row.idx,handlePrecedesTrigger&&rowCrossed){var tempY=this.getLineYRow(handle1.row);y=this.getLineYRow(this.handles[0].row),d+="M"+[handle1.x,handle1.y]+"C"+[handle1.x,tempY,handle1.x,tempY,handle1.x+dx,tempY]+"m"+[textlen,0]+"L"+[width,tempY]+"M"+[0,y],rowCrossed=!1,this.svgTexts[_i3].y(tempY-10)}else d+="M"+[handle1.x,handle1.y]+"C"+[handle1.x,y,handle1.x,y,handle1.x+dx,y],leftOfTrigger&&(d+="m"+[textlen,0]);handlePrecedesTrigger&&(_i3+1<il?(d+="L"+[this.handles[0].x-dx,y]+"c"+[dx,0,dx,0,dx,this.handles[0].y-y]+"m"+[dx,0]+"l"+[-2*dx,0]+"m"+[dx,0]+"C"+[this.handles[0].x,y,this.handles[0].x,y,this.handles[0].x+dx,y],rowCrossed=this.handles[_i3+2].anchor.row.idx!=this.handles[0].anchor.row.idx):d+="L"+[this.handles[0].x-dx,y]+"c"+[dx,0,dx,0,dx,this.handles[0].y-y])}else if(this.reltype){var pStart={x:leftHandle.x,y:this.top?leftHandle.y-this.config.linkHandlePadding:leftHandle.y+this.config.linkHandlePadding},pEnd={x:rightHandle.x,y:this.top?rightHandle.y-this.config.linkHandlePadding:rightHandle.y+this.config.linkHandlePadding},_sameRow=leftHandle.row.idx===rightHandle.row.idx,_textLength=this.svgTexts[0].length(),_textY=this.getLineYRow(leftHandle.row)-10,_textCentre=_sameRow?(pStart.x+pEnd.x)/2:(pStart.x+leftHandle.row.rw)/2,_textLeft=_textCentre-_textLength/2;_textLeft+_textLength>leftHandle.row.rw&&(_textCentre=(_textLeft=leftHandle.row.rw-_textLength)+_textLength/2),d="M"+[pStart.x,pStart.y];var firstY=this.getLineYRow(leftHandle.row);if(_textLeft<pStart.x)d+="L"+[pStart.x,firstY];else{var _curveLeftX2=pStart.x+this.config.linkCurveWidth;_curveLeftX2=Math.min(_curveLeftX2,_textLeft),d+="C"+[pStart.x,firstY,pStart.x,firstY,_curveLeftX2,firstY]+"L"+[_textLeft,firstY]}if(_sameRow)if(_textLeft+_textLength>pEnd.x)d+="M"+[pEnd.x,firstY]+"L"+[pEnd.x,pEnd.y];else{var _curveRightX4=pEnd.x-this.config.linkCurveWidth;d+="M"+[_textLeft+_textLength,firstY]+"L"+[_curveRightX4=Math.max(_curveRightX4,_textLeft+_textLength),firstY]+"C"+[pEnd.x,firstY,pEnd.x,firstY,pEnd.x,pEnd.y]}else{d+="M"+[_textLeft+_textLength,firstY]+"L"+[leftHandle.row.rw,firstY];for(var _i4=leftHandle.row.idx+1;_i4<rightHandle.row.idx;_i4++){var _thisRow2=this.main.rowManager.rows[_i4],_lineY2=this.getLineYRow(_thisRow2);d+="M"+[0,_lineY2]+"L"+[_thisRow2.rw,_lineY2]}var _curveRightX5=pEnd.x-this.config.linkCurveWidth;_curveRightX5=Math.max(_curveRightX5,0);var _finalY2=this.getLineYRow(rightHandle.row);d+="M"+[0,_finalY2]+"L"+[_curveRightX5,_finalY2]+"C"+[pEnd.x,_finalY2,pEnd.x,_finalY2,pEnd.x,pEnd.y]}d+=this.arrowhead(pStart)+this.arrowhead(pEnd),this.svgTexts[0].x(_textCentre).y(_textY)}this.line.plot(d),console.log("Drew ".concat(this.eventId," in ").concat(performance.now()-drawStart,"ms.")),this.links.forEach(function(l){return l.draw(_this3)})}}},{key:"getLineYRow",value:function(row){return this.top?row.ry+row.rh-row.wordHeight-15*this.slot:row.ry+row.rh+row.wordDescent+15*this.slot}},{key:"arrowhead",value:function(point){var s=this.config.linkArrowWidth;return this.top?"M"+[point.x-s,point.y-5]+"l"+[s,5]+"l"+[s,-5]:"M"+[point.x-s,point.y+5]+"l"+[s,-5]+"l"+[s,5]}},{key:"remove",value:function(){this.svg.remove();var self=this;function detachLink(anchor){var i=anchor.links.indexOf(self);i>-1&&anchor.links.splice(i,1)}this.trigger&&detachLink(this.trigger),this.arguments.forEach(function(arg){return detachLink(arg.anchor)})}},{key:"calculateSlot",value:function(words){if(this.slot)return this.slot;if(this.calculatingSlot)return 0;this.calculatingSlot=!0;var intervening=[],coveredWords=words.slice(this.endpoints[0].idx,this.endpoints[1].idx+1),_iteratorNormalCompletion4=!0,_didIteratorError4=!1,_iteratorError4=void 0;try{for(var _step4,_iterator4=coveredWords[Symbol.iterator]();!(_iteratorNormalCompletion4=(_step4=_iterator4.next()).done);_iteratorNormalCompletion4=!0){var word=_step4.value,_iteratorNormalCompletion5=!0,_didIteratorError5=!1,_iteratorError5=void 0;try{for(var _step5,_iterator5=word.links[Symbol.iterator]();!(_iteratorNormalCompletion5=(_step5=_iterator5.next()).done);_iteratorNormalCompletion5=!0){var link=_step5.value;link!==this&&link.top===this.top&&intervening.indexOf(link)<0&&intervening.push(link)}}catch(err){_didIteratorError5=!0,_iteratorError5=err}finally{try{_iteratorNormalCompletion5||null==_iterator5.return||_iterator5.return()}finally{if(_didIteratorError5)throw _iteratorError5}}}}catch(err){_didIteratorError4=!0,_iteratorError4=err}finally{try{_iteratorNormalCompletion4||null==_iterator4.return||_iterator4.return()}finally{if(_didIteratorError4)throw _iteratorError4}}var maxSlot=(intervening=_$util_96.sortForSlotting(intervening)).map(function(link){return link.calculateSlot(words)}).reduce(function(prev,next){return(next=Math.abs(next))>prev?next:prev},0);return this.slot=maxSlot+1,this.top||(this.slot=-1*this.slot),this.calculatingSlot=!1,this.slot}},{key:"resetSlotRecalculation",value:function(){var _this4=this;this.isRecalculated=!1,this.slot=0,this.top?(this.trigger&&(this.slot=this.trigger.slot),this.arguments.forEach(function(arg){arg.anchor.slot>_this4.slot&&(_this4.slot=arg.anchor.slot)}),this.slot+=1):this.slot=-1}},{key:"recalculateSlots",value:function(words){var ep=this.endpoints;if(this.isRecalculated)return[{slot:this.slot,endpoints:ep}];this.isRecalculated=!0;var wordArray=words.slice(ep[0].idx,ep[1].idx+1),self=this,slots=[];return wordArray.forEach(function(word){word.links.forEach(function(l){l===self||l.top!==self.top||l.endpoints[0].idx>=ep[1].idx||l.endpoints[1].idx<=ep[0].idx||[].push.apply(slots,l.recalculateSlots(words))})}),function incrementSlot(l){for(;slots.find(function(s){return s.slot===l.slot&&!(s.endpoints[0].idx>=l.endpoints[1].idx||s.endpoints[1].idx<=l.endpoints[0].idx)});)l.slot+=l.top?1:-1;slots.push({slot:l.slot,endpoints:l.endpoints}),l.links.forEach(function(link){link.top===l.top&&incrementSlot(link)})}(this),slots}},{key:"listenForEdit",value:function(e){this.isEditing=!0;var bbox=e.detail.text.bbox();e.detail.text.addClass("tag-element").addClass("editing-text"),this.editingText=e.detail.text,this.editingRect=this.svg.rect(bbox.width+8,bbox.height+4).x(bbox.x-4).y(bbox.y-2).rx(2).ry(2).addClass("tag-element").addClass("editing-rect").back()}},{key:"text",value:function(str){if(this.editingText){if(void 0===str)return this.editingText;this.editingText.text(str)}}},{key:"stopEditing",value:function(){this.isEditing=!1,this.editingText.removeClass("editing-text"),this.editingRect.remove(),this.editingRect=this.editingText=null,this.draw()}},{key:"endpoints",get:function(){var minWord=null,maxWord=null;return this.trigger&&(minWord=maxWord=this.trigger),this.arguments.forEach(function(arg){if(arg.anchor instanceof Link){var endpts=arg.anchor.endpoints;(!minWord||minWord.idx>endpts[0].idx)&&(minWord=endpts[0]),(!maxWord||maxWord.idx<endpts[1].idx)&&(maxWord=endpts[1])}else(!minWord||minWord.idx>arg.anchor.idx)&&(minWord=arg.anchor),(!maxWord||maxWord.idx<arg.anchor.idx)&&(maxWord=arg.anchor)}),[minWord,maxWord]}},{key:"width",get:function(){if(this.leftHandle.row===this.rightHandle.row)return this.rightHandle.x-this.leftHandle.x;var width=0;width+=this.leftHandle.row.rw-this.leftHandle.x;for(var i=this.leftHandle.row.idx+1;i<this.rightHandle.row.idx;i++)width+=this.main.rowManager.rows[i].rw;return width+=this.rightHandle.x}},{key:"leftHandle",get:function(){return this.handles.reduce(function(prev,next){return prev.precedes(next)?prev:next},this.handles[0])}},{key:"rightHandle",get:function(){return this.handles.reduce(function(prev,next){return prev.precedes(next)?next:prev},this.handles[0])}},{key:"triggerHandle",get:function(){var _this5=this;return this.trigger?this.handles.find(function(handle){return handle.anchor===_this5.trigger}):null}},{key:"rootWord",get:function(){return this.trigger?this.trigger:this.arguments[0].anchor instanceof _word.default?this.arguments[0].anchor:this.arguments[0].anchor.rootWord}},{key:"idx",get:function(){return this.rootWord.idx}},{key:"row",get:function(){return this.rootWord.row}},{key:"cx",get:function(){return this.line&&this.trigger?this.trigger.cx+this.handles[0].offset:this.rootWord.cx}},{key:"absoluteY",get:function(){return this.rootWord.row.rh+this.rootWord.row.ry-45-15*this.slot}},{key:"val",get:function(){return this.reltype||this.trigger.reltype||this.trigger.tag&&this.trigger.tag.val||this.trigger.val}}]),Link}(),Handle=function(){function Handle(anchor,parent){(0,___classCallCheck2_82.default)(this,Handle),this.anchor=anchor,this.parent=parent,this.x=0,this.y=0,this.offset=0;var rowBase,l=anchor.links.sort(function(a,b){return a.slot-b.slot}).filter(function(link){return link.top===parent.top});!(anchor instanceof Link)&&l.length>1&&(l=l.filter(function(link){return anchor.idx>link.endpoints[0].idx==anchor.idx>parent.endpoints[0].idx}),this.offset=(l.indexOf(parent)+.5)/l.length*(anchor.idx>parent.endpoints[0].idx?10:-10)),rowBase=anchor instanceof Link?anchor.endpoints[0]:anchor,this.row=rowBase.row}return(0,___createClass2_82.default)(Handle,[{key:"precedes",value:function(handle){return!(!this.row||!handle.row)&&(this.row.idx<handle.row.idx||this.row.idx===handle.row.idx&&this.x<handle.x)}}]),Handle}();var _$Link_82=Link;

"use strict";var ___classCallCheck2_89=_$interopRequireDefault_8(_$classCallCheck_6),_link=_$interopRequireDefault_8(_$Link_82);var _$labelmanager_89=function(){var _svg,activeObject=null,string=null,originalString=null,MAX_WIDTH=22,Key={delete:8,tab:9,enter:13,escape:27,left:37,up:38,right:39,down:40},KeyValues=Object.values(Key);function listenForEdit(e){(activeObject=e.detail.object).listenForEdit(e),originalString=e.detail.object.val,string=null}function stopEditing(){if(activeObject&&activeObject.isEditing){var text=activeObject.text();!text||activeObject instanceof _link.default||_svg.fire("label-updated",{object:text,label:text.text()}),activeObject.stopEditing(),activeObject=null,originalString=string=null}}function updateString(s){string=s.slice(0,MAX_WIDTH),activeObject.text(string)}return document.addEventListener("keydown",function(e){if(activeObject&&activeObject.isEditing&&KeyValues.indexOf(e.keyCode)>-1)switch(e.keyCode){case Key.delete:null===string&&(string=originalString),updateString(string.slice(0,-1));break;case Key.tab:break;case Key.enter:stopEditing();break;case Key.escape:updateString(originalString),stopEditing();break;case Key.right:null===string&&updateString(originalString)}}),document.addEventListener("keypress",function(e){activeObject&&activeObject.isEditing&&(32===e.which&&e.preventDefault(),e.which>31&&!e.ctrlKey&&!e.metaKey&&!e.altKey&&(null===string&&(string=""),updateString(string+String.fromCharCode(e.which))))}),document.addEventListener("mousedown",stopEditing),function LabelManager(svg){(0,___classCallCheck2_89.default)(this,LabelManager),_svg=svg,svg.on("tag-edit",listenForEdit),svg.on("link-label-edit",listenForEdit),this.stopEditing=stopEditing}}();

"use strict";var ___classCallCheck2_83=_$interopRequireDefault_8(_$classCallCheck_6),___createClass2_83=_$interopRequireDefault_8(_$createClass_7),Row=(_$interopRequireWildcard_9(_$svg_80),_$interopRequireWildcard_9(_$svgDraggable_79),function(){function Row(svg,config){var idx=arguments.length>2&&void 0!==arguments[2]?arguments[2]:0,ry=arguments.length>3&&void 0!==arguments[3]?arguments[3]:0,rh=arguments.length>4&&void 0!==arguments[4]?arguments[4]:100;(0,___classCallCheck2_83.default)(this,Row),this.config=config,this.idx=idx,this.ry=ry,this.rh=rh,this.rw=0,this.words=[],this.svg=null,this.draggable=null,this.wordGroup=null,svg&&this.svgInit(svg)}return(0,___createClass2_83.default)(Row,[{key:"svgInit",value:function(mainSvg){var _this=this;this.svg=mainSvg.group().transform({y:this.baseline}).addClass("tag-element").addClass("row"),this.wordGroup=this.svg.group(),this.rw=mainSvg.width(),this.draggable=this.svg.line(0,0,this.rw,0).addClass("tag-element").addClass("row-drag").draggable();var y=0;this.draggable.on("dragstart",function(e){y=e.detail.p.y}).on("dragmove",function(e){e.preventDefault();var dy=e.detail.p.y-y;y=e.detail.p.y,mainSvg.fire("row-resize",{object:_this,y:dy})})}},{key:"remove",value:function(){return this.svg.remove()}},{key:"dy",value:function(y){this.ry+=y,this.svg.transform({y:this.baseline})}},{key:"move",value:function(y){this.ry=y,this.svg.transform({y:this.baseline})}},{key:"height",value:function(rh){this.rh=rh,this.svg.transform({y:this.baseline})}},{key:"width",value:function(rw){this.rw=rw,this.draggable.attr("x2",this.rw)}},{key:"addWord",value:function(word,index,forceX){var newX;if(isNaN(index)&&(index=this.words.length),word.row=this,this.words.splice(index,0,word),this.wordGroup.add(word.svg),word.x=-1,0===index)newX=this.config.rowEdgePadding;else{var prevWord=this.words[index-1];newX=prevWord.x+prevWord.boxWidth,word.isPunct?newX+=this.config.wordPunctPadding:newX+=this.config.wordPadding}return forceX&&(newX=forceX),this.positionWord(word,newX)}},{key:"positionWord",value:function(word,newX){var wordIndex=this.words.indexOf(word),prevWord=this.words[wordIndex-1],nextWord=this.words[wordIndex+1],overflowIndex=this.words.length;if(prevWord){var wordPadding=word.isPunct?this.config.wordPunctPadding:this.config.wordPadding;if(newX<prevWord.x+prevWord.boxWidth+wordPadding)throw"Trying to position new Word over existing one!\n        (Row: ".concat(this.idx,", wordIndex: ").concat(wordIndex,")")}if(nextWord){var nextWordPadding=nextWord.isPunct?this.config.wordPunctPadding:this.config.wordPadding;nextWord.x-nextWordPadding<newX+word.boxWidth&&(overflowIndex=this.positionWord(nextWord,newX+word.boxWidth+nextWordPadding))}return newX+word.boxWidth>this.rw-this.config.rowEdgePadding?wordIndex:(word.move(newX),overflowIndex)}},{key:"removeWord",value:function(word){return this.words.splice(this.words.indexOf(word),1),this.wordGroup.removeElement(word.svg),word}},{key:"removeLastWord",value:function(){var word=this.words.pop();return this.wordGroup.removeElement(word.svg),word}},{key:"removeFirstWord",value:function(){var word=this.words.shift();return this.wordGroup.removeElement(word.svg),word}},{key:"redrawLinks",value:function(){var links=[],_iteratorNormalCompletion=!0,_didIteratorError=!1,_iteratorError=void 0;try{for(var _step,_iterator=this.words[Symbol.iterator]();!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=!0){var word=_step.value,_iteratorNormalCompletion2=!0,_didIteratorError2=!1,_iteratorError2=void 0;try{for(var _step2,_iterator2=word.links[Symbol.iterator]();!(_iteratorNormalCompletion2=(_step2=_iterator2.next()).done);_iteratorNormalCompletion2=!0){var link=_step2.value;links.indexOf(link)<0&&links.push(link)}}catch(err){_didIteratorError2=!0,_iteratorError2=err}finally{try{_iteratorNormalCompletion2||null==_iterator2.return||_iterator2.return()}finally{if(_didIteratorError2)throw _iteratorError2}}}}catch(err){_didIteratorError=!0,_iteratorError=err}finally{try{_iteratorNormalCompletion||null==_iterator.return||_iterator.return()}finally{if(_didIteratorError)throw _iteratorError}}links.forEach(function(link){return link.draw()})}},{key:"drawBbox",value:function(){var bbox=this.svg.bbox();this.svg.polyline([[bbox.x,bbox.y],[bbox.x2,bbox.y],[bbox.x2,bbox.y2],[bbox.x,bbox.y2],[bbox.x,bbox.y]]).fill("none").stroke({width:1})}},{key:"baseline",get:function(){return this.ry+this.rh}},{key:"ry2",get:function(){return this.ry+this.rh+this.descent}},{key:"maxSlot",get:function(){var maxSlot=0,_iteratorNormalCompletion3=!0,_didIteratorError3=!1,_iteratorError3=void 0;try{for(var _step3,_iterator3=this.words[Symbol.iterator]();!(_iteratorNormalCompletion3=(_step3=_iterator3.next()).done);_iteratorNormalCompletion3=!0){var word=_step3.value,_iteratorNormalCompletion4=!0,_didIteratorError4=!1,_iteratorError4=void 0;try{for(var _step4,_iterator4=word.links[Symbol.iterator]();!(_iteratorNormalCompletion4=(_step4=_iterator4.next()).done);_iteratorNormalCompletion4=!0){var link=_step4.value;maxSlot=Math.max(maxSlot,link.slot)}}catch(err){_didIteratorError4=!0,_iteratorError4=err}finally{try{_iteratorNormalCompletion4||null==_iterator4.return||_iterator4.return()}finally{if(_didIteratorError4)throw _iteratorError4}}}}catch(err){_didIteratorError3=!0,_iteratorError3=err}finally{try{_iteratorNormalCompletion3||null==_iterator3.return||_iterator3.return()}finally{if(_didIteratorError3)throw _iteratorError3}}return maxSlot}},{key:"minSlot",get:function(){var minSlot=0,_iteratorNormalCompletion5=!0,_didIteratorError5=!1,_iteratorError5=void 0;try{for(var _step5,_iterator5=this.words[Symbol.iterator]();!(_iteratorNormalCompletion5=(_step5=_iterator5.next()).done);_iteratorNormalCompletion5=!0){var word=_step5.value,_iteratorNormalCompletion6=!0,_didIteratorError6=!1,_iteratorError6=void 0;try{for(var _step6,_iterator6=word.links[Symbol.iterator]();!(_iteratorNormalCompletion6=(_step6=_iterator6.next()).done);_iteratorNormalCompletion6=!0){var link=_step6.value;minSlot=Math.min(minSlot,link.slot)}}catch(err){_didIteratorError6=!0,_iteratorError6=err}finally{try{_iteratorNormalCompletion6||null==_iterator6.return||_iterator6.return()}finally{if(_didIteratorError6)throw _iteratorError6}}}}catch(err){_didIteratorError5=!0,_iteratorError5=err}finally{try{_iteratorNormalCompletion5||null==_iterator5.return||_iterator5.return()}finally{if(_didIteratorError5)throw _iteratorError5}}return minSlot}},{key:"wordHeight",get:function(){var wordHeight=0,_iteratorNormalCompletion7=!0,_didIteratorError7=!1,_iteratorError7=void 0;try{for(var _step7,_iterator7=this.words[Symbol.iterator]();!(_iteratorNormalCompletion7=(_step7=_iterator7.next()).done);_iteratorNormalCompletion7=!0){var word=_step7.value;wordHeight=Math.max(wordHeight,word.boxHeight)}}catch(err){_didIteratorError7=!0,_iteratorError7=err}finally{try{_iteratorNormalCompletion7||null==_iterator7.return||_iterator7.return()}finally{if(_didIteratorError7)throw _iteratorError7}}return wordHeight}},{key:"wordDescent",get:function(){var wordDescent=0,_iteratorNormalCompletion8=!0,_didIteratorError8=!1,_iteratorError8=void 0;try{for(var _step8,_iterator8=this.words[Symbol.iterator]();!(_iteratorNormalCompletion8=(_step8=_iterator8.next()).done);_iteratorNormalCompletion8=!0){var word=_step8.value;wordDescent=Math.max(wordDescent,word.descendHeight)}}catch(err){_didIteratorError8=!0,_iteratorError8=err}finally{try{_iteratorNormalCompletion8||null==_iterator8.return||_iterator8.return()}finally{if(_didIteratorError8)throw _iteratorError8}}return wordDescent}},{key:"minHeight",get:function(){return this.wordHeight+this.maxSlot*this.config.linkSlotInterval+this.config.rowVerticalPadding}},{key:"descent",get:function(){return this.wordDescent+Math.abs(this.minSlot)*this.config.linkSlotInterval+this.config.rowVerticalPadding}},{key:"availableSpace",get:function(){if(0===this.words.length)return this.rw-2*this.config.rowEdgePadding;var lastWord=this.words[this.words.length-1];return this.rw-this.config.rowEdgePadding-lastWord.x-lastWord.boxWidth}}]),Row}());var _$Row_83=Row;

"use strict";var ___classCallCheck2_90=_$interopRequireDefault_8(_$classCallCheck_6),___createClass2_90=_$interopRequireDefault_8(_$createClass_7),_row=_$interopRequireDefault_8(_$Row_83),RowManager=function(){function RowManager(svg,config){(0,___classCallCheck2_90.default)(this,RowManager),this.config=config,this._svg=svg,this._rows=[]}return(0,___createClass2_90.default)(RowManager,[{key:"resizeAll",value:function(){this.width(this._svg.width()),this.resizeRow(0)}},{key:"resizeRow",value:function(i){var dy=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0,row=this._rows[i];if(void 0!==row){var newHeight=Math.max(row.rh+dy,row.minHeight);if(row.rh!==newHeight){row.height(newHeight),console.log("--------");var drawStart=performance.now();row.redrawLinks(),console.log("Redrew links in ".concat(performance.now()-drawStart,"ms."))}for(i+=1;i<this._rows.length;i++){var prevRow=this._rows[i-1],thisRow=this._rows[i];thisRow.ry!==prevRow.ry2&&(thisRow.move(prevRow.ry2),thisRow.redrawLinks())}this._svg.height(this.lastRow.ry2+20)}}},{key:"width",value:function(rw){var _this=this;this._rows.forEach(function(row){row.width(rw);var i=row.words.findIndex(function(w){return w.x+w.boxWidth>rw-_this.config.rowEdgePadding});if(i>0)for(;i<row.words.length;)_this.moveWordDownARow(row.idx);else row.words.forEach(function(word){word.links.forEach(function(l){l.endpoints[1].row!==l.endpoints[0].row&&l.draw(word)}),word.redrawClusters()})})}},{key:"appendRow",value:function(){var lr=this.lastRow,row=lr?new _row.default(this._svg,this.config,lr.idx+1,lr.ry2):new _row.default(this._svg,this.config);return this._rows.push(row),this._svg.height(row.ry2+20),row}},{key:"removeRow",value:function(){this._rows.pop().remove(),this.lastRow&&this._svg.height(this.lastRow.ry2+20)}},{key:"addWordToRow",value:function(word,row,i,forceX){isNaN(i)&&(i=row.words.length);var minSlot=0,maxSlot=0,_iteratorNormalCompletion=!0,_didIteratorError=!1,_iteratorError=void 0;try{for(var _step,_iterator=word.links[Symbol.iterator]();!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=!0){var link=_step.value;minSlot=Math.min(minSlot,link.slot),maxSlot=Math.max(maxSlot,link.slot)}}catch(err){_didIteratorError=!0,_iteratorError=err}finally{try{_iteratorNormalCompletion||null==_iterator.return||_iterator.return()}finally{if(_didIteratorError)throw _iteratorError}}(minSlot<row.minSlot||maxSlot>row.maxSlot)&&this.resizeRow(row.idx);for(var overflow=row.addWord(word,i,forceX);overflow<row.words.length;)this.moveWordDownARow(row.idx)}},{key:"moveWordOnRow",value:function(word,dx){var row=word.row;row&&(dx>=0?this.moveWordRight({row:row,wordIndex:row.words.indexOf(word),dx:dx}):dx<0&&(dx=-dx,this.moveWordLeft({row:row,wordIndex:row.words.indexOf(word),dx:dx})))}},{key:"moveWordRight",value:function(params){var rightEdge,row=params.row,wordIndex=params.wordIndex,dx=params.dx,word=row.words[wordIndex],nextWord=row.words[wordIndex+1];nextWord?(rightEdge=nextWord.x,rightEdge-=nextWord.isPunct?this.config.wordPunctPadding:this.config.wordPadding):rightEdge=row.rw-this.config.rowEdgePadding,dx<=rightEdge-(word.x+word.boxWidth)?word.dx(dx):nextWord?(this.moveWordRight({row:row,wordIndex:wordIndex+1,dx:dx}),word.dx(dx)):this.moveWordDownARow(row.idx)}},{key:"moveWordLeft",value:function(params){var row=params.row,wordIndex=params.wordIndex,dx=params.dx,word=row.words[wordIndex],prevWord=row.words[wordIndex-1],leftPadding=word.isPunct?this.config.wordPunctPadding:this.config.wordPadding,space=word.x;if(dx<=(space-=prevWord?prevWord.x+prevWord.boxWidth+leftPadding:this.config.rowEdgePadding))return word.dx(-dx),!0;if(0===wordIndex){var prevRow=this._rows[row.idx-1];if(!prevRow)return!1;if(prevRow.availableSpace>=word.boxWidth+leftPadding)return this.moveWordUpARow(row.idx),!0;var prevRowShift=word.boxWidth+leftPadding-prevRow.availableSpace;return!!this.moveWordLeft({row:prevRow,wordIndex:prevRow.words.length-1,dx:prevRowShift})&&(this.moveWordUpARow(row.idx),!0)}return!!this.moveWordLeft({row:row,wordIndex:wordIndex-1,dx:dx})&&(word.dx(-dx),!0)}},{key:"moveWordUpARow",value:function(index){var prevRow=this._rows[index-1];if(prevRow){var removedWord=this._rows[index].removeFirstWord(),newX=prevRow.rw-this.config.rowEdgePadding-removedWord.boxWidth;this.addWordToRow(removedWord,prevRow,void 0,newX),removedWord.redrawClusters(),removedWord.redrawLinks()}}},{key:"moveWordDownARow",value:function(index){var nextRow=this._rows[index+1]||this.appendRow();this.addWordToRow(this._rows[index].removeLastWord(),nextRow,0)}},{key:"lastRow",get:function(){return this._rows[this._rows.length-1]}},{key:"rows",get:function(){return this._rows}}]),RowManager}();var _$RowManager_90=RowManager;

var _$randomColor_76 = { exports: {} };
!function(root,factory){if("object"==typeof _$randomColor_76.exports){var randomColor=factory();"object"=="object"&&_$randomColor_76&&_$randomColor_76.exports&&(_$randomColor_76.exports=_$randomColor_76.exports=randomColor),_$randomColor_76.exports.randomColor=randomColor}else"function"==typeof define&&define.amd?define([],factory):root.randomColor=factory()}(this,function(){var seed=null,colorDictionary={};defineColor("monochrome",null,[[0,0],[100,0]]),defineColor("red",[-26,18],[[20,100],[30,92],[40,89],[50,85],[60,78],[70,70],[80,60],[90,55],[100,50]]),defineColor("orange",[19,46],[[20,100],[30,93],[40,88],[50,86],[60,85],[70,70],[100,70]]),defineColor("yellow",[47,62],[[25,100],[40,94],[50,89],[60,86],[70,84],[80,82],[90,80],[100,75]]),defineColor("green",[63,178],[[30,100],[40,90],[50,85],[60,81],[70,74],[80,64],[90,50],[100,40]]),defineColor("blue",[179,257],[[20,100],[30,86],[40,80],[50,74],[60,60],[70,52],[80,44],[90,39],[100,35]]),defineColor("purple",[258,282],[[20,100],[30,87],[40,79],[50,70],[60,65],[70,59],[80,52],[90,45],[100,42]]),defineColor("pink",[283,334],[[20,100],[30,90],[40,86],[60,84],[80,80],[90,75],[100,73]]);var randomColor=function(options){if(void 0!==(options=options||{}).seed&&null!==options.seed&&options.seed===parseInt(options.seed,10))seed=options.seed;else if("string"==typeof options.seed)seed=function(string){for(var total=0,i=0;i!==string.length&&!(total>=Number.MAX_SAFE_INTEGER);i++)total+=string.charCodeAt(i);return total}(options.seed);else{if(void 0!==options.seed&&null!==options.seed)throw new TypeError("The seed value must be an integer or string");seed=null}var H,S;if(null!==options.count&&void 0!==options.count){var totalColors=options.count,colors=[];for(options.count=null;totalColors>colors.length;)seed&&options.seed&&(options.seed+=1),colors.push(randomColor(options));return options.count=totalColors,colors}return function(hsv,options){switch(options.format){case"hsvArray":return hsv;case"hslArray":return HSVtoHSL(hsv);case"hsl":var hsl=HSVtoHSL(hsv);return"hsl("+hsl[0]+", "+hsl[1]+"%, "+hsl[2]+"%)";case"hsla":var hslColor=HSVtoHSL(hsv),alpha=options.alpha||Math.random();return"hsla("+hslColor[0]+", "+hslColor[1]+"%, "+hslColor[2]+"%, "+alpha+")";case"rgbArray":return HSVtoRGB(hsv);case"rgb":var rgb=HSVtoRGB(hsv);return"rgb("+rgb.join(", ")+")";case"rgba":var rgbColor=HSVtoRGB(hsv),alpha=options.alpha||Math.random();return"rgba("+rgbColor.join(", ")+", "+alpha+")";default:return function(hsv){var rgb=HSVtoRGB(hsv);function componentToHex(c){var hex=c.toString(16);return 1==hex.length?"0"+hex:hex}return"#"+componentToHex(rgb[0])+componentToHex(rgb[1])+componentToHex(rgb[2])}(hsv)}}([H=function(options){var hue=randomWithin(function(colorInput){if("number"==typeof parseInt(colorInput)){var number=parseInt(colorInput);if(number<360&&number>0)return[number,number]}if("string"==typeof colorInput)if(colorDictionary[colorInput]){var color=colorDictionary[colorInput];if(color.hueRange)return color.hueRange}else if(colorInput.match(/^#?([0-9A-F]{3}|[0-9A-F]{6})$/i)){var hue=function(hex){hex=3===(hex=hex.replace(/^#/,"")).length?hex.replace(/(.)/g,"$1$1"):hex;var red=parseInt(hex.substr(0,2),16)/255,green=parseInt(hex.substr(2,2),16)/255,blue=parseInt(hex.substr(4,2),16)/255,cMax=Math.max(red,green,blue),delta=cMax-Math.min(red,green,blue),saturation=cMax?delta/cMax:0;switch(cMax){case red:return[(green-blue)/delta%6*60||0,saturation,cMax];case green:return[60*((blue-red)/delta+2)||0,saturation,cMax];case blue:return[60*((red-green)/delta+4)||0,saturation,cMax]}}(colorInput)[0];return[hue,hue]}return[0,360]}(options.hue));hue<0&&(hue=360+hue);return hue}(options),S=function(hue,options){if("monochrome"===options.hue)return 0;if("random"===options.luminosity)return randomWithin([0,100]);var saturationRange=function(hue){return getColorInfo(hue).saturationRange}(hue),sMin=saturationRange[0],sMax=saturationRange[1];switch(options.luminosity){case"bright":sMin=55;break;case"dark":sMin=sMax-10;break;case"light":sMax=55}return randomWithin([sMin,sMax])}(H,options),function(H,S,options){var bMin=function(H,S){for(var lowerBounds=getColorInfo(H).lowerBounds,i=0;i<lowerBounds.length-1;i++){var s1=lowerBounds[i][0],v1=lowerBounds[i][1],s2=lowerBounds[i+1][0],v2=lowerBounds[i+1][1];if(S>=s1&&S<=s2){var m=(v2-v1)/(s2-s1),b=v1-m*s1;return m*S+b}}return 0}(H,S),bMax=100;switch(options.luminosity){case"dark":bMax=bMin+20;break;case"light":bMin=(bMax+bMin)/2;break;case"random":bMin=0,bMax=100}return randomWithin([bMin,bMax])}(H,S,options)],options)};function getColorInfo(hue){for(var colorName in hue>=334&&hue<=360&&(hue-=360),colorDictionary){var color=colorDictionary[colorName];if(color.hueRange&&hue>=color.hueRange[0]&&hue<=color.hueRange[1])return colorDictionary[colorName]}return"Color not found"}function randomWithin(range){if(null===seed)return Math.floor(range[0]+Math.random()*(range[1]+1-range[0]));var max=range[1]||1,min=range[0]||0,rnd=(seed=(9301*seed+49297)%233280)/233280;return Math.floor(min+rnd*(max-min))}function defineColor(name,hueRange,lowerBounds){var sMin=lowerBounds[0][0],sMax=lowerBounds[lowerBounds.length-1][0],bMin=lowerBounds[lowerBounds.length-1][1],bMax=lowerBounds[0][1];colorDictionary[name]={hueRange:hueRange,lowerBounds:lowerBounds,saturationRange:[sMin,sMax],brightnessRange:[bMin,bMax]}}function HSVtoRGB(hsv){var h=hsv[0];0===h&&(h=1),360===h&&(h=359),h/=360;var s=hsv[1]/100,v=hsv[2]/100,h_i=Math.floor(6*h),f=6*h-h_i,p=v*(1-s),q=v*(1-f*s),t=v*(1-(1-f)*s),r=256,g=256,b=256;switch(h_i){case 0:r=v,g=t,b=p;break;case 1:r=q,g=v,b=p;break;case 2:r=p,g=v,b=t;break;case 3:r=p,g=q,b=v;break;case 4:r=t,g=p,b=v;break;case 5:r=v,g=p,b=q}return[Math.floor(255*r),Math.floor(255*g),Math.floor(255*b)]}function HSVtoHSL(hsv){var h=hsv[0],s=hsv[1]/100,v=hsv[2]/100,k=(2-s)*v;return[h,Math.round(s*v/(k<1?k:2-k)*1e4)/100,k/2*100]}return randomColor});

_$randomColor_76 = _$randomColor_76.exports
"use strict";var ___classCallCheck2_81=_$interopRequireDefault_8(_$classCallCheck_6),___createClass2_81=_$interopRequireDefault_8(_$createClass_7),ColorPicker=function(){function ColorPicker(className){var _this=this,options=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};(0,___classCallCheck2_81.default)(this,ColorPicker),this.initialColor=options.initialColor||"#000000",this.llColor=options.lightLabelColor||"#dddddd",this.dlColor=options.darkLabelColor||"#333333",this.changeCallback=options.changeCallback||null,this.currentInput,this.picker=document.createElement("input"),this.picker.type="color",this.picker.style="position:absolute; display: block; opacity: 0; z-index:-100;",this.picker.onchange=function(){_this.currentInput&&(_this.setColor(_this.currentInput,_this.picker.value),_this.changeCallback&&_this.changeCallback(_this.currentInput))},document.body.appendChild(this.picker);var nodes=document.querySelectorAll("input.".concat(className));this.registerInputs(nodes)}return(0,___createClass2_81.default)(ColorPicker,[{key:"registerInputs",value:function(nodes){var _this2=this;nodes.forEach(function(input){_this2.setColor(input,_this2.initialColor),input.setAttribute("readonly",!0),input.onclick=function(){_this2.currentInput=input,_this2.picker.focus(),_this2.picker.click(),input.focus(),_this2.picker.value=input.colorValue}})}},{key:"getLabelColor",value:function(bgColor){return this.RGBLum(bgColor)>128?this.dlColor:this.llColor}},{key:"setColor",value:function(input,hex){input.colorValue=hex,input.value=hex,input.style.backgroundColor=hex,input.style.color=this.getLabelColor(hex)}},{key:"RGBLum",value:function(hex){var c=parseInt(hex.slice(1),16);return.299*(c>>16&255)+.587*(c>>8&255)+.114*(c>>0&255)}}]),ColorPicker}();var _$ColorPicker_81=ColorPicker;

"use strict";var ___classCallCheck2_91=_$interopRequireDefault_8(_$classCallCheck_6),___createClass2_91=_$interopRequireDefault_8(_$createClass_7),___word_91=(_$interopRequireDefault_8(_$ColorPicker_81),_$interopRequireDefault_8(_$Word_85)),TaxonomyManager=function(){function TaxonomyManager(){(0,___classCallCheck2_91.default)(this,TaxonomyManager),this.taxonomy=[],this.taxonomyYaml="",this.tagColours={},this.defaultColours=["#3fa1d1","#ed852a","#2ca02c","#c34a1d","#a048b3","#e377c2","#bcbd22","#17becf","#e7298a","#e6ab02","#7570b3","#a6761d","#7f7f7f"]}return(0,___createClass2_91.default)(TaxonomyManager,[{key:"loadTaxonomyYaml",value:function(taxonomyYaml){this.taxonomy=_$yaml_43.safeLoad(taxonomyYaml),this.taxonomyYaml=taxonomyYaml}},{key:"getTaxonomyYaml",value:function(){return this.taxonomyYaml}},{key:"getTaxonomyTree",value:function(){return this.taxonomy}},{key:"colour",value:function(words){var _this=this;words.forEach(function(word){word.tag&&(_this.tagColours[word.tag.val]||_this.assignColour(word.tag.val,_this.getNewColour()),TaxonomyManager.setColour(word,_this.tagColours[word.tag.val])),word.clusters.length>0&&word.clusters.forEach(function(cluster){_this.tagColours[cluster.val]||_this.assignColour(cluster.val,_this.getNewColour()),TaxonomyManager.setColour(cluster,_this.tagColours[cluster.val])})})}},{key:"color",value:function(words){return this.colour(words)}},{key:"assignColour",value:function(label,colour){this.tagColours[label]=colour}},{key:"getColour",value:function(label){return this.tagColours[label]}},{key:"getNewColour",value:function(){return this.defaultColours.length>0?this.defaultColours.shift():_$randomColor_76()}}],[{key:"setColour",value:function(element,colour){element instanceof ___word_91.default?element.tag.svgText.node.style.fill=colour:element.svgText.node.style.fill=colour}}]),TaxonomyManager}();var _$TaxonomyManager_91=TaxonomyManager;

var _$arrayWithHoles_4=function(arr){if(Array.isArray(arr))return arr};

var _$iterableToArrayLimit_10=function(arr,i){var _arr=[],_n=!0,_d=!1,_e=void 0;try{for(var _s,_i=arr[Symbol.iterator]();!(_n=(_s=_i.next()).done)&&(_arr.push(_s.value),!i||_arr.length!==i);_n=!0);}catch(err){_d=!0,_e=err}finally{try{_n||null==_i.return||_i.return()}finally{if(_d)throw _e}}return _arr};

var _$nonIterableRest_11=function(){throw new TypeError("Invalid attempt to destructure non-iterable instance")};

/* removed: var _$nonIterableRest_11=require("./nonIterableRest"); */;var _$slicedToArray_12=function(arr,i){return _$arrayWithHoles_4(arr)||_$iterableToArrayLimit_10(arr,i)||_$nonIterableRest_11()};

"use strict";var _slicedToArray2=_$interopRequireDefault_8(_$slicedToArray_12),___classCallCheck2_92=_$interopRequireDefault_8(_$classCallCheck_6),___createClass2_92=_$interopRequireDefault_8(_$createClass_7),___word_92=_$interopRequireDefault_8(_$Word_85),___link_92=_$interopRequireDefault_8(_$Link_82),BratParser=function(){function BratParser(){(0,___classCallCheck2_92.default)(this,BratParser),this.data={},this.re=/:+(?=[TER]\d+$)/,this.text="",this.mentions={}}return(0,___createClass2_92.default)(BratParser,[{key:"parse",value:function(textInput,entInput,evtInput){var lines,_this=this;if(this.mentions={},entInput)this.text=textInput,lines=entInput.split("\n"),evtInput&&(lines=lines.concat(evtInput.split("\n")));else{var splitLines=textInput.split("\n");this.text=splitLines[0],lines=splitLines.slice(1)}lines.forEach(function(line){var tokens=line.trim().split(/\s+/);tokens[0]&&tokens[0].match(/[TER]\d+/)&&(_this.mentions[tokens[0]]={annotation:tokens,object:null})});var graph={words:[],links:[],clusters:[]};for(var id in this.textArray=[{charStart:0,charEnd:this.text.length,entity:null}],this.mentions)this.mentions[id]&&null===this.mentions[id].object&&this.parseAnnotation(id,graph);graph.words.length;var idx=0;this.textArray.forEach(function(t,i){if(null===t.entity){var text=_this.text.slice(t.charStart,t.charEnd).trim();if(""===text)return;text.split(/\s+/).forEach(function(token){var word=new ___word_92.default(token,idx);graph.words.push(word),idx++})}else t.entity.idx=idx,idx++}),graph.words.sort(function(a,b){return a.idx-b.idx}),this.data=graph}},{key:"parseAnnotation",value:function(id,graph){var m=this.mentions[id];if(void 0===m)return null;if(null!==m.object)return m.object;var tokens=m.annotation;switch(tokens[0].charAt(0)){case"T":var tbm=this.parseTextMention(tokens);return null===tbm?(delete this.mentions[id],null):(graph.words.push(tbm),m.object=tbm,tbm);case"E":var em=this.parseEventMention(tokens,graph);return null===em?(delete this.mentions[id],null):(graph.links.push(em),m.object=em,em);case"R":var rm=this.parseRelationMention(tokens,graph);return null===rm?(delete this.mentions[id],null):(graph.links.push(rm),m.object=rm,rm)}return null}},{key:"parseTextMention",value:function(tokens){var id=tokens[0].slice(1),label=tokens[1],charStart=Number(tokens[2]),charEnd=Number(tokens[3]);if(charStart>=0&&charStart<charEnd&&charEnd<=this.text.length){var word=new ___word_92.default(this.text.slice(charStart,charEnd),Number(id));word.setTag(label),word.addEventId(id);var textWord={charStart:charStart,charEnd:charEnd,entity:word},i=this.textArray.findIndex(function(token){return token.charEnd>charStart});if(-1===i)console.log("// mistake in tokenizing string");else if(this.textArray[i].charStart<charStart){var tempEnd=this.textArray[i].charEnd;this.textArray[i].charEnd=charStart,tempEnd>charEnd?this.textArray.splice(i+1,0,textWord,{charStart:charEnd,charEnd:tempEnd,entity:null}):this.textArray.splice(i+1,0,textWord)}else this.textArray[i].charEnd===charEnd?this.textArray[i].entity=word:(this.textArray.splice(i,0,textWord),this.textArray[i+1].charStart=charEnd,this.textArray[i+1].entity=null);return word}return null}},{key:"searchBackwards",value:function(arr,fn){for(var i=arr.length-1;i>=0;--i)if(fn(arr[i]))return arr[i];return null}},{key:"parseEventMention",value:function(tokens,graph){var _this2=this,successfulParse=!0,id=tokens[0],args=tokens.slice(1).map(function(token,i){var _token$split=token.split(_this2.re),_token$split2=(0,_slicedToArray2.default)(_token$split,2),label=_token$split2[0],id=_token$split2[1],object=_this2.parseAnnotation(id,graph);return null!==object?{type:label,anchor:object}:(0===i&&(successfulParse=!1),null)}).filter(function(arg){return arg});return successfulParse&&args.length>1?new ___link_92.default(id,args[0].anchor,args.slice(1)):null}},{key:"parseRelationMention",value:function(tokens,graph){var _this3=this;if(tokens.length<4)return null;var successfulParse=!0,id=tokens[0],reltype=tokens[1],args=tokens.slice(2,4).map(function(token){var _token$split3=token.split(_this3.re),_token$split4=(0,_slicedToArray2.default)(_token$split3,2),label=_token$split4[0],id=_token$split4[1],object=_this3.parseAnnotation(id,graph);if(null!==object)return{type:label,anchor:object};successfulParse=!1});return!0===successfulParse?new ___link_92.default(id,null,args,reltype):null}}]),BratParser}();var _$BratParser_92=BratParser;

"use strict";var ___classCallCheck2_86=_$interopRequireDefault_8(_$classCallCheck_6),___createClass2_86=_$interopRequireDefault_8(_$createClass_7),WordCluster=function(){function WordCluster(){var _this=this,words=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[],val=arguments.length>1?arguments[1]:void 0;(0,___classCallCheck2_86.default)(this,WordCluster),this.eventIds=[],this.val=val,this.words=words,this.slot=words.reduce(function(acc,w){return Math.max(acc,w.slot)},0),this.metaValue=words.map(function(w){return w.clusters.push(_this),w.val}).join(" "),this.setEndpoints(),this.links=[],this.svgs=[],this.lines=[],this.svgText=null,this.x=0}return(0,___createClass2_86.default)(WordCluster,[{key:"addEventId",value:function(id){this.eventIds.indexOf(id)<0&&this.eventIds.push(id)}},{key:"setTag",value:function(tag){this.val=tag}},{key:"text",value:function(val){if(this.val=val,this.svgText.text(this.val),this.editingRect){var bbox=this.svgText.bbox();bbox.width>0?this.editingRect.width(bbox.width+8).height(bbox.height+4).x(bbox.x-4).y(bbox.y-2):this.editingRect.width(10).x(this.svgText.x()-5)}}},{key:"setEndpoints",value:function(){this.endpoints=[this.words[0],this.words[this.words.length-1]]}},{key:"init",value:function(word){var _this2=this,i=this.endpoints.indexOf(word);if(0===i||1===i){if(this.svgs[i])console.log("already exists u dumb fuck");else{var svg=this.svgs[i]=word.svg.group().addClass("tag-element").addClass("word-cluster");this.words.find(function(word){return word.tag})?svg.y(1.9*this.tagOffset):svg.y(this.tagOffset),this.lines[i]=svg.path().addClass("tag-element"),0===i&&(this.svgText=svg.text(this.val),this.svgText.node.oncontextmenu=function(e){e.preventDefault(),word.mainSVG.fire("tag-right-click",{object:_this2,event:e})},this.svgText.click(function(e){return word.mainSVG.fire("tag-edit",{object:_this2})}))}this.draw()}}},{key:"draw",value:function(){var _this3=this;if(this.lines[1]){var left=this.endpoints[0].x,right=this.endpoints[1].x+this.endpoints[1].boxWidth,lOffset=-this.endpoints[0].boxWidth/2,rOffset=this.endpoints[1].boxWidth/2;if(this.endpoints[0].row===this.endpoints[1].row){var center=(-left+right)/2;this.x=center+lOffset,this.svgText.x(center+lOffset),this.lines[0].plot("M"+lOffset+",33c0,-10,"+[center,0,center,-8]),this.lines[1].plot("M"+rOffset+",33c0,-10,"+[-center,0,-center,-8])}else{var _center=(-left+this.endpoints[0].row.rw)/2+10;this.x=_center+lOffset,this.svgText.x(_center+lOffset),this.lines[0].plot("M"+lOffset+",33c0,-10,"+[_center,0,_center,-8]+"c0,10,"+[_center,0,_center,8]),this.lines[1].plot("M"+rOffset+",33c0,-10,"+[8-right,0,8-right,-8]+"c0,10,"+[8-right,0,8-right,8])}this.links.forEach(function(l){return l.draw(_this3)})}}},{key:"remove",value:function(){var _this4=this;this.svgs.forEach(function(svg){return svg.remove()}),this.words.forEach(function(word){var i=word.clusters.indexOf(_this4);i>-1&&word.clusters.splice(i,1)})}},{key:"listenForEdit",value:function(){this.isEditing=!0;var bbox=this.svgText.bbox();this.svgs[0].addClass("tag-element").addClass("editing"),this.editingRect=this.svgs[0].rect(bbox.width+8,bbox.height+4).x(bbox.x-4).y(bbox.y-2).rx(2).ry(2).back()}},{key:"stopEditing",value:function(){this.isEditing=!1,this.svgs[0].removeClass("editing"),this.editingRect.remove(),this.editingRect=null,this.val=this.val.trim(),this.val||this.remove()}},{key:"row",get:function(){return this.endpoints[0].row}},{key:"absoluteY",get:function(){return this.endpoints[0].absoluteY}},{key:"idx",get:function(){return this.endpoints[0].idx}},{key:"cx",get:function(){return this.endpoints[0].cx}},{key:"ww",get:function(){return this.svgText.length()}},{key:"tagOffset",get:function(){return-28}}]),WordCluster}();var _$WordCluster_86=WordCluster;

"use strict";var ___slicedToArray2_94=_$interopRequireDefault_8(_$slicedToArray_12),___classCallCheck2_94=_$interopRequireDefault_8(_$classCallCheck_6),___createClass2_94=_$interopRequireDefault_8(_$createClass_7),___word_94=_$interopRequireDefault_8(_$Word_85),_wordcluster=_$interopRequireDefault_8(_$WordCluster_86),___link_94=_$interopRequireDefault_8(_$Link_82),ReachParser=function(){function ReachParser(){(0,___classCallCheck2_94.default)(this,ReachParser),this.data={}}return(0,___createClass2_94.default)(ReachParser,[{key:"parse",value:function(data){var text=data.syntaxData.text,tokens=data.syntaxData.entities.sort(function(a,b){return a[2][0][0]-b[2][0][0]}).map(function(x){return{text:text.substring(x[2][0][0],x[2][0][1]),id:x[0],type:x[1],startIndex:x[2][0][0],endIndex:x[2][0][1]}});function findTokenByIndex(_ref){var _ref2=(0,___slicedToArray2_94.default)(_ref,2),i1=_ref2[0],i2=_ref2[1];return[tokens.findIndex(function(token){return token.startIndex===i1}),tokens.findIndex(function(token){return token.endIndex===i2})]}var syntax=data.syntaxData.relations.map(function(arr){return{id:arr[0],trigger:arr[2][0][1],arguments:[{id:arr[2][1][1],type:arr[1]}]}}),e=data.eventData,entities=e.entities.map(function(arr){return{id:arr[0],type:arr[1],tokenIndex:findTokenByIndex(arr[2][0]),string:e.text.substring(arr[2][0][0],arr[2][0][1])}}),triggers=e.triggers.map(function(arr){return{id:arr[0],type:arr[1],tokenIndex:findTokenByIndex(arr[2][0]),string:e.text.substring(arr[2][0][0],arr[2][0][1])}}),events=e.events.map(function(arr){return{id:arr[0],trigger:arr[1],arguments:arr[2].map(function(argument){return{id:argument[1],type:argument[0]}})}}),relations=e.relations.map(function(arr){return{id:arr[0],type:arr[1],arguments:arr[2].map(function(argument){return{id:argument[1],type:argument[0]}})}});this.buildWordsAndLinks(tokens,entities,triggers,events,relations,syntax)}},{key:"buildWordsAndLinks",value:function(tokens,entities,triggers,events,relations,syntax){var words=tokens.map(function(token,i){var w=new ___word_94.default(token.text,i);return w.setSyntaxTag(token.type),w.setSyntaxId(token.id),w}),clusters=[];function searchForEntity(argument){var anchor;switch(argument.id.charAt(0)){case"E":case"R":anchor=links.find(function(link){return link.eventId===argument.id});break;case"T":anchor=entities.find(function(word){return word.eventIds.indexOf(argument.id)>-1});break;default:console.log("unhandled argument type",argument)}return{anchor:anchor,type:argument.type}}[].concat(entities,triggers).forEach(function(el){if(el.tokenIndex[0]===el.tokenIndex[1])words[el.tokenIndex[0]].setTag(el.type),words[el.tokenIndex[0]].addEventId(el.id);else{for(var cluster=[],i=el.tokenIndex[0];i<=el.tokenIndex[1];++i)cluster.push(words[i]);var wordCluster=new _wordcluster.default(cluster,el.type);wordCluster.addEventId(el.id),clusters.push(wordCluster)}}),entities=words.concat(clusters);var links=[];events.forEach(function(evt){var trigger=entities.find(function(word){return word.eventIds.indexOf(evt.trigger)>-1}),args=evt.arguments.map(searchForEntity),link=new ___link_94.default(evt.id,trigger,args);links.push(link)}),relations.forEach(function(rel){var args=rel.arguments.map(searchForEntity),link=new ___link_94.default(rel.id,null,args,rel.type);links.push(link)}),syntax.forEach(function(syn){var trigger=entities.find(function(word){return word.syntaxId===syn.trigger}),args=syn.arguments.map(function(arg){return{anchor:words.find(function(w){return w.syntaxId===arg.id}),type:arg.type}}),link=new ___link_94.default(syn.id,trigger,args,null,!1);links.push(link)}),this.data={words:words,links:links,clusters:clusters}}}]),ReachParser}();var _$ReachParser_94=ReachParser;

"use strict";var _$xhr_97=function(url){var xhr=new XMLHttpRequest;return xhr.open("GET",url),xhr.send(),new Promise(function(res,err){xhr.onreadystatechange=function(){4===xhr.readyState&&(200===xhr.status?res(xhr.responseText):err(xhr))}})};

"use strict";var ___classCallCheck2_93=_$interopRequireDefault_8(_$classCallCheck_6),___createClass2_93=_$interopRequireDefault_8(_$createClass_7),___lodash_93=_$interopRequireDefault_8(_$lodash_73),_reach=_$interopRequireDefault_8(_$ReachParser_94),_ann=_$interopRequireDefault_8(_$BratParser_92),_xhr=_$interopRequireDefault_8(_$xhr_97),re=/.*(?=\.(\S+))|.*/,Parser=function(){function Parser(){(0,___classCallCheck2_93.default)(this,Parser),this._parsedData={words:[],links:[],clusters:[]},this.reach=new _reach.default,this.ann=new _ann.default}return(0,___createClass2_93.default)(Parser,[{key:"loadData",value:function(data,format){if("json"===format)this.parseJson(data);else{if("brat"!==format)throw"Unknown annotation format: ".concat(format);this.parseText(data)}return this.getParsedData()}},{key:"loadFiles",value:function(files,format){if(1===files.length){var file=files[0];if("json"===format)this.parseJson(JSON.parse(file.content));else{if("brat"!==format)throw"Unknown annotation format: ".concat(format);this.parseText(file.content)}}else{files.sort(function(a,b){return a.name.localeCompare(b.name)});for(var matchingFiles=[],iname=files[0].name.match(re),j=1;j<files.length;++j){var jname=files[j].name.match(re);if(jname[1]&&jname[0]===iname[0]){matchingFiles.push(files[0],files[j]);for(var k=j+1;k<files.length;){var kname=files[k].name.match(re);if(!kname[1]||kname[0]!==iname[0])break;matchingFiles.push(files[k]),++k}break}}if("brat"!==format)throw"Unknown format, or wrong number/type of files for format";if(2===matchingFiles.length){var text=matchingFiles.find(function(file){return file.name.endsWith(".txt")}),standoff=matchingFiles.find(function(file){return!file.name.endsWith(".txt")});this.parseText(text.content,standoff.content)}else{var _text=matchingFiles.find(function(file){return file.name.endsWith(".txt")}),entities=matchingFiles.find(function(file){return file.name.endsWith(".a1")}),evts=matchingFiles.find(function(file){return file.name.endsWith(".a2")});if(!(_text&&evts&&entities))throw"Wrong number/type of files for Brat format";this.parseText(_text.content,entities.content,evts.content)}}return this.getParsedData()}},{key:"loadFile",value:function(path,format){var _this=this;if(!format){var extension=path.toLowerCase().match(re)[1];format="json"===extension?"json":"brat"}return(0,_xhr.default)(path).then(function(data){return"json"===format?_this.parseJson(JSON.parse(data)):"brat"===format&&_this.parseText(data),_this.getParsedData()})}},{key:"parseFiles",value:function(files){if(1===files.length){var file=files[0];return"application/json"===file.type?this.parseJson(JSON.parse(file.content)):""===file.type&&this.parseText(file.content),file.name}if(files.length>1){files.sort(function(a,b){return a.name.localeCompare(b.name)});for(var matchingFiles=[],iname=files[0].name.match(re),j=1;j<files.length;++j){var jname=files[j].name.match(re);if(jname[1]&&jname[0]===iname[0]){matchingFiles.push(files[0],files[j]);for(var k=j+1;k<files.length;){var kname=files[k].name.match(re);if(!kname[1]||kname[0]!==iname[0])break;matchingFiles.push(files[k]),++k}break}}if(2===matchingFiles.length){var text=matchingFiles.find(function(file){return file.name.endsWith(".txt")}),standoff=matchingFiles.find(function(file){return!file.name.endsWith(".txt")});return this.parseText(text.content,standoff.content),[text.name,standoff.name].join("\n")}var _text2=matchingFiles.find(function(file){return file.name.endsWith(".txt")}),entities=matchingFiles.find(function(file){return file.name.endsWith(".a1")}),evts=matchingFiles.find(function(file){return file.name.endsWith(".a2")});return _text2&&evts&&entities&&this.parseText(_text2.content,entities.content,evts.content),[_text2.name,entities.name,evts.name].join("\n")}}},{key:"getParsedData",value:function(){return ___lodash_93.default.cloneDeep(this._parsedData)}},{key:"parseJson",value:function(data){this.reach.parse(data),this._parsedData=this.reach.data}},{key:"parseText",value:function(){this.ann.parse.apply(this.ann,arguments),this._parsedData=this.ann.data}}]),Parser}();var _$Parser_93=Parser;

"use strict";var _class,_regenerator=_$interopRequireDefault_8(_$regenerator_13),_asyncToGenerator2=_$interopRequireDefault_8(_$asyncToGenerator_5),___classCallCheck2_88=_$interopRequireDefault_8(_$classCallCheck_6),___createClass2_88=_$interopRequireDefault_8(_$createClass_7),___lodash_88=_$interopRequireDefault_8(_$lodash_73),_jquery=_$interopRequireDefault_8(_$jquery_42),__SVG_88=_$interopRequireWildcard_9(_$svg_80),_parse=_$interopRequireDefault_8(_$Parser_93),_rowmanager=_$interopRequireDefault_8(_$RowManager_90),_labelmanager=_$interopRequireDefault_8(_$labelmanager_89),_taxonomy=_$interopRequireDefault_8(_$TaxonomyManager_91),_config=_$interopRequireDefault_8(_$Config_87),__Util_88=_$interopRequireWildcard_9(_$util_96),Main=(0,_$interopRequireDefault_8(_$lib_14).default)(_class=function(){function Main(container){(0,___classCallCheck2_88.default)(this,Main),this.config=new _config.default,___lodash_88.default.hasIn(container,"jquery")&&(container=container[0]),this.svg=new __SVG_88.Doc(container),this.$container=(0,_jquery.default)(this.svg.node).parent(),this.parser=new _parse.default,this.rowManager=new _rowmanager.default(this.svg,this.config),this.labelManager=new _labelmanager.default(this.svg),this.taxonomyManager=new _taxonomy.default,this.words=[],this.links=[],this.options={showSyntax:!1,showLinksOnMove:!1,showTreeInModal:!1},this.resize(),this._setupSVGListeners(),this._setupUIListeners()}var _loadFilesAsync,_loadUrlAsync;return(0,___createClass2_88.default)(Main,[{key:"loadData",value:function(data,format){this.parser.loadData(data,format),this.redraw()}},{key:"loadUrlAsync",value:(_loadUrlAsync=(0,_asyncToGenerator2.default)(_regenerator.default.mark(function _callee(path,format){var data;return _regenerator.default.wrap(function(_context){for(;;)switch(_context.prev=_context.next){case 0:return _context.next=2,_jquery.default.ajax(path);case 2:data=_context.sent,this.parser.loadData(data,format),this.redraw();case 5:case"end":return _context.stop()}},_callee,this)})),function(_x,_x2){return _loadUrlAsync.apply(this,arguments)})},{key:"loadFilesAsync",value:(_loadFilesAsync=(0,_asyncToGenerator2.default)(_regenerator.default.mark(function _callee2(fileList,format){var readPromises,files;return _regenerator.default.wrap(function(_context2){for(;;)switch(_context2.prev=_context2.next){case 0:return readPromises=___lodash_88.default.map(fileList,function(file){var reader=new FileReader;return reader.readAsText(file),new Promise(function(resolve,reject){reader.onload=function(){resolve({name:file.name,type:file.type,content:reader.result})}})}),_context2.next=3,Promise.all(readPromises);case 3:files=_context2.sent,this.parser.loadFiles(files,format),this.redraw();case 6:case"end":return _context2.stop()}},_callee2,this)})),function(_x3,_x4){return _loadFilesAsync.apply(this,arguments)})},{key:"draw",value:function(){var _this=this,data=this.parser.getParsedData();this.words=data.words,this.links=data.links,this.links=__Util_88.sortForSlotting(this.links),this.links.forEach(function(link){link.calculateSlot(_this.words)}),this.words.length>0&&!this.rowManager.lastRow&&this.rowManager.appendRow(),this.words.forEach(function(word){word.init(_this.svg,_this.config),_this.rowManager.addWordToRow(word,_this.rowManager.lastRow)}),this.links.forEach(function(link){link.init(_this)});var _iteratorNormalCompletion=!0,_didIteratorError=!1,_iteratorError=void 0;try{for(var _step,_iterator=this.links[Symbol.iterator]();!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=!0){_step.value.draw()}}catch(err){_didIteratorError=!0,_iteratorError=err}finally{try{_iteratorNormalCompletion||null==_iterator.return||_iterator.return()}finally{if(_didIteratorError)throw _iteratorError}}this.taxonomyManager.colour(this.words),this.options.showSyntax?this.showSyntax():this.hideSyntax(),this.rowManager.resizeAll()}},{key:"clear",value:function(){for(;this.rowManager.rows.length>0;)this.rowManager.removeRow();this.links.forEach(function(link){return link.svg&&link.svg.remove()})}},{key:"redraw",value:function(){this.clear(),this.draw()}},{key:"resize",value:function(){this.svg.size(this.$container.innerWidth(),this.$container.innerHeight()),this.rowManager.resizeAll()}},{key:"loadTaxonomyYaml",value:function(taxonomy){return this.taxonomyManager.loadTaxonomyYaml(taxonomy)}},{key:"getTaxonomyYaml",value:function(){return this.taxonomyManager.getTaxonomyYaml()}},{key:"getTaxonomyTree",value:function(){return this.taxonomyManager.getTaxonomyTree()}},{key:"getColour",value:function(label){return this.taxonomyManager.getColour(label)}},{key:"setColour",value:function(label,colour){this.taxonomyManager.assignColour(label,colour),this.taxonomyManager.colour(this.words)}},{key:"exportFile",value:function(){var exportedSVG=this.svg.svg(),svgRules=__Util_88.getCssRules(this.$container.find(".tag-element").toArray()),i=exportedSVG.indexOf("</defs>");exportedSVG=exportedSVG.slice(0,i)+"<style>"+svgRules.join("\n")+"</style>"+exportedSVG.slice(i),(0,_jquery.default)('<a \n      href="data:image/svg+xml;charset=utf-8,'.concat(encodeURIComponent(exportedSVG),'"\n      download="tag.svg"></a>')).appendTo((0,_jquery.default)("body"))[0].click()}},{key:"setOption",value:function(option,value){this.options[option]=value}},{key:"getOption",value:function(option){return this.options[option]}},{key:"showSyntax",value:function(){this.links.forEach(function(link){link.top||link.show()}),this.rowManager.resizeAll()}},{key:"hideSyntax",value:function(){this.links.forEach(function(link){link.top||link.hide()}),this.rowManager.resizeAll()}},{key:"_setupSVGListeners",value:function(){var _this2=this;this.svg.on("row-resize",function(event){_this2.labelManager.stopEditing(),_this2.rowManager.resizeRow(event.detail.object.idx,event.detail.y)}),this.svg.on("word-move-start",function(){!_this2.options.showLinksOnMove&&_this2.options.showSyntax&&_this2.hideSyntax()}),this.svg.on("word-move",function(event){_this2.labelManager.stopEditing(),_this2.rowManager.moveWordOnRow(event.detail.object,event.detail.x)}),this.svg.on("word-move-end",function(){!_this2.options.showLinksOnMove&&_this2.options.showSyntax&&_this2.showSyntax()}),this.svg.on("row-recalculate-slots",function(){_this2.links.forEach(function(link){link.resetSlotRecalculation()}),_this2.links.forEach(function(link){link.recalculateSlots(_this2.words),link.draw()})})}},{key:"_setupUIListeners",value:function(){var _this3=this;(0,_jquery.default)(window).on("resize",___lodash_88.default.throttle(function(){_this3.resize()},50))}},{key:"xLine",value:function(x){this.svg.line(x,0,x,1e3).stroke({width:1})}},{key:"yLine",value:function(y){this.svg.line(0,y,1e3,y).stroke({width:1})}}]),Main}())||_class;var _$Main_88=Main;

"use strict";var _main=_$interopRequireDefault_8(_$Main_88);var _$tag_95={tag:function(params){if(!params.container)throw"No TAG container element specified.";var instance=new _main.default(params.container);return params.data&&params.format&&instance.loadData(params.data,params.format),instance}};

var _$demo_2 = {};
"use strict";var ___regenerator_2=_$interopRequireDefault_8(_$regenerator_13),___asyncToGenerator2_2=_$interopRequireDefault_8(_$asyncToGenerator_5);_$popper_74,_$collapse_15,_$dropdown_16,_$modal_17,_$popover_18,_$prism_75;/* removed: var _$taxonomy_3=require("./taxonomy.hbs"); */;_$runtime_41.registerPartial("taxonomySubtree",_$taxonomy_3),window.$=_$jquery_42,window.jQuery=_$jquery_42,_$jquery_42((0,___asyncToGenerator2_2.default)(___regenerator_2.default.mark(function _callee2(){var $basicContainer,basicTag,sampleTaxonomy,refreshTaxonomyTree,editor;return ___regenerator_2.default.wrap(function(_context2){for(;;)switch(_context2.prev=_context2.next){case 0:return refreshTaxonomyTree=function(){var rawTaxonomy=(void 0).getTaxonomyTree(),renderTaxonomy=function flattenTaxonomy(taxonomy,depth){depth=depth||0;var flatTaxonomy=[],currentLeafBlock=[],_iteratorNormalCompletion=!0,_didIteratorError=!1,_iteratorError=void 0;try{for(var _step,_iterator=taxonomy[Symbol.iterator]();!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=!0){var node=_step.value;if(_$lodash_73.isObject(node)){currentLeafBlock.length>0&&(flatTaxonomy.push({leaves:currentLeafBlock,padding:20*depth}),currentLeafBlock=[]);var label=_$lodash_73.keys(node)[0];flatTaxonomy.push({label:label,id:_$lodash_73.kebabCase(label),colour:(void 0).getColour(label),children:flattenTaxonomy(node[label],depth+1),padding:20*depth})}else currentLeafBlock.push({label:node,id:_$lodash_73.kebabCase(node),colour:(void 0).getColour(node)})}}catch(err){_didIteratorError=!0,_iteratorError=err}finally{try{_iteratorNormalCompletion||null==_iterator.return||_iterator.return()}finally{if(_didIteratorError)throw _iteratorError}}return currentLeafBlock.length>0&&flatTaxonomy.push({leaves:currentLeafBlock,padding:20*depth}),flatTaxonomy}(rawTaxonomy);_$jquery_42("#tag-taxonomy-tree").html(_$taxonomy_3({children:renderTaxonomy})),_$jquery_42(".tag-cp").colorpicker({format:"hex",autoInputFallback:!1}).on("change",function(event){var $this=_$jquery_42(event.target);(void 0).setColour($this.data("label"),$this.val())})},$basicContainer=_$jquery_42("#basicContainer"),basicTag=_$tag_95.tag({container:$basicContainer,data:_$data7_1,format:"json"}),window.basicTag=basicTag,_context2.next=6,basicTag.loadUrlAsync("data/simple-brat.ann","brat");case 6:return _context2.abrupt("return");case 21:sampleTaxonomy=_context2.sent,(void 0).loadTaxonomyYaml(sampleTaxonomy),refreshTaxonomyTree(),(editor=new _$codeflaskMin_21("#tag-taxonomy-editor",{language:"yaml"})).addLanguage("yaml",{scalar:{pattern:/([\-:]\s*(?:![^\s]+)?[ \t]*[|>])[ \t]*(?:((?:\r?\n|\r)[ \t]+)[^\r\n]+(?:\2[^\r\n]+)*)/,lookbehind:!0,alias:"string"},comment:/#.*/,key:{pattern:/(\s*(?:^|[:\-,[{\r\n?])[ \t]*(?:![^\s]+)?[ \t]*)[^\r\n{[\]},#\s]+?(?=\s*:\s)/,lookbehind:!0,alias:"atrule"},directive:{pattern:/(^[ \t]*)%.+/m,lookbehind:!0,alias:"important"},datetime:{pattern:/([:\-,[{]\s*(?:![^\s]+)?[ \t]*)(?:\d{4}-\d\d?-\d\d?(?:[tT]|[ \t]+)\d\d?:\d{2}:\d{2}(?:\.\d*)?[ \t]*(?:Z|[-+]\d\d?(?::\d{2})?)?|\d{4}-\d{2}-\d{2}|\d\d?:\d{2}(?::\d{2}(?:\.\d*)?)?)(?=[ \t]*(?:$|,|]|}))/m,lookbehind:!0,alias:"number"},boolean:{pattern:/([:\-,[{]\s*(?:![^\s]+)?[ \t]*)(?:true|false)[ \t]*(?=$|,|]|})/im,lookbehind:!0,alias:"important"},null:{pattern:/([:\-,[{]\s*(?:![^\s]+)?[ \t]*)(?:null|~)[ \t]*(?=$|,|]|})/im,lookbehind:!0,alias:"important"},string:{pattern:/([:\-,[{]\s*(?:![^\s]+)?[ \t]*)("|')(?:(?!\2)[^\\\r\n]|\\.)*\2(?=[ \t]*(?:$|,|]|}))/m,lookbehind:!0,greedy:!0},number:{pattern:/([:\-,[{]\s*(?:![^\s]+)?[ \t]*)[+-]?(?:0x[\da-f]+|0o[0-7]+|(?:\d+\.?\d*|\.?\d+)(?:e[+-]?\d+)?|\.inf|\.nan)[ \t]*(?=$|,|]|})/im,lookbehind:!0},tag:/![^\s]+/,important:/[&*][\w]+/,punctuation:/---|[:[\]{}\-,|>?]|\.\.\./}),_$jquery_42("#tag-taxonomy-stop-edit").on("click",function(){var $errors=_$jquery_42("#tag-taxonomy-editor-errors");try{$errors.hide();var newYaml=editor.getCode();(void 0).loadTaxonomyYaml(newYaml),refreshTaxonomyTree()}catch(err){return $errors.text(err),$errors.show()}_$jquery_42("#tag-taxonomy-view").show(),_$jquery_42("#tag-taxonomy-edit").hide()}),_$jquery_42("#tag-taxonomy-edit").hide(),_$jquery_42("#tag-taxonomy-start-edit").on("click",function(){editor.updateCode((void 0).getTaxonomyYaml()),_$jquery_42("#tag-taxonomy-view").hide(),_$jquery_42("#tag-taxonomy-edit").show()}),window._=_$lodash_73,window.basicTag=basicTag,window.uiTag=void 0,window.editor=editor,window.yaml=_$yaml_43;case 34:case"end":return _context2.stop()}},_callee2,this)})));
