...
"use strict";var ___classCallCheck2_83=_$interopRequireDefault_8(_$classCallCheck_6),___createClass2_83=_$interopRequireDefault_8(_$createClass_7),Row=(_$interopRequireWildcard_9(_$svg_80),_$interopRequireWildcard_9(_$svgDraggable_79),function(){function Row(svg,config){var idx=arguments.length>2&&void 0!==arguments[2]?arguments[2]:0,ry=arguments.length>3&&void 0!==arguments[3]?arguments[3]:0,rh=arguments.length>4&&void 0!==arguments[4]?arguments[4]:120;(0,___classCallCheck2_83.default)(this,Row),this.config=config,this.idx=idx,this.ry=ry,this.rh=rh,this.rw=0,this.words=[],this.maxSlot=0,this.minSlot=0,this.svg=null,this.draggable=null,this.wordGroup=null,svg&&this.svgInit(svg)}return(0,___createClass2_83.default)(Row,[{key:"svgInit",value:function(mainSvg){var _this=this;this.svg=mainSvg.group().transform({y:this.baseline}).addClass("tag-element").addClass("row"),this.wordGroup=this.svg.group(),this.rw=mainSvg.width(),this.draggable=this.svg.line(0,0,this.rw,0).addClass("tag-element").addClass("row-drag").draggable();var y=0;this.draggable.on("dragstart",function(e){y=e.detail.p.y}).on("dragmove",function(e){e.preventDefault();var dy=e.detail.p.y-y;y=e.detail.p.y,mainSvg.fire("row-resize",{object:_this,y:dy})})}},{key:"remove",value:function(){return this.svg.remove()}},{key:"dy",value:function(y){this.ry+=y,this.svg.transform({y:this.baseline})}},{key:"move",value:function(y){this.ry=y,this.svg.transform({y:this.baseline})}},{key:"height",value:function(rh){this.rh=rh,this.svg.transform({y:this.baseline})}},{key:"width",value:function(rw){this.rw=rw,this.draggable.attr("x2",this.rw)}},{key:"addWord",value:function(word,index,forceX){var newX;if(isNaN(index)&&(index=this.words.length),word.row=this,this.words.splice(index,0,word),this.wordGroup.add(word.svg),word.x=-1,0===index)newX=this.config.rowEdgePadding;else{var prevWord=this.words[index-1];newX=prevWord.x+prevWord.boxWidth,word.isPunct?newX+=this.config.wordPunctPadding:newX+=this.config.wordPadding}return forceX&&(newX=forceX),this.positionWord(word,newX)}},{key:"positionWord",value:function(word,newX){var wordIndex=this.words.indexOf(word),prevWord=this.words[wordIndex-1],nextWord=this.words[wordIndex+1],overflowIndex=this.words.length;if(prevWord){var wordPadding=word.isPunct?this.config.wordPunctPadding:this.config.wordPadding;if(newX<prevWord.x+prevWord.boxWidth+wordPadding)throw"Trying to position new Word over existing one!\n        (Row: ".concat(this.idx,", wordIndex: ").concat(wordIndex,")")}if(nextWord){var nextWordPadding=nextWord.isPunct?this.config.wordPunctPadding:this.config.wordPadding;nextWord.x-nextWordPadding<newX+word.boxWidth&&(overflowIndex=this.positionWord(nextWord,newX+word.boxWidth+nextWordPadding))}return newX+word.boxWidth>this.rw-this.config.rowEdgePadding?wordIndex:(word.move(newX),overflowIndex)}},{key:"deprecateMoveWordRight",value:function(word,x){var EDGE_PADDING=this.config.rowEdgePadding,WORD_PADDING=this.config.wordPadding,i=this.words.indexOf(word),prevWord=this.words[i-1];if(x){if((x=Math.min(this.rw,x))+word.boxWidth>this.rw-EDGE_PADDING)return i;word.move(x),++i,prevWord=word}else prevWord||(word.move(EDGE_PADDING),++i,prevWord=word);for(;i<this.words.length;){var _word=this.words[i],dx=prevWord.x+prevWord.boxWidth+(_word.isPunct?0:WORD_PADDING);if(_word.x>dx)return this.words.length;if(dx+_word.boxWidth>this.rw-EDGE_PADDING)return i;_word.move(dx),prevWord=this.words[i],++i}}},{key:"removeWord",value:function(word){return this.words.splice(this.words.indexOf(word),1),this.wordGroup.removeElement(word.svg),word}},{key:"removeLastWord",value:function(){var word=this.words.pop();return this.wordGroup.removeElement(word.svg),word}},{key:"removeFirstWord",value:function(){var word=this.words.shift();return this.wordGroup.removeElement(word.svg),word}},{key:"contains",value:function(x,y){return x<=this.rw&&y>=this.ry&&y<=this.ry2}},{key:"drawBbox",value:function(){var bbox=this.svg.bbox();this.svg.polyline([[bbox.x,bbox.y],[bbox.x2,bbox.y],[bbox.x2,bbox.y2],[bbox.x,bbox.y2],[bbox.x,bbox.y]]).fill("none").stroke({width:1})}},{key:"baseline",get:function(){return this.ry+this.rh}},{key:"ry2",get:function(){return this.ry+this.rh+20-15*this.minSlot}},{key:"minHeight",get:function(){return 60+15*this.maxSlot}},{key:"availableSpace",get:function(){if(0===this.words.length)return this.rw-2*this.config.rowEdgePadding;var lastWord=this.words[this.words.length-1];return this.rw-this.config.rowEdgePadding-lastWord.x-lastWord.boxWidth}}]),Row}());var _$Row_83=Row;

"use strict";var _slicedToArray2=_$interopRequireDefault_8(_$slicedToArray_12),___classCallCheck2_90=_$interopRequireDefault_8(_$classCallCheck_6),___createClass2_90=_$interopRequireDefault_8(_$createClass_7),_row=_$interopRequireDefault_8(_$Row_83),___link_90=_$interopRequireDefault_8(_$Link_82),RowManager=function(){function RowManager(svg,config){(0,___classCallCheck2_90.default)(this,RowManager),this.config=config,this._svg=svg,this._rows=[]}return(0,___createClass2_90.default)(RowManager,[{key:"resizeAll",value:function(){var _this=this;this.width(this._svg.width()),this._rows.forEach(function(row){_this.recalculateRowSlots(row)}),this.resizeRow(0)}},{key:"resizeRow",value:function(i){var dy=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0,row=this._rows[i];if(void 0!==row){if(i>0){var adjust=this._rows[i-1].ry2+10-row.ry;row.move(row.ry+adjust),row.height(row.rh-adjust)}dy=Math.max(-row.rh+row.minHeight,dy),row.height(row.rh+dy),row.words.forEach(function(word){return word.redrawLinks()});for(var j=i+1;j<this._rows.length;++j)this._rows[j-1].ry2+10>this._rows[j].ry+dy?this._rows[j].move(this._rows[j-1].ry2+10):this._rows[j].dy(dy),this._rows[j].words.forEach(function(word){return word.redrawLinks()});this._svg.height(this.lastRow.ry2+10+20)}}},{key:"width",value:function(rw){var _this2=this;this._rows.forEach(function(row){row.width(rw);var i=row.words.findIndex(function(w){return w.x+w.boxWidth>rw-_this2.config.rowEdgePadding});if(i>0)for(;i<row.words.length;)_this2.moveWordDownARow(row.idx);else row.words.forEach(function(word){word.links.forEach(function(l){l.endpoints[1].row!==l.endpoints[0].row&&l.draw(word)}),word.redrawClusters()})})}},{key:"appendRow",value:function(){var lr=this.lastRow,row=lr?new _row.default(this._svg,this.config,lr.idx+1,lr.ry2+10):new _row.default(this._svg,this.config);return this._rows.push(row),this._svg.height(row.ry2+10+20),row}},{key:"removeRow",value:function(){this._rows.pop().remove(),this.lastRow&&this._svg.height(this.lastRow.ry2+10+20)}},{key:"addWordToRow",value:function(word,row,i,forceX){isNaN(i)&&(i=row.words.length);var slots=this.getSlotRange([0,0],word);!word.row||word.row===row||slots[0]!==word.row.minSlot&&word.row.maxSlot!==slots[1]||this.recalculateRowSlots(word.row),(row.minSlot>slots[0]||row.maxSlot<slots[1])&&(row.minSlot>slots[0]&&(row.minSlot=slots[0]),row.maxSlot<slots[1]&&(row.maxSlot=slots[1]),this.resizeRow(row.idx));for(var overflow=row.addWord(word,i,forceX);overflow<row.words.length;)this.moveWordDownARow(row.idx)}},{key:"moveWordOnRow",value:function(word,dx){var row=word.row;row&&(dx>=0?this.moveWordRight({row:row,wordIndex:row.words.indexOf(word),dx:dx}):dx<0&&(dx=-dx,this.moveWordLeft({row:row,wordIndex:row.words.indexOf(word),dx:dx})))}},{key:"moveWordRight",value:function(params){var rightEdge,row=params.row,wordIndex=params.wordIndex,dx=params.dx,word=row.words[wordIndex],nextWord=row.words[wordIndex+1];nextWord?(rightEdge=nextWord.x,rightEdge-=nextWord.isPunct?this.config.wordPunctPadding:this.config.wordPadding):rightEdge=row.rw-this.config.rowEdgePadding,dx<=rightEdge-(word.x+word.boxWidth)?word.dx(dx):nextWord?(this.moveWordRight({row:row,wordIndex:wordIndex+1,dx:dx}),word.dx(dx)):this.moveWordDownARow(row.idx)}},{key:"moveWordLeft",value:function(params){var row=params.row,wordIndex=params.wordIndex,dx=params.dx,word=row.words[wordIndex],prevWord=row.words[wordIndex-1],leftPadding=word.isPunct?this.config.wordPunctPadding:this.config.wordPadding,space=word.x;if(dx<=(space-=prevWord?prevWord.x+prevWord.boxWidth+leftPadding:this.config.rowEdgePadding))return word.dx(-dx),!0;if(0===wordIndex){var prevRow=this._rows[row.idx-1];if(!prevRow)return!1;if(prevRow.availableSpace>=word.boxWidth+leftPadding)return this.moveWordUpARow(row.idx),!0;var prevRowShift=word.boxWidth+leftPadding-prevRow.availableSpace;return!!this.moveWordLeft({row:prevRow,wordIndex:prevRow.words.length-1,dx:prevRowShift})&&(this.moveWordUpARow(row.idx),!0)}return!!this.moveWordLeft({row:row,wordIndex:wordIndex-1,dx:dx})&&(word.dx(-dx),!0)}},{key:"moveWordUpARow",value:function(index){var prevRow=this._rows[index-1];if(prevRow){var removedWord=this._rows[index].removeFirstWord(),newX=prevRow.rw-this.config.rowEdgePadding-removedWord.boxWidth;this.addWordToRow(removedWord,prevRow,void 0,newX),removedWord.redrawClusters(),removedWord.redrawLinks()}}},{key:"moveWordDownARow",value:function(index){var nextRow=this._rows[index+1]||this.appendRow();this.addWordToRow(this._rows[index].removeLastWord(),nextRow,0)}},{key:"getSlotRange",value:function(acc,anchor){var _this3=this;if(anchor instanceof ___link_90.default&&!anchor.visible)return[acc[0],acc[1]];if(0===anchor.links.length)return[Math.min(acc[0],0),Math.max(acc[1],0)];var a=anchor.links.reduce(function(acc,val){return _this3.getSlotRange(acc,val)},[0,0]);return[Math.min(acc[0],a[0]),Math.max(acc[1],a[1])]}},{key:"recalculateRowSlots",value:function(row){var _this4=this,_row$words$reduce=row.words.reduce(function(acc,val){return _this4.getSlotRange(acc,val)},[0,0]),_row$words$reduce2=(0,_slicedToArray2.default)(_row$words$reduce,2);row.minSlot=_row$words$reduce2[0],row.maxSlot=_row$words$reduce2[1]}},{key:"whichRow",value:function(x,y){return this._rows.find(function(row){return row.contains(x,y)})}},{key:"lastRow",get:function(){return this._rows[this._rows.length-1]}},{key:"rows",get:function(){return this._rows}}]),RowManager}();var _$RowManager_90=RowManager;
