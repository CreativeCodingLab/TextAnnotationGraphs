!(function(t) {
  ...
  var i = function(t, e, n) {
    ...
    a = (function(t) {
      ...
      return (
        (v.prototype = b.constructor = y),
        (y.constructor = v),
        (y[a] = v.displayName = "GeneratorFunction"),
      ...
      e.forEach(function(e) {
        if ("constructor" !== e) {
          ...
          "function" == typeof n.value &&
            Object.defineProperty(t.prototype, e, h(t, e, n));
        }
      }),
      t
    );
  ...
  !(function(t, e) {
    ...
    var _ = (function(t) {
      ...
      try {
        P.apply((L = O.call(b.childNodes)), b.childNodes),
      ...
      function at(t, e, r, i) {
        ...
        if (
          !i &&
          ((e ? e.ownerDocument || e : b) !== d && f(e), (e = e || d), g)
        ) {
          if (11 !== k && (h = J.exec(t)))
            if ((o = h[1])) {
              if (9 === k) {
          ...
          if (
            ...
            if (((y = t), (m = e), 1 === k && $.test(t))) {
              for (
                ...
                p[a] = "#" + c + " " + xt(p[a]);
              (y = p.join(",")), (m = (tt.test(t) && yt(e.parentNode)) || e);
            }
            try {
      ...
      (at.contains = function(t, e) {
        return (t.ownerDocument || t) !== d && f(t), x(t, e);
      }),
                    ...
                    if (((p = [s ? v.firstChild : v.lastChild]), s && m)) {
                      for (
                        x =
                          (d =
                            (l =
                              (c =
                                (h = (f = v)[w] || (f[w] = {}))[f.uniqueID] ||
                                (h[f.uniqueID] = {}))[t] || [])[0] === k &&
                            l[1]) && l[2],
                          f = d && v.childNodes[d];
                        (f = (++d && f && f[g]) || (x = d = 0) || p.pop());
                      ...
                      (m &&
                        (x = d =
                          (l =
                            (c =
                              (h = (f = e)[w] || (f[w] = {}))[f.uniqueID] ||
                              (h[f.uniqueID] = {}))[t] || [])[0] === k && l[1]),
                      !1 === x)
                    )
                      for (
                        ;
        ...
        return (
          ...
          lt(function(o, s, a, u) {
            var l,
              ...
              v = !t || (!o && e) ? g : kt(g, f, t, a, u),
              y = n ? (i || (o ? t : p || r) ? [] : s) : v;
            if ((n && n(v, y, a, u), r))
              for (l = kt(y, d), r(l, [], a, u), c = l.length; c--; )
                (h = l[c]) && (y[d[c]] = !(v[d[c]] = h));
            if (o) {
              if (i || t) {
                if (i) {
            ...
            } else (y = kt(y === s ? y.splice(p, y.length) : y)), i ? i(null, s, y, u) : P.apply(s, y);
          })
        );
      }
      function Ct(t) {
        for (
          ...
          if ((n = r.relative[t[u].type])) f = [wt(bt(f), n)];
          else {
      ...
      return (
        ...
        (s = at.tokenize = function(t, e) {
          ...
          return e ? a.length : a ? at.error(t) : T(t, u).slice(0);
        }),
                ...
                var n = e.length > 0,
                  ...
                  o = function(o, s, a, u, c) {
                    ...
                    for (
                      ...
                      n && ((h = !v && h) && y--, o && x.push(h));
                    }
                    if (((y += m), n && m !== y)) {
                      for (p = 0; (v = e[p++]); ) v(x, w, s, a);
                      if (o) {
                        if (y > 0)
                          for (; m--; ) x[m] || w[m] || (w[m] = j.call(u));
                        w = kt(w);
                      }
                      P.apply(u, w),
                        c &&
          ...
          if (((n = n || []), 1 === d.length)) {
            ...
            for (
              ...
              if (
                ...
                if ((u.splice(o, 1), !(t = i.length && xt(u))))
    ...
    (w.filter = function(t, e, n) {
      ...
      w.fn.extend({
        ...
        is: function(t) {
          return !!M(
            this,
            "string" == typeof t && A.test(t) ? w(t) : t || [],
            !1
          ).length;
        }
      });
      ...
      if (((n = n || L), "string" == typeof t)) {
        ...
        if (i[1]) {
          if (
            ...
            w.merge(
              this,
              w.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : r, !0)
            ),
            E.test(i[1]) && w.isPlainObject(e))
          )
        ...
        function(t, e) {
          w.fn[t] = function(n, r) {
            ...
            return (
              ...
              this.length > 1 &&
                (P[t] || w.uniqueSort(i), N.test(t) && i.reverse()),
              this.pushStack(i)
            );
          };
        }
    ...
    (w.Callbacks = function(t) {
      ...
      w.extend({
          ...
          var n = [
            ...
            i = {
              ...
              then: function(e, r, i) {
                ...
                return w
                  .Deferred(function(t) {
                    n[0][3].add(s(0, t, g(i) ? i : I, t.notifyWith)),
                      n[1][3].add(s(0, t, g(e) ? e : I)),
                      n[2][3].add(s(0, t, g(r) ? r : R));
                  })
                  .promise();
              },
              promise: function(t) {
        ...
        when: function(t) {
          ...
          if (
            e <= 1 &&
            (W(t, s.done(a(n)).resolve, s.reject, !e),
            "pending" === s.state() || g(i[n] && i[n].then))
          )
            return s.then();
          for (; n--; ) W(i[n], a(n), s.reject);
          return s.promise();
        }
      });
    ...
    (w.fn.ready = function(t) {
      ...
      w.extend({
        ...
        ready: function(t) {
          (!0 === t ? --w.readyWait : w.isReady) ||
            ((w.isReady = !0),
            (!0 !== t && --w.readyWait > 0) || F.resolveWith(r, [w]));
        }
      }),
      (w.ready.then = F.then),
      ...
      ("loading" !== r.readyState && !r.documentElement.doScroll)
        ...
        : (r.addEventListener("DOMContentLoaded", H),
    ...
    function U(t) {
      return t.replace(z, "ms-").replace(Y, $);
    }
    var G = function(t) {
    ...
    var st = function(t, e) {
        return (
          ...
          ("" === t.style.display && it(t) && "none" === w.css(t, "display"))
        );
      },
      at = function(t, e, n, r) {
        var i,
      ...
      return (
        (n =
          void 0 !== t.getElementsByTagName
            ...
            : []),
        void 0 === e || (e && S(t, e)) ? w.merge([t], n) : n
      );
    }
    function yt(t, e) {
    ...
    function bt(t, e, n, r, i) {
      for (
        ...
        if ((o = t[d]) || 0 === o)
          if ("object" === x(o)) w.merge(f, o.nodeType ? [o] : o);
          else if (wt.test(o)) {
            for (
      ...
      for (h.textContent = "", d = 0; (o = f[d++]); )
        if (r && w.inArray(o, r) > -1) i && i.push(o);
          ...
          ((l = it(o)), (s = vt(h.appendChild(o), "script")), l && yt(s), n)
        )
          for (c = 0; (o = s[c++]); ) pt.test(o.type || "") && n.push(o);
      return h;
    }
    (mt = r.createDocumentFragment().appendChild(r.createElement("div"))),
            ...
            if (
              ...
              s &&
                ...
                ((h.teardown && !1 !== h.teardown.call(t, p, v.handle)) ||
                  w.removeEvent(t, d, v.handle),
                delete u[d]);
            } else for (d in u) w.event.remove(t, d + e[l], n, r, !0);
          w.isEmptyObject(u) && V.remove(t, "handle events");
        }
      },
      dispatch: function(t) {
        var e,
        ...
        if (
          ...
          for (
            s = w.event.handlers.call(this, a, l), e = 0;
    ...
    function Wt(t, e, n, r) {
      ...
      var i,
        ...
        v = e[0],
        y = g(v);
      if (y || (f > 1 && "string" == typeof v && !p.checkClone && Nt.test(v)))
      ...
      if (
        f &&
        ((o = (i = bt(e, t[0].ownerDocument, !1, t, r)).firstChild),
        1 === i.childNodes.length && (i = o),
        o || r)
      ) {
        for (u = (a = w.map(vt(i, "script"), Dt)).length; h < f; h++)
          (l = i),
            h !== d &&
              ((l = w.clone(l, !0, !0)), u && w.merge(a, vt(l, "script"))),
            n.call(t[h], l, h);
        if (u)
          for (
            c = a[a.length - 1].ownerDocument, w.map(a, It), h = 0;
            h < u;
            h++
          )
            (l = a[h]),
              pt.test(l.type || "") &&
                ...
                (l.src && "module" !== (l.type || "").toLowerCase()
                  ...
                  : m(l.textContent.replace(Pt, ""), l, c));
      }
      return t;
    }
    function Bt(t, e, n) {
      for (var r, i = e ? w.filter(e, t) : t, o = 0; null != (r = i[o]); o++)
        n || 1 !== r.nodeType || w.cleanData(vt(r)),
          r.parentNode &&
            (n && it(r) && yt(vt(r, "script")), r.parentNode.removeChild(r));
      return t;
    }
    w.extend({
      ...
      clone: function(t, e, n) {
        ...
        return (
          (s = vt(c, "script")).length > 0 && yt(s, !h && vt(t, "script")), c
        );
      },
      ...
      function e() {
        if (c) {
          (l.style.cssText =
            ...
            rt.appendChild(l).appendChild(c);
    ...
    function te(t, e, n, r, i, o) {
      ...
      for (; s < 4; s += 2)
        "margin" === n && (u += w.css(t, n + nt[s], !0, i)),
          r
            ? ("content" === n && (u -= w.css(t, "padding" + nt[s], !0, i)),
              "margin" !== n &&
                (u -= w.css(t, "border" + nt[s] + "Width", !0, i)))
            : ((u += w.css(t, "padding" + nt[s], !0, i)),
              "padding" !== n
                ? (u += w.css(t, "border" + nt[s] + "Width", !0, i))
                : (a += w.css(t, "border" + nt[s] + "Width", !0, i)));
      return (
        !r &&
          o >= 0 &&
          (u +=
    ...
    w.extend({
      ...
      w.each(["height", "width"], function(t, e) {
        w.cssHooks[e] = {
          get: function(t, n, r) {
            if (n)
              return !Vt.test(w.css(t, "display")) ||
      ...
      (w.cssHooks.marginLeft = Yt(p.reliableMarginLeft, function(t, e) {
        if (e)
          return (
        ...
        _default: {
          ...
          set: function(t) {
            w.fx.step[t.prop]
              ? w.fx.step[t.prop](t)
              : 1 !== t.elem.nodeType ||
                (!w.cssHooks[t.prop] && null == t.elem.style[Xt(t.prop)])
              ? (t.elem[t.prop] = t.now)
    ...
    function he(t, e, n) {
      ...
      return (
        ...
        w.fx.timer(w.extend(u, { elem: t, anim: l, queue: l.opts.queue })),
        l
      );
    }
        ...
        function(t, e, n) {
          ...
          e))
            if (((i = e[r]), oe.test(i))) {
              ...
              d[r] = (v && v[r]) || w.style(t, r);
            }
          if ((u = !w.isEmptyObject(e)) || !w.isEmptyObject(d))
            for (r in (h &&
              1 === t.nodeType &&
              ((n.overflow = [p.overflow, p.overflowX, p.overflowY]),
              null == (l = v && v.display) && (l = V.get(t, "display")),
            ...
            d))
              u ||
                (v
                  ...
                  : (v = V.access(t, "fxshow", { display: l })),
                o && (v.hidden = !g),
                g && ht([t], !0),
                f.done(function() {
                  for (r in (g || ht([t]), V.remove(t, "fxshow"), d))
                    w.style(t, r, d[r]);
                })),
                (u = ce(g ? v[r] : 0, r, f)),
                r in v ||
            ...
            return void 0 === t.getAttribute
              ...
              : ((1 === o && w.isXMLDoc(t)) ||
                  (i =
                    ...
                    (w.expr.match.bool.test(e) ? fe : void 0)),
                void 0 !== n
                  ? null === n
        ...
        toggleClass: function(t, e) {
          ...
          return "boolean" == typeof e && r
            ...
            : this.each(function() {
                var e, i, o, s;
                if (r)
                  for (i = 0, o = w(this), s = me(t); (e = s[i++]); )
                    o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
                else
                  (void 0 !== t && "boolean" !== n) ||
                    ((e = ye(this)) && V.set(this, "__className__", e),
                    this.setAttribute &&
                      this.setAttribute(
                        "class",
    ...
    w.fn.extend({
      val: function(t) {
        ...
        return arguments.length
          ...
          : i
          ? (e = w.valHooks[i.type] || w.valHooks[i.nodeName.toLowerCase()]) &&
            "get" in e &&
      ...
      w.extend({
        valHooks: {
          ...
          select: {
            ...
            set: function(t, e) {
              for (
                var n, r, i = t.options, o = w.makeArray(e), s = i.length;
                s--;
    ...
    w.extend(w.event, {
      trigger: function(e, n, i, o) {
        ...
        if (
          ...
          if (!o && !d.noBubble && !v(i)) {
            for (
              l = d.delegateType || m, we.test(l + m) || (a = a.parentNode);
              a;
              a = a.parentNode
            )
              y.push(a), (u = a);
            u === (i.ownerDocument || r) &&
              y.push(u.defaultView || u.parentWindow || t);
          }
          for (s = 0; (a = y[s++]) && !e.isPropagationStopped(); )
            (p = a),
              (e.type = s > 1 ? l : d.bindType || m),
              (f = (V.get(a, "events") || {})[e.type] && V.get(a, "handle")) &&
                f.apply(a, n),
              (f = c && a[c]) &&
                f.apply &&
                G(a) &&
          ...
          return (
            ...
            o ||
              ...
              (c &&
                ...
                ((u = i[c]) && (i[c] = null),
                (w.event.triggered = m),
                e.isPropagationStopped() && p.addEventListener(m, be),
                i[m](),
                e.isPropagationStopped() && p.removeEventListener(m, be),
        ...
        w.each({ focus: "focusin", blur: "focusout" }, function(t, e) {
          ...
          w.event.special[e] = {
            ...
            teardown: function() {
              ...
              i
                ? V.access(r, e, i)
                : (r.removeEventListener(t, n, !0), V.remove(r, e));
            }
          };
        });
    var ke = t.location,
      ...
      w.extend({
        ...
        ajax: function(e, n) {
          ...
          if (
            ...
            if (((C.readyState = 1), h && v.trigger("ajaxSend", [C, p]), c))
              return C;
            p.async &&
              p.timeout > 0 &&
              ...
              l
                ? (p.ifModified &&
                    ((k = C.getResponseHeader("Last-Modified")) &&
                      (w.lastModified[o] = k),
                    (k = C.getResponseHeader("etag")) && (w.etag[o] = k)),
                  204 === e || "HEAD" === p.type
                    ? (_ = "nocontent")
                    : 304 === e
                    ? (_ = "notmodified")
                    : ((_ = b.state), (f = b.data), (l = !(d = b.error))))
                : ((d = _), (!e && _) || ((_ = "error"), e < 0 && (e = 0))),
              (C.status = e),
              (C.statusText = (n || _) + ""),
              l ? y.resolveWith(g, [f, _, C]) : y.rejectWith(g, [C, _, d]),
              C.statusCode(x),
              (x = void 0),
              h &&
                v.trigger(l ? "ajaxSuccess" : "ajaxError", [C, p, l ? f : d]),
              m.fireWith(g, [C, _]),
              h &&
    ...
    w.ajaxSetup({
      ...
      (p.createHTMLDocument = ((($e = r.implementation.createHTMLDocument("")
      ...
      (w.fn.load = function(t, e, n) {
        var r,
          ...
          a = t.indexOf(" ");
        return (
          a > -1 && ((r = ve(t.slice(a))), (t = t.slice(0, a))),
          g(e)
            ? ((n = e), (e = void 0))
      ...
      w.each(["top", "left"], function(t, e) {
        w.cssHooks[e] = Yt(p.pixelPosition, function(t, n) {
          if (n)
            return (n = zt(t, e)), Ft.test(n) ? w(t).position()[e] + "px" : n;
        });
      }),
    ...
    return (
      (w.noConflict = function(e) {
        return (
          t.$ === w && (t.$ = Ve), e && t.jQuery === w && (t.jQuery = Xe), w
        );
      }),
      e || (t.jQuery = t.$ = w),
      w
  ...
  (function(t) {
    (function() {
      var e,
        ...
        fe = -1,
        de = {};
      (de[J] = de[tt] = de[et] = de[nt] = de[rt] = de[it] = de[ot] = de[
        st
      ] = de[at] = !0),
        (de[j] = de[N] = de[Q] = de[O] = de[Z] = de[D] = de[R] = de[W] = de[
          F
        ] = de[H] = de[z] = de[$] = de[U] = de[G] = de[K] = !1);
      var pe = {};
      (pe[j] = pe[N] = pe[Q] = pe[Z] = pe[O] = pe[D] = pe[J] = pe[tt] = pe[
        et
      ] = pe[nt] = pe[rt] = pe[F] = pe[H] = pe[z] = pe[$] = pe[U] = pe[G] = pe[
        X
      ] = pe[it] = pe[ot] = pe[st] = pe[at] = !0),
        (pe[R] = pe[W] = pe[K] = !1);
      var ge = {
          "\\": "\\",
          "'": "'",
        ...
        we = me || xe || Function("return this")(),
        be =
          "object" == typeof p.exports &&
          p.exports &&
          !p.exports.nodeType &&
          p.exports,
        ke = be && p && !p.nodeType && p,
        _e = ke && ke.exports === be,
        Ce = _e && me.process,
        Te = (function() {
          try {
        ...
        Ae = Te && Te.isArrayBuffer,
        Se = Te && Te.isDate,
        Ee = Te && Te.isMap,
        Me = Te && Te.isRegExp,
        Le = Te && Te.isSet,
        je = Te && Te.isTypedArray;
      function Ne(t, e, n) {
        switch (n.length) {
          case 0:
            return t.call(e);
      ...
      function yn(t) {
        return hn(t)
          ? (function(t) {
              for (var e = (ae.lastIndex = 0); ae.test(t); ) ++e;
              return e;
            })(t)
          : Ye(t);
      }
      ...
      var xn = Ze({
        ...
        wn = (function t(p) {
          var Ht,
            qt = (p =
              null == p ? we : wn.defaults(we.Object(), p, wn.pick(we, he)))
              .Array,
            zt = p.Date,
            Yt = p.Error,
            $t = p.Function,
            ...
            ee = Zt.toString,
            ne = Jt.hasOwnProperty,
            re = 0,
            ie = (Ht = /[^.]+$/.exec((te && te.keys && te.keys.IE_PROTO) || ""))
              ? "Symbol(src)_1." + Ht
              : "",
            ae = Jt.toString,
            le = ee.call(Gt),
            ...
            be = p.Symbol,
            ke = p.Uint8Array,
            Ce = xe ? xe.allocUnsafe : e,
            Te = dn(Gt.getPrototypeOf, Gt),
            Ye = Gt.create,
            Ze = Jt.propertyIsEnumerable,
            bn = Qt.splice,
            kn = be ? be.isConcatSpreadable : e,
            _n = be ? be.iterator : e,
            Cn = be ? be.toStringTag : e,
            Tn = (function() {
              try {
                var t = Co(Gt, "defineProperty");
                return t({}, "", {}), t;
              } catch (e) {}
            })(),
            An = p.clearTimeout !== we.clearTimeout && p.clearTimeout,
            Sn = zt && zt.now !== we.Date.now && zt.now,
            En = p.setTimeout !== we.setTimeout && p.setTimeout,
            Mn = Ut.ceil,
            Ln = Ut.floor,
            jn = Gt.getOwnPropertySymbols,
            Nn = xe ? xe.isBuffer : e,
            Pn = p.isFinite,
            On = Qt.join,
            Dn = dn(Gt.keys, Gt),
            ...
            Jn = Zo($n),
            tr = Zo(Un),
            er = be ? be.prototype : e,
            nr = er ? er.valueOf : e,
            rr = er ? er.toString : e;
          function ir(t) {
            if (ga(t) && !ia(t) && !(t instanceof ur)) {
              if (t instanceof ar) return t;
              if (ne.call(t, "__wrapped__")) return Jo(t);
            }
            return new ar(t);
          }
          var or = (function() {
          ...
          function fr(t) {
            var e = -1,
              n = null == t ? 0 : t.length;
            for (this.__data__ = new hr(); ++e < n; ) this.add(t[e]);
          }
          function dr(t) {
          ...
          function gr(t) {
            var n = t.length;
            return n ? t[li(0, n - 1)] : e;
          }
          function vr(t, n, r) {
            ((r === e || ta(t[n], r)) && (r !== e || n in t)) || br(t, n, r);
          }
          function yr(t, n, r) {
            var i = t[n];
            (ne.call(t, n) && ta(i, r) && (r !== e || n in t)) || br(t, n, r);
          }
          function mr(t, e) {
          ...
          function kr(t, n) {
            for (var r = -1, i = n.length, o = qt(i), s = null == t; ++r < i; )
              o[r] = s ? e : Fa(t, n[r]);
            return o;
          }
          function _r(t, n, r) {
          ...
          function Cr(t, n, r, i, u, l) {
            var c,
              h = n & o,
              f = n & s,
              d = n & a;
            if ((r && (c = u ? r(t, i, u, l) : r(t)), c !== e)) return c;
            if (!pa(t)) return t;
            var p = ia(t);
            if (p) {
              if (
            ...
            if (va(t))
              return (
                t.forEach(function(e, i) {
                  c.set(i, Cr(e, n, r, i, t, l));
                }),
                c
              );
            var m = p ? e : (d ? (f ? yo : vo) : f ? Ua : $a)(t);
            return (
              Oe(m || t, function(e, i) {
                m && (e = t[(i = e)]), yr(c, i, Cr(e, n, r, i, t, l));
              }),
              c
            );
          }
          function Tr(t, n, r) {
            ...
            for (t = Gt(t); i--; ) {
              var o = r[i],
                s = n[o],
                a = t[o];
              if ((a === e && !(o in t)) || !s(a)) return !1;
            }
            return !0;
          }
          function Ar(t, n, i) {
            if ("function" != typeof t) throw new Kt(r);
            return zo(function() {
              t.apply(e, i);
            }, n);
          }
          function Sr(t, e, r, i) {
            ...
            r && (e = Be(e, nn(r))),
              i
                ? ((s = We), (a = !1))
                : e.length >= n && ((s = on), (a = !1), (e = new fr(e)));
            t: for (; ++o < u; ) {
              var h = t[o],
                f = null == r ? h : r(h);
              if (((h = i || 0 !== h ? h : 0), a && f == f)) {
                for (var d = c; d--; ) if (e[d] === f) continue t;
                l.push(h);
              } else s(e, f, i) || l.push(h);
            }
            return l;
          }
          (ir.templateSettings = {
            ...
            (ar.prototype = or(sr.prototype)),
            (ar.prototype.constructor = ar),
            (ur.prototype = or(sr.prototype)),
            ...
            (lr.prototype.get = function(t) {
              ...
              return ne.call(n, t) ? n[t] : e;
            }),
            (lr.prototype.has = function(t) {
              var n = this.__data__;
              return Gn ? n[t] !== e : ne.call(n, t);
            }),
            (lr.prototype.set = function(t, n) {
              var r = this.__data__;
              return (
                (this.size += this.has(t) ? 0 : 1),
                (r[t] = Gn && n === e ? "__lodash_hash_undefined__" : n),
                this
              );
            }),
            ...
            (cr.prototype.delete = function(t) {
              ...
              return !(
                n < 0 ||
                (n == e.length - 1 ? e.pop() : bn.call(e, n, 1), --this.size, 0)
              );
            }),
          ...
          function Br(t, n) {
            for (var r = 0, i = (n = ji(n, t)).length; null != t && r < i; )
              t = t[Qo(n[r++])];
            return r && r == i ? t : e;
          }
          function Fr(t, e, n) {
            var r = e(t);
            return ia(t) ? r : Fe(r, n(t));
          }
          function Hr(t) {
            return null == t
              ? t === e
              ...
              ? (function(t) {
                  ...
                  var o = ae.call(t);
                  return i && (n ? (t[Cn] = r) : delete t[Cn]), o;
                })(t)
              : (function(t) {
                  return ae.call(t);
                })(t);
          ...
          function $r(t, n, r) {
            ...
            var f = -1,
              d = u[0];
            t: for (; ++f < o && c.length < l; ) {
              var p = h[f],
                g = n ? n(p) : p;
              if (((p = r || 0 !== p ? p : 0), !(d ? on(d, g) : i(c, g, r)))) {
                for (a = s; --a; ) {
                  var v = u[a];
                  if (!(v ? on(v, g) : i(t[a], g, r))) continue t;
                }
                d && d.push(g), c.push(p);
              }
            }
          ...
          function Ur(t, n, r) {
            var i = null == (t = Fo(t, (n = ji(n, t)))) ? t : t[Qo(cs(n))];
            return null == i ? e : Ne(i, t, r);
          }
          function Gr(t) {
            return ga(t) && Hr(t) == j;
          }
          function Xr(t, n, r, i, o) {
            return (
              t === n ||
              (null == t || null == n || (!ga(t) && !ga(n))
                ? t != t && n != n
                : (function(t, n, r, i, o, s) {
                    ...
                    if (!(r & u)) {
                      var v = d && ne.call(t, "__wrapped__"),
                        y = p && ne.call(n, "__wrapped__");
                      if (v || y) {
                        var m = v ? t.value() : t,
                          x = y ? n.value() : n;
                        return s || (s = new dr()), o(m, x, r, i, s);
                      }
                    }
                    return (
                      !!g &&
                      ...
                      (function(t, n, r, i, o, s) {
                        var a = r & u,
                          l = vo(t),
                          c = l.length;
                        if (c != vo(n).length && !a) return !1;
                        for (var h = c; h--; ) {
                          var f = l[h];
                          if (!(a ? f in n : ne.call(n, f))) return !1;
                        }
                        var d = s.get(t);
          ...
          function Vr(t, n, r, i) {
            ...
            for (; ++o < s; ) {
              var h = (c = r[o])[0],
                ...
                d = c[1];
              if (a && c[2]) {
                if (f === e && !(h in t)) return !1;
              } else {
                var p = new dr();
                if (i) var g = i(f, d, h, t, n, p);
                if (!(g === e ? Xr(d, f, u | l, i, p) : g)) return !1;
              }
            }
            return !0;
          }
          ...
          function ni(t, n) {
            return Po(t) && Ro(n)
              ...
              : function(r) {
                  var i = Fa(r, t);
                  return i === e && i === n ? Ha(r, t) : Xr(n, i, u | l);
                };
          }
          function ri(t, n, r, i, o) {
            t !== n &&
              Or(
                n,
                function(s, a) {
                    ...
                    o || (o = new dr()),
                      (function(t, n, r, i, o, s, a) {
                        ...
                        if (c) vr(t, r, c);
                          ...
                          f && (a.set(l, h), o(h, l, i, s, a), a.delete(l)),
                            vr(t, r, h);
                        }
                      })(t, n, a, r, ri, i, o);
                  else {
                    var u = i ? i(Ho(t, a), s, a + "", t, n, o) : e;
                    u === e && (u = s), vr(t, a, u);
                  }
                },
                Ua
          ...
          function ai(t, e, n, r) {
            var i = r ? Xe : Ge,
              ...
              s = e.length,
              a = t;
            for (t === e && (e = Hi(e)), n && (a = Be(t, nn(n))); ++o < s; )
              for (
                var u = 0, l = e[o], c = n ? n(l) : l;
                (u = i(a, c, u, r)) > -1;

              )
                a !== t && bn.call(a, u, 1), bn.call(t, u, 1);
            return t;
          }
          function ui(t, e) {
            for (var n = t ? e.length : 0, r = n - 1; n--; ) {
              ...
              if (n == r || i !== o) {
                var o = i;
                jo(i) ? bn.call(t, i, 1) : _i(t, i);
              }
            }
            return t;
          }
          function li(t, e) {
            return t + Ln(Fn() * (e - t + 1));
          }
          function ci(t, e) {
            var n = "";
          ...
          function hi(t, e) {
            return Yo(Bo(t, e, yu), t + "");
          }
          function fi(t, n, r, i) {
            if (!pa(t)) return t;
            for (
              var o = -1, s = (n = ji(n, t)).length, a = s - 1, u = t;
              null != u && ++o < s;
          ...
          function wi(t) {
            return "number" == typeof t ? t : ka(t) ? A : +t;
          }
          function bi(t) {
            if ("string" == typeof t) return t;
            if (ia(t)) return Be(t, bi) + "";
            if (ka(t)) return rr ? rr.call(t) : "";
            var e = t + "";
          ...
          function ki(t, e, r) {
            ...
            t: for (; ++i < s; ) {
              var h = t[i],
                f = e ? e(h) : h;
              if (((h = r || 0 !== h ? h : 0), a && f == f)) {
                for (var d = l.length; d--; ) if (l[d] === f) continue t;
                e && l.push(f), u.push(h);
              } else o(l, f, r) || (l !== u && l.push(f), u.push(h));
            }
            return u;
          }
          function _i(t, e) {
            return null == (t = Fo(t, (e = ji(e, t)))) || delete t[Qo(cs(e))];
          }
          function Ci(t, e, n, r) {
            return fi(t, e, n(Br(t, e)), r);
          }
          function Ti(t, e, n, r) {
            for (
          ...
          function Si(t, e, n) {
            var r = t.length;
            if (r < 2) return r ? ki(t[0]) : [];
            for (var i = -1, o = qt(r); ++i < r; )
              for (var s = t[i], a = -1; ++a < r; )
                a != i && (o[i] = Sr(o[i] || s, t[a], e, n));
            return ki(Pr(o, 1), e, n);
          }
          function Ei(t, n, r) {
          ...
          function ji(t, e) {
            return ia(t) ? t : Po(t, e) ? [t] : Ko(Na(t));
          }
          var Ni = hi;
          function Pi(t, n, r) {
            var i = t.length;
            return (r = r === e ? i : r), !n && r >= i ? t : gi(t, n, r);
          }
          var Oi =
            An ||
            function(t) {
          ...
          function qi(t, n, r, i) {
            ...
            for (var s = -1, a = n.length; ++s < a; ) {
              var u = n[s],
                l = i ? i(r[u], t[u], u, r, t) : e;
              l === e && (l = t[u]), o ? br(r, u, l) : yr(r, u, l);
            }
            return r;
          }
          function zi(t, e) {
          ...
          function Yi(t) {
            return hi(function(n, r) {
              var i = -1,
                ...
                a = o > 2 ? r[2] : e;
              for (
                s = t.length > 3 && "function" == typeof s ? (o--, s) : e,
                  a && No(r[0], r[1], a) && ((s = o < 3 ? e : s), (o = 1)),
                  n = Gt(n);
                ++i < o;
          ...
          function $i(t, e) {
            return function(n, r) {
              if (null == n) return n;
              if (!sa(n)) return t(n, r);
              for (
                var i = n.length, o = e ? i : -1, s = Gt(n);
                (e ? o-- : ++o < i) && !1 !== r(s[o], o, s);
          ...
          function Gi(t) {
            return function(n) {
              var r = hn((n = Na(n))) ? mn(n) : e,
                i = r ? r[0] : n.charAt(0),
                o = r ? Pi(r, 1).join("") : n.slice(1);
              return i[t]() + o;
            };
          }
          function Xi(t) {
            return function(e) {
              return He(hu(ru(e).replace(oe, "")), t, "");
            };
          }
          function Vi(t) {
            return function() {
          ...
          function Qi(t) {
            return go(function(n) {
              ...
              for (t && n.reverse(); o--; ) {
                var a = n[o];
                if ("function" != typeof a) throw new Kt(r);
                if (s && !u && "wrapper" == xo(a)) var u = new ar([], !0);
              }
              for (o = u ? o : i; ++o < i; ) {
                var l = xo((a = n[o])),
                  c = "wrapper" == l ? mo(a) : e;
              ...
              return function() {
                var t = arguments,
                  e = t[0];
                if (u && 1 == t.length && ia(e)) return u.plant(e).value();
          ...
          function Zi(t, n, r, i, o, s, a, u, l, f) {
            var p = n & m,
              v = n & c,
              y = n & h,
              x = n & (d | g),
              ...
              k = y ? e : Vi(t);
            return function c() {
              for (var h = arguments.length, d = qt(h), g = h; g--; )
                d[g] = arguments[g];
              if (x)
                var m = wo(c),
                  w = (function(t, e) {
              ...
              if (
                ...
                var _ = pn(d, m);
                return oo(t, n, Zi, c.placeholder, r, d, _, u, l, f - h);
              }
              var C = v ? r : this,
                T = y ? C[t] : t;
              return (
                ...
                u
                  ? (d = (function(t, n) {
                      for (
                        var r = t.length, i = Rn(n.length, r), o = Hi(t);
                        i--;
                  ...
                  : b && h > 1 && d.reverse(),
                p && l < h && (d.length = l),
                this && this !== we && this instanceof c && (T = k || Vi(T)),
                T.apply(C, d)
              );
            };
          }
          ...
          function no(t, n) {
            var r = (n = n === e ? " " : bi(n)).length;
            if (r < 2) return r ? ci(n, t) : n;
            var i = ci(n, Mn(t / yn(n)));
            return hn(n) ? Pi(mn(i), 0, t).join("") : i.slice(0, t);
          }
          function ro(t) {
            return function(n, r, i) {
              return (
                i && "number" != typeof i && No(n, r, i) && (r = i = e),
                (n = Sa(n)),
                r === e ? ((r = n), (n = 0)) : (r = Sa(r)),
                (function(t, e, n, r) {
                  for (
                    var i = -1, o = In(Mn((e - t) / (n || 1)), 0), s = qt(o);
                    o--;

                  )
                    (s[r ? o : ++i] = t), (t += n);
                  return s;
                })(n, r, (i = i === e ? (n < r ? 1 : -1) : Sa(i)), t)
              );
            };
          }
          function io(t) {
          ...
          function oo(t, n, r, i, o, s, a, u, l, p) {
            var g = n & d;
            (n |= g ? v : y), (n &= ~(g ? y : v)) & f || (n &= ~(c | h));
            var m = [
                t,
                n,
                o,
              ...
              x = r.apply(e, m);
            return Oo(t) && qo(x, m), (x.placeholder = i), $o(x, t, n);
          }
          function so(t) {
            var e = Ut[t];
            return function(t, n) {
              if (((t = La(t)), (n = null == n ? 0 : Rn(Ea(n), 292)))) {
                var r = (Na(t) + "e").split("e");
                return +(
                  (r = (Na(e(r[0] + "e" + (+r[1] + n))) + "e").split("e"))[0] +
                  "e" +
                  (+r[1] - n)
                );
              }
          ...
          function lo(t, n, o, s, a, u, l, p) {
            var w = n & h;
            if (!w && "function" != typeof t) throw new Kt(r);
            var b = s ? s.length : 0;
            if (
              (b || ((n &= ~(v | y)), (s = a = e)),
              (l = l === e ? l : In(Ea(l), 0)),
            ...
            if (
              (C &&
                (function(t, e) {
                  var n = t[1],
                    ...
                    a =
                      (r == m && n == d) ||
                      (r == m && n == x && t[7].length <= e[8]) ||
                      (r == (m | x) && e[7].length <= e[8] && n == d);
                  if (!s && !a) return t;
                  r & c && ((t[2] = e[2]), (o |= n & c ? 0 : f));
                  var u = e[3];
                  if (u) {
                    var l = t[3];
                    (t[3] = l ? Bi(l, u, e[4]) : u),
                  ...
                  (u = e[5]) &&
                    ...
                    (t[6] = l ? pn(t[5], i) : e[6])),
                    (u = e[7]) && (t[7] = u),
                    r & m && (t[8] = null == t[8] ? e[8] : Rn(t[8], e[8])),
                    null == t[9] && (t[9] = e[9]),
                    (t[0] = e[0]),
                    (t[1] = o);
                })(T, C),
              ...
              (s = T[3]),
              (a = T[4]),
              !(p = T[9] = T[9] === e ? (w ? 0 : t.length) : In(T[9] - b, 0)) &&
                n & (d | g) &&
                (n &= ~(d | g)),
              n && n != c)
            )
              A =
                n == d || n == g
                  ? (function(t, n, r) {
                      ...
                      return function o() {
                        for (
                          var s = arguments.length, a = qt(s), u = s, l = wo(o);
                          u--;

                        )
                          a[u] = arguments[u];
                        var c =
                          s < 3 && a[0] !== l && a[s - 1] !== l ? [] : pn(a, l);
                        return (s -= c.length) < r
                          ? oo(t, n, Zi, o.placeholder, e, a, c, e, e, r - s)
                          : Ne(
                              this && this !== we && this instanceof o ? i : t,
                              this,
                              a
                            );
                      };
                      ...
                      return function e() {
                        for (
                          var s = -1,
                            ...
                            c = qt(l + a),
                            h =
                              this && this !== we && this instanceof e ? o : t;
                          ++u < l;

                        )
                          c[u] = r[u];
                        for (; a--; ) c[u++] = arguments[++s];
                        return Ne(h, i ? n : this, c);
                      };
                    })(t, n, o, s);
            else
            ...
            return $o((C ? di : qo)(A, T), t, n);
          }
          function co(t, n, r, i) {
            return t === e || (ta(t, Jt[r]) && !ne.call(i, r)) ? n : t;
          }
          function ho(t, n, r, i, o, s) {
            return (
              pa(t) && pa(n) && (s.set(n, t), ri(t, n, e, ho, s), s.delete(n)),
              t
            );
          }
          function fo(t) {
          ...
          function po(t, n, r, i, o, s) {
            var a = r & u,
              c = t.length,
              h = n.length;
            if (c != h && !(a && h > c)) return !1;
            var f = s.get(t);
            if (f && s.get(n)) return f == n;
            var d = -1,
              p = !0,
              g = r & l ? new fr() : e;
            for (s.set(t, n), s.set(n, t); ++d < c; ) {
              var v = t[d],
                y = n[d];
              if (i) var m = a ? i(y, v, d, n, t, s) : i(v, y, d, t, n, s);
              if (m !== e) {
                if (m) continue;
                p = !1;
                break;
          ...
          function xo(t) {
            for (
              var e = t.name + "", n = Vn[e], r = ne.call(Vn, e) ? n.length : 0;
              r--;
          ...
          function wo(t) {
            return (ne.call(ir, "placeholder") ? ir : t).placeholder;
          }
          function bo() {
            var t = ir.iteratee || mu;
            return (
              (t = t === mu ? Qr : t),
          ...
          function Mo(t) {
            return "function" != typeof t.constructor || Io(t) ? {} : or(Te(t));
          }
          function Lo(t) {
            return ia(t) || ra(t) || !!(kn && t && t[kn]);
          }
          function jo(t, e) {
            var n = typeof t;
            return (
              !!(e = null == e ? C : e) &&
              ("number" == n || ("symbol" != n && Rt.test(t))) &&
              t > -1 &&
              t % 1 == 0 &&
              t < e
            );
          ...
          function Oo(t) {
            var e = xo(t),
              n = ir[e];
            if ("function" != typeof n || !(e in ur.prototype)) return !1;
            if (t === n) return !0;
            var r = mo(n);
            return !!r && t === r[0];
          }
          ((qn && So(new qn(new ArrayBuffer(1))) != Z) ||
            (zn && So(new zn()) != F) ||
            (Yn && "[object Promise]" != So(Yn.resolve())) ||
            ($n && So(new $n()) != U) ||
            (Un && So(new Un()) != K)) &&
            (So = function(t) {
              var n = Hr(t),
          ...
          function Wo(t, n) {
            return function(r) {
              return null != r && r[t] === n && (n !== e || t in Gt(r));
            };
          }
          function Bo(t, n, r) {
            return (
              (n = In(n === e ? t.length - 1 : n, 0)),
              function() {
                for (
                  var e = arguments, i = -1, o = In(e.length - n, 0), s = qt(o);
                  ++i < o;

                )
                  s[i] = e[n + i];
                i = -1;
                for (var a = qt(n + 1); ++i < n; ) a[i] = e[i];
                return (a[n] = r(s)), Ne(t, this, a);
              }
            );
          }
          function Fo(t, e) {
            return e.length < 2 ? t : Br(t, gi(e, 0, -1));
          }
          function Ho(t, e) {
          ...
          function Jo(t) {
            ...
            return (
              (e.__actions__ = Hi(t.__actions__)),
          ...
          var ts = hi(function(t, e) {
              return aa(t) ? Sr(t, Pr(e, 1, aa, !0)) : [];
            }),
            es = hi(function(t, n) {
              var r = cs(n);
              return (
                aa(r) && (r = e), aa(t) ? Sr(t, Pr(n, 1, aa, !0), bo(r, 2)) : []
              );
            }),
            ns = hi(function(t, n) {
              var r = cs(n);
              return (
                aa(r) && (r = e), aa(t) ? Sr(t, Pr(n, 1, aa, !0), e, r) : []
              );
            });
          function rs(t, e, n) {
            ...
            if (!r) return -1;
            var i = null == n ? 0 : Ea(n);
            return i < 0 && (i = In(r + i, 0)), Ue(t, bo(e, 3), i);
          }
          function is(t, n, r) {
            var i = null == t ? 0 : t.length;
            if (!i) return -1;
            ...
            return (
              r !== e &&
                ((o = Ea(r)), (o = r < 0 ? In(i + o, 0) : Rn(o, i - 1))),
              Ue(t, bo(n, 3), o, !0)
            );
          }
          function os(t) {
          ...
          var gs = hi(function(t) {
              return ki(Pr(t, 1, aa, !0));
            }),
            vs = hi(function(t) {
              var n = cs(t);
              return aa(n) && (n = e), ki(Pr(t, 1, aa, !0), bo(n, 2));
            }),
            ys = hi(function(t) {
              var n = cs(t);
              return (
                (n = "function" == typeof n ? n : e), ki(Pr(t, 1, aa, !0), e, n)
              );
            });
          function ms(t) {
            ...
            return (
              (t = Ie(t, function(t) {
                if (aa(t)) return (e = In(t.length, e)), !0;
              })),
              en(e, function(e) {
                return Be(t, Qe(e));
              })
          ...
          var ws = hi(function(t, e) {
            ...
            ks = hi(function(t) {
              var n = cs(t);
              return aa(n) && (n = e), Si(Ie(t, aa), bo(n, 2));
            }),
            _s = hi(function(t) {
              var n = cs(t);
              return (n = "function" == typeof n ? n : e), Si(Ie(t, aa), e, n);
            }),
            Cs = hi(ms),
            Ts = hi(function(t) {
              var n = t.length,
                r = n > 1 ? t[n - 1] : e;
              return (r = "function" == typeof r ? (t.pop(), r) : e), xs(t, r);
            });
          function As(t) {
            var e = ir(t);
          ...
          var Es = go(function(t) {
              ...
              return !(n > 1 || this.__actions__.length) &&
                ...
                ? ((i = i.slice(r, +r + (n ? 1 : 0))).__actions__.push({
                  ...
                  new ar(i, this.__chain__).thru(function(t) {
                    return n && !t.length && t.push(e), t;
                  }))
                : this.thru(o);
            }),
            Ms = zi(function(t, e, n) {
              ne.call(t, n) ? ++t[n] : br(t, n, 1);
            }),
            Ls = Ki(rs),
            js = Ki(is);
          function Ns(t, e) {
            return (ia(t) ? Oe : Er)(t, bo(e, 3));
          }
          function Ps(t, e) {
            return (ia(t)
              ? function(t, e) {
          ...
          var Os = zi(function(t, e, n) {
              ne.call(t, n) ? t[n].push(e) : br(t, n, [e]);
            }),
            Ds = hi(function(t, e, n) {
              var r = -1,
                i = "function" == typeof e,
                o = sa(t) ? qt(t.length) : [];
              return (
                Er(t, function(t) {
                  o[++r] = i ? Ne(e, t, n) : Ur(t, e, n);
                }),
                o
              );
            }),
            Is = zi(function(t, e, n) {
              br(t, n, e);
            });
          function Rs(t, e) {
            return (ia(t) ? Be : ti)(t, bo(e, 3));
          }
          var Ws = zi(
              function(t, e, n) {
                t[n ? 0 : 1].push(e);
          ...
          function qs(t, n) {
            var i;
            if ("function" != typeof n) throw new Kt(r);
            return (
              (t = Ea(t)),
              function() {
                return (
                  --t > 0 && (i = n.apply(this, arguments)),
                  t <= 1 && (n = e),
                  i
                );
              }
          ...
          function $s(t, n, i) {
            ...
            function g(n) {
              var r = o,
                i = s;
              return (o = s = e), (h = n), (u = t.apply(i, r));
            }
            function v(t) {
              var r = t - c;
              return c === e || r >= n || r < 0 || (d && t - h >= a);
            }
            function y() {
              var t = Fs();
              if (v(t)) return m(t);
              l = zo(
                ...
                (function(t) {
                  var e = n - (t - c);
                  return d ? Rn(e, a - (t - h)) : e;
                })(t)
              );
            }
            function m(t) {
              return (l = e), p && o ? g(t) : ((o = s = e), u);
            }
            function x() {
              var t = Fs(),
                r = v(t);
              if (((o = arguments), (s = this), (c = t), r)) {
                if (l === e)
                  return (function(t) {
                    return (h = t), (l = zo(y, n)), f ? g(t) : u;
                  })(c);
                if (d) return (l = zo(y, n)), g(c);
              }
              return l === e && (l = zo(y, n)), u;
            }
            return (
              (n = La(n) || 0),
              pa(i) &&
                ((f = !!i.leading),
                (a = (d = "maxWait" in i) ? In(La(i.maxWait) || 0, n) : a),
                (p = "trailing" in i ? !!i.trailing : p)),
              (x.cancel = function() {
                l !== e && Oi(l), (h = 0), (o = c = s = l = e);
              }),
              (x.flush = function() {
                return l === e ? u : m(Fs());
              }),
          ...
          var Us = hi(function(t, e) {
            ...
            Gs = hi(function(t, e, n) {
              return Ar(t, La(e) || 0, n);
            });
          function Xs(t, e) {
            ...
            return (n.cache = new (Xs.Cache || hr)()), n;
          }
          function Vs(t) {
            if ("function" != typeof t) throw new Kt(r);
            return function() {
          ...
          Xs.Cache = hr;
          var Ks = Ni(function(t, e) {
              var n = (e =
                1 == e.length && ia(e[0])
                  ? Be(e[0], nn(bo()))
                  : Be(Pr(e, 1), nn(bo()))).length;
              return hi(function(r) {
                for (var i = -1, o = Rn(r.length, n); ++i < o; )
          ...
          var ea = io(qr),
            ...
            ra = Gr(
              ...
              ? Gr
              : function(t) {
                  return ga(t) && ne.call(t, "callee") && !Ze.call(t, "callee");
                },
            ia = qt.isArray,
            oa = Ae
              ? nn(Ae)
          ...
          function sa(t) {
            return null != t && da(t.length) && !ha(t);
          }
          function aa(t) {
            return ga(t) && sa(t);
          }
          ...
          function ya(t) {
            return "number" == typeof t || (ga(t) && Hr(t) == H);
          }
          function ma(t) {
            if (!ga(t) || Hr(t) != z) return !1;
            var e = Te(t);
            if (null === e) return !0;
            var n = ne.call(e, "constructor") && e.constructor;
            return "function" == typeof n && n instanceof n && ee.call(n) == le;
          }
          var xa = Me
              ? nn(Me)
              : function(t) {
          ...
          function ba(t) {
            return "string" == typeof t || (!ia(t) && ga(t) && Hr(t) == G);
          }
          function ka(t) {
            return "symbol" == typeof t || (ga(t) && Hr(t) == X);
          }
          var _a = je
              ? nn(je)
              : function(t) {
                  return ga(t) && da(t.length) && !!de[Hr(t)];
                },
            Ca = io(Jr),
            Ta = io(function(t, e) {
              return t <= e;
          ...
          var Pa = Yi(function(t, e) {
              if (Io(e) || sa(e)) qi(e, $a(e), t);
              else for (var n in e) ne.call(e, n) && yr(t, n, e[n]);
            }),
            Oa = Yi(function(t, e) {
              qi(e, Ua(e), t);
            }),
            Da = Yi(function(t, e, n, r) {
              qi(e, Ua(e), t, r);
            }),
            Ia = Yi(function(t, e, n, r) {
              qi(e, $a(e), t, r);
            }),
            Ra = go(kr),
            Wa = hi(function(t, n) {
              ...
              var r = -1,
                i = n.length,
                o = i > 2 ? n[2] : e;
              for (o && No(n[0], n[1], o) && (i = 1); ++r < i; )
                for (var s = n[r], a = Ua(s), u = -1, l = a.length; ++u < l; ) {
                  var c = a[u],
                    h = t[c];
                  (h === e || (ta(h, Jt[c]) && !ne.call(t, c))) &&
                    (t[c] = s[c]);
                }
              return t;
            }),
            Ba = hi(function(t) {
              return t.push(e, ho), Ne(Xa, e, t);
            });
          function Fa(t, n, r) {
            var i = null == t ? e : Br(t, n);
            return i === e ? r : i;
          }
          function Ha(t, e) {
            return null != t && Eo(t, e, Yr);
          }
          var qa = Ji(function(t, e, n) {
              null != e && "function" != typeof e.toString && (e = ae.call(e)),
                (t[e] = n);
            }, pu(yu)),
            za = Ji(function(t, e, n) {
              null != e && "function" != typeof e.toString && (e = ae.call(e)),
                ne.call(t, e) ? t[e].push(n) : (t[e] = [n]);
            }, bo),
            Ya = hi(Ur);
          function $a(t) {
            return sa(t) ? pr(t) : Zr(t);
          }
          function Ua(t) {
            return sa(t)
              ? pr(t, !0)
          ...
          var Ga = Yi(function(t, e, n) {
              ri(t, e, n);
            }),
            Xa = Yi(function(t, e, n, r) {
              ri(t, e, n, r);
            }),
            Va = go(function(t, e) {
              var n = {};
          ...
          var Za = uo($a),
            Ja = uo(Ua);
          function tu(t) {
            return null == t ? [] : rn(t, $a(t));
          }
          var eu = Xi(function(t, e, n) {
            return (e = e.toLowerCase()), t + (n ? nu(e) : e);
          });
          function nu(t) {
            return cu(Na(t).toLowerCase());
          }
          function ru(t) {
            return (t = Na(t)) && t.replace(Wt, un).replace(se, "");
          }
          var iu = Xi(function(t, e, n) {
            ...
            uu = Xi(function(t, e, n) {
              return t + (n ? " " : "") + cu(e);
            }),
            lu = Xi(function(t, e, n) {
          ...
          var fu = hi(function(t, n) {
              try {
                return Ne(t, e, n);
              } catch (r) {
                return ca(r) ? r : new Yt(r);
              }
            }),
            du = go(function(t, e) {
              return (
                Oe(e, function(e) {
                  (e = Qo(e)), br(t, e, zs(t[e], t));
                }),
                t
              );
            });
          ...
          function mu(t) {
            return Qr("function" == typeof t ? t : Cr(t, o));
          }
          var xu = hi(function(t, e) {
              return function(n) {
                return Ur(n, t, e);
              };
            }),
          ...
          function bu(t, e, n) {
            var r = $a(e),
              i = Wr(e, r);
            null != n ||
              (pa(e) && (i.length || !r.length)) ||
              ((n = e), (e = t), (t = this), (i = Wr(e, $a(e))));
            var o = !(pa(n) && "chain" in n && !n.chain),
              s = ha(t);
            return (
              Oe(i, function(n) {
                var r = e[n];
          ...
          return (
            (ir.after = function(t, e) {
              if ("function" != typeof e) throw new Kt(r);
              return (
                (t = Ea(t)),
                function() {
            ...
            (ir.chunk = function(t, n, r) {
              n = (r ? No(t, n, r) : n === e) ? 1 : In(Ea(n), 0);
              var i = null == t ? 0 : t.length;
              if (!i || n < 1) return [];
              for (var o = 0, s = 0, a = qt(Mn(i / n)); o < i; )
                a[s++] = gi(t, o, (o += n));
              return a;
            }),
            ...
            (ir.cond = function(t) {
              ...
              return (
                (t = e
                  ? Be(t, function(t) {
                      if ("function" != typeof t[1]) throw new Kt(r);
                      return [n(t[0]), t[1]];
                    })
                  : []),
                hi(function(n) {
            ...
            (ir.curry = function t(n, r, i) {
              var o = lo(n, d, e, e, e, e, e, (r = i ? e : r));
              return (o.placeholder = t.placeholder), o;
            }),
            (ir.curryRight = function t(n, r, i) {
              var o = lo(n, g, e, e, e, e, e, (r = i ? e : r));
              return (o.placeholder = t.placeholder), o;
            }),
            (ir.debounce = $s),
            (ir.defaults = Wa),
            ...
            (ir.difference = ts),
            (ir.differenceBy = es),
            (ir.differenceWith = ns),
            (ir.drop = function(t, n, r) {
              var i = null == t ? 0 : t.length;
              return i
                ? gi(t, (n = r || n === e ? 1 : Ea(n)) < 0 ? 0 : n, i)
                : [];
            }),
            (ir.dropRight = function(t, n, r) {
              var i = null == t ? 0 : t.length;
              return i
                ? gi(t, 0, (n = i - (n = r || n === e ? 1 : Ea(n))) < 0 ? 0 : n)
                : [];
            }),
            (ir.dropRightWhile = function(t, e) {
              return t && t.length ? Ti(t, bo(e, 3), !0, !0) : [];
            }),
            (ir.dropWhile = function(t, e) {
              return t && t.length ? Ti(t, bo(e, 3), !0) : [];
            }),
            (ir.fill = function(t, n, r, i) {
            ...
            (ir.flatMapDepth = function(t, n, r) {
              return (r = r === e ? 1 : Ea(r)), Pr(Rs(t, n), r);
            }),
            (ir.flatten = os),
            (ir.flattenDeep = function(t) {
              return null != t && t.length ? Pr(t, _) : [];
            }),
            ...
            (ir.functions = function(t) {
              return null == t ? [] : Wr(t, $a(t));
            }),
            (ir.functionsIn = function(t) {
              return null == t ? [] : Wr(t, Ua(t));
            }),
            (ir.groupBy = Os),
            (ir.initial = function(t) {
              return null != t && t.length ? gi(t, 0, -1) : [];
            }),
            (ir.intersection = as),
            (ir.intersectionBy = us),
            (ir.intersectionWith = ls),
            (ir.invert = qa),
            (ir.invertBy = za),
            (ir.invokeMap = Ds),
            (ir.iteratee = mu),
            ...
            (ir.orderBy = function(t, n, r, i) {
              return null == t
                ? []
                : (ia(n) || (n = null == n ? [] : [n]),
                  ia((r = i ? e : r)) || (r = null == r ? [] : [r]),
                  oi(t, n, r));
            }),
            (ir.over = _u),
            (ir.overArgs = Ks),
            ...
            (ir.pull = hs),
            (ir.pullAll = fs),
            (ir.pullAllBy = function(t, e, n) {
              return t && t.length && e && e.length ? ai(t, e, bo(n, 2)) : t;
            }),
            (ir.pullAllWith = function(t, n, r) {
              return t && t.length && n && n.length ? ai(t, n, e, r) : t;
            }),
            (ir.pullAt = ds),
            (ir.range = Su),
            (ir.rangeRight = Eu),
            ...
            (ir.rest = function(t, n) {
              if ("function" != typeof t) throw new Kt(r);
              return hi(t, (n = n === e ? n : Ea(n)));
            }),
            (ir.reverse = ps),
            (ir.sampleSize = function(t, n, r) {
              return (
                (n = (r ? No(t, n, r) : n === e) ? 1 : Ea(n)),
                (ia(t)
                  ? function(t, e) {
                      return Go(Hi(t), _r(e, 0, t.length));
                    }
                  : function(t, e) {
                      var n = tu(t);
                      return Go(n, _r(e, 0, n.length));
                    })(t, n)
              );
            }),
            (ir.set = function(t, e, n) {
              return null == t ? t : fi(t, e, n);
            }),
            (ir.setWith = function(t, n, r, i) {
              return (
            ...
            (ir.slice = function(t, n, r) {
              var i = null == t ? 0 : t.length;
              return i
                ? (r && "number" != typeof r && No(t, n, r)
                    ? ((n = 0), (r = i))
                    : ((n = null == n ? 0 : Ea(n)), (r = r === e ? i : Ea(r))),
                  gi(t, n, r))
                : [];
            }),
            (ir.sortBy = Bs),
            ...
            (ir.sortedUniqBy = function(t, e) {
              return t && t.length ? xi(t, bo(e, 2)) : [];
            }),
            (ir.split = function(t, n, r) {
              return (
                r && "number" != typeof r && No(t, n, r) && (n = r = e),
                (r = r === e ? S : r >>> 0)
                  ? (t = Na(t)) &&
                    ("string" == typeof n || (null != n && !xa(n))) &&
                    !(n = bi(n)) &&
                    hn(t)
                    ? Pi(mn(t), 0, r)
                    : t.split(n, r)
            ...
            (ir.spread = function(t, e) {
              if ("function" != typeof t) throw new Kt(r);
              return (
                (e = null == e ? 0 : In(Ea(e), 0)),
                hi(function(n) {
                  var r = n[e],
                    i = Pi(n, 0, e);
                  return r && Fe(i, r), Ne(t, this, i);
                })
              );
            }),
            (ir.tail = function(t) {
            ...
            (ir.take = function(t, n, r) {
              return t && t.length
                ? gi(t, 0, (n = r || n === e ? 1 : Ea(n)) < 0 ? 0 : n)
                : [];
            }),
            (ir.takeRight = function(t, n, r) {
              var i = null == t ? 0 : t.length;
              return i
                ? gi(t, (n = i - (n = r || n === e ? 1 : Ea(n))) < 0 ? 0 : n, i)
                : [];
            }),
            (ir.takeRightWhile = function(t, e) {
              return t && t.length ? Ti(t, bo(e, 3), !1, !0) : [];
            }),
            (ir.takeWhile = function(t, e) {
              return t && t.length ? Ti(t, bo(e, 3)) : [];
            }),
            (ir.tap = function(t, e) {
              return e(t), t;
            }),
            (ir.throttle = function(t, e, n) {
              var i = !0,
                o = !0;
              if ("function" != typeof t) throw new Kt(r);
              return (
            ...
            (ir.toPath = function(t) {
              return ia(t) ? Be(t, Qo) : ka(t) ? [t] : Hi(Ko(Na(t)));
            }),
            (ir.toPlainObject = ja),
            (ir.transform = function(t, e, n) {
              var r = ia(t),
                i = r || ua(t) || _a(t);
              if (((e = bo(e, 4)), null == n)) {
                var o = t && t.constructor;
                n = i ? (r ? new o() : []) : pa(t) && ha(o) ? or(Te(t)) : {};
              }
              return (
                (i ? Oe : Ir)(t, function(t, r, i) {
                  return e(n, t, r, i);
                }),
                n
              );
            ...
            (ir.unzip = ms),
            (ir.unzipWith = xs),
            (ir.update = function(t, e, n) {
              return null == t ? t : Ci(t, e, Li(n));
            }),
            (ir.updateWith = function(t, n, r, i) {
              return (
                (i = "function" == typeof i ? i : e),
                null == t ? t : Ci(t, n, Li(r), i)
              );
            }),
            (ir.values = tu),
            (ir.valuesIn = function(t) {
              return null == t ? [] : rn(t, Ua(t));
            }),
            (ir.without = ws),
            (ir.words = hu),
            ...
            (ir.cloneDeepWith = function(t, n) {
              return Cr(t, o | a, (n = "function" == typeof n ? n : e));
            }),
            (ir.cloneWith = function(t, n) {
              return Cr(t, a, (n = "function" == typeof n ? n : e));
            }),
            (ir.conformsTo = function(t, e) {
              return null == e || Tr(t, e, $a(e));
            }),
            (ir.deburr = ru),
            ...
            (ir.endsWith = function(t, n, r) {
              (t = Na(t)), (n = bi(n));
              var i = t.length,
                o = (r = r === e ? i : _r(Ea(r), 0, i));
              return (r -= n.length) >= 0 && t.slice(r, o) == n;
            }),
            (ir.eq = ta),
            (ir.escape = function(t) {
              return (t = Na(t)) && pt.test(t) ? t.replace(ft, ln) : t;
            }),
            (ir.escapeRegExp = function(t) {
              return (t = Na(t)) && kt.test(t) ? t.replace(bt, "\\$&") : t;
            }),
            (ir.every = function(t, n, r) {
              var i = ia(t) ? De : Lr;
              return r && No(t, n, r) && (n = e), i(t, bo(n, 3));
            }),
            (ir.find = Ls),
            (ir.findIndex = rs),
            (ir.findKey = function(t, e) {
              return $e(t, bo(e, 3), Ir);
            }),
            (ir.findLast = js),
            (ir.findLastIndex = is),
            (ir.findLastKey = function(t, e) {
              return $e(t, bo(e, 3), Rr);
            }),
            (ir.floor = Du),
            (ir.forEach = Ns),
            (ir.forEachRight = Ps),
            (ir.forIn = function(t, e) {
              return null == t ? t : Or(t, bo(e, 3), Ua);
            }),
            (ir.forInRight = function(t, e) {
              return null == t ? t : Dr(t, bo(e, 3), Ua);
            }),
            (ir.forOwn = function(t, e) {
              return t && Ir(t, bo(e, 3));
            }),
            (ir.forOwnRight = function(t, e) {
              return t && Rr(t, bo(e, 3));
            }),
            (ir.get = Fa),
            (ir.gt = ea),
            (ir.gte = na),
            (ir.has = function(t, e) {
              return null != t && Eo(t, e, zr);
            }),
            (ir.hasIn = Ha),
            (ir.head = ss),
            (ir.identity = yu),
            (ir.includes = function(t, e, n, r) {
              (t = sa(t) ? t : tu(t)), (n = n && !r ? Ea(n) : 0);
              var i = t.length;
              return (
                n < 0 && (n = In(i + n, 0)),
                ba(t) ? n <= i && t.indexOf(e, n) > -1 : !!i && Ge(t, e, n) > -1
              );
            }),
            (ir.indexOf = function(t, e, n) {
              var r = null == t ? 0 : t.length;
              if (!r) return -1;
              var i = null == n ? 0 : Ea(n);
              return i < 0 && (i = In(r + i, 0)), Ge(t, e, i);
            }),
            ...
            (ir.isArrayBuffer = oa),
            (ir.isArrayLike = sa),
            (ir.isArrayLikeObject = aa),
            (ir.isBoolean = function(t) {
              return !0 === t || !1 === t || (ga(t) && Hr(t) == O);
            }),
            (ir.isBuffer = ua),
            (ir.isDate = la),
            (ir.isElement = function(t) {
              return ga(t) && 1 === t.nodeType && !ma(t);
            }),
            ...
            (ir.isMatch = function(t, e) {
              return t === e || Vr(t, e, _o(e));
            }),
            (ir.isMatchWith = function(t, n, r) {
              return (r = "function" == typeof r ? r : e), Vr(t, n, _o(n), r);
            }),
            (ir.isNaN = function(t) {
              return ya(t) && t != +t;
            }),
            ...
            (ir.lastIndexOf = function(t, n, r) {
              ...
              var o = i;
              return (
                r !== e && (o = (o = Ea(r)) < 0 ? In(i + o, 0) : Rn(o, i - 1)),
                n == n
                  ? (function(t, e, n) {
            ...
            (ir.lte = Ta),
            (ir.max = function(t) {
              return t && t.length ? jr(t, yu, qr) : e;
            }),
            (ir.maxBy = function(t, n) {
              return t && t.length ? jr(t, bo(n, 2), qr) : e;
            }),
            (ir.mean = function(t) {
              return Ke(t, yu);
            }),
            ...
            (ir.min = function(t) {
              return t && t.length ? jr(t, yu, Jr) : e;
            }),
            (ir.minBy = function(t, n) {
              return t && t.length ? jr(t, bo(n, 2), Jr) : e;
            }),
            (ir.stubArray = Mu),
            (ir.stubFalse = Lu),
            ...
            (ir.multiply = Iu),
            (ir.nth = function(t, n) {
              return t && t.length ? ii(t, Ea(n)) : e;
            }),
            (ir.noConflict = function() {
              return we._ === this && (we._ = ge), this;
            }),
            (ir.noop = ku),
            (ir.now = Fs),
            (ir.pad = function(t, e, n) {
              t = Na(t);
              var r = (e = Ea(e)) ? yn(t) : 0;
              if (!e || r >= e) return t;
              var i = (e - r) / 2;
              return no(Ln(i), n) + t + no(Mn(i), n);
            }),
            (ir.padEnd = function(t, e, n) {
              t = Na(t);
              var r = (e = Ea(e)) ? yn(t) : 0;
              return e && r < e ? t + no(e - r, n) : t;
            }),
            (ir.padStart = function(t, e, n) {
              t = Na(t);
              var r = (e = Ea(e)) ? yn(t) : 0;
              return e && r < e ? no(e - r, n) + t : t;
            }),
            (ir.parseInt = function(t, e, n) {
              return (
                n || null == e ? (e = 0) : e && (e = +e),
                Bn(Na(t).replace(Ct, ""), e || 0)
              );
            }),
            (ir.random = function(t, n, r) {
              if (
                (r && "boolean" != typeof r && No(t, n, r) && (n = r = e),
                r === e &&
                  ("boolean" == typeof n
                    ? ((r = n), (n = e))
              ...
              if (r || t % 1 || n % 1) {
                var o = Fn();
                return Rn(
                  t + o * (n - t + ve("1e-" + ((o + "").length - 1))),
                  n
                );
              }
              return li(t, n);
            }),
            (ir.reduce = function(t, e, n) {
              var r = ia(t) ? He : Je,
                i = arguments.length < 3;
              return r(t, bo(e, 4), n, i, Er);
            }),
            (ir.reduceRight = function(t, e, n) {
              var r = ia(t) ? qe : Je,
                i = arguments.length < 3;
              return r(t, bo(e, 4), n, i, Mr);
            }),
            (ir.repeat = function(t, n, r) {
              return (
                (n = (r ? No(t, n, r) : n === e) ? 1 : Ea(n)), ci(Na(t), n)
              );
            }),
            (ir.replace = function() {
              var t = arguments,
            ...
            (ir.result = function(t, n, r) {
              var i = -1,
                o = (n = ji(n, t)).length;
              for (o || ((o = 1), (t = e)); ++i < o; ) {
                var s = null == t ? e : t[Qo(n[i])];
                s === e && ((i = o), (s = r)), (t = ha(s) ? s.call(t) : s);
              }
              return t;
            }),
            (ir.round = Ru),
            ...
            (ir.size = function(t) {
              if (null == t) return 0;
              if (sa(t)) return ba(t) ? yn(t) : t.length;
              var e = So(t);
              return e == F || e == U ? t.size : Zr(t).length;
            }),
            (ir.snakeCase = au),
            ...
            (ir.sortedIndexBy = function(t, e, n) {
              return mi(t, e, bo(n, 2));
            }),
            ...
            (ir.sortedLastIndexBy = function(t, e, n) {
              return mi(t, e, bo(n, 2), !0);
            }),
            ...
            (ir.startCase = uu),
            (ir.startsWith = function(t, e, n) {
              return (
                (t = Na(t)),
                (n = null == n ? 0 : _r(Ea(n), 0, t.length)),
                (e = bi(e)),
            ...
            (ir.subtract = Wu),
            (ir.sum = function(t) {
              return t && t.length ? tn(t, yu) : 0;
            }),
            (ir.sumBy = function(t, e) {
              return t && t.length ? tn(t, bo(e, 2)) : 0;
            }),
            (ir.template = function(t, n, r) {
              var i = ir.templateSettings;
              r && No(t, n, r) && (n = e), (t = Na(t)), (n = Da({}, n, i, co));
              var o,
                s,
                a = Da({}, n.imports, i.imports, co),
                u = $a(a),
                l = rn(a, u),
                c = 0,
                h = n.interpolate || Bt,
              ...
              g || (f = "with (obj) {\n" + f + "\n}\n"),
                ...
                (f =
                  ...
                  "return __p\n}");
              var v = fu(function() {
                return $t(u, p + "return " + f).apply(e, l);
              });
              if (((v.source = f), ca(v))) throw v;
              return v;
            }),
            (ir.times = function(t, e) {
              if ((t = Ea(t)) < 1 || t > C) return [];
              var n = S,
                r = Rn(t, S);
              (e = bo(e)), (t -= S);
              for (var i = en(r, e); ++n < t; ) e(n);
              return i;
            }),
            (ir.toFinite = Sa),
            (ir.toInteger = Ea),
            ...
            (ir.toLower = function(t) {
              return Na(t).toLowerCase();
            }),
            (ir.toNumber = La),
            (ir.toSafeInteger = function(t) {
              return t ? _r(Ea(t), -C, C) : 0 === t ? t : 0;
            }),
            (ir.toString = Na),
            (ir.toUpper = function(t) {
              return Na(t).toUpperCase();
            }),
            (ir.trim = function(t, n, r) {
              if ((t = Na(t)) && (r || n === e)) return t.replace(_t, "");
              if (!t || !(n = bi(n))) return t;
              var i = mn(t),
                o = mn(n);
              return Pi(i, sn(i, o), an(i, o) + 1).join("");
            }),
            (ir.trimEnd = function(t, n, r) {
              if ((t = Na(t)) && (r || n === e)) return t.replace(Tt, "");
              if (!t || !(n = bi(n))) return t;
              var i = mn(t);
              return Pi(i, 0, an(i, mn(n)) + 1).join("");
            }),
            (ir.trimStart = function(t, n, r) {
              if ((t = Na(t)) && (r || n === e)) return t.replace(Ct, "");
              if (!t || !(n = bi(n))) return t;
              var i = mn(t);
              return Pi(i, sn(i, mn(n))).join("");
            }),
            (ir.truncate = function(t, n) {
              ...
              if (pa(n)) {
                ...
                (r = "length" in n ? Ea(n.length) : r),
                  (i = "omission" in n ? bi(n.omission) : i);
              }
              var s = (t = Na(t)).length;
              if (hn(t)) {
                var a = mn(t);
              ...
              var u = r - yn(i);
              if (u < 1) return i;
              var l = a ? Pi(a, 0, u).join("") : t.slice(0, u);
              if (o === e) return l + i;
              if ((a && (u += l.length - u), xa(o))) {
                if (t.slice(u).search(o)) {
                  var c,
                    h = l;
                  for (
                    o.global || (o = Xt(o.source, Na(Nt.exec(o)) + "g")),
                      o.lastIndex = 0;
                    (c = o.exec(h));
            ...
            (ir.unescape = function(t) {
              return (t = Na(t)) && dt.test(t) ? t.replace(ht, xn) : t;
            }),
            ...
            Oe(["drop", "take"], function(t, n) {
              (ur.prototype[t] = function(r) {
                r = r === e ? 1 : In(Ea(r), 0);
                var i = this.__filtered__ && !n ? new ur(this) : this.clone();
                return (
                  i.__filtered__
                    ? (i.__takeCount__ = Rn(r, i.__takeCount__))
                    : i.__views__.push({
                        size: Rn(r, S),
            ...
            Oe(["filter", "map", "takeWhile"], function(t, e) {
              ...
              ur.prototype[t] = function(t) {
                var e = this.clone();
                return (
                  e.__iteratees__.push({ iteratee: bo(t, 3), type: n }),
            ...
            Oe(["initial", "tail"], function(t, e) {
              var n = "drop" + (e ? "" : "Right");
              ur.prototype[t] = function() {
                return this.__filtered__ ? new ur(this) : this[n](1);
              };
            }),
            ...
            (ur.prototype.invokeMap = hi(function(t, e) {
              return "function" == typeof t
                ? new ur(this)
                : this.map(function(n) {
                    return Ur(n, t, e);
            ...
            (ur.prototype.slice = function(t, n) {
              ...
              return r.__filtered__ && (t > 0 || n < 0)
                ...
                : (t < 0 ? (r = r.takeRight(-t)) : t && (r = r.drop(t)),
                  n !== e &&
                    (r = (n = Ea(n)) < 0 ? r.dropRight(-n) : r.take(n - t)),
                  r);
            }),
            ...
            Ir(ur.prototype, function(t, n) {
              var r = /^(?:filter|find|map|reject)|While$/.test(n),
                i = /^(?:head|last)$/.test(n),
                o = ir[i ? "take" + ("last" == n ? "Right" : "") : n],
                s = i || /^find/.test(n);
              o &&
                (ir.prototype[n] = function() {
                  ...
                  if (!s && c) {
                    ...
                    var v = t.apply(n, a);
                    return (
                      v.__actions__.push({ func: Ss, args: [h], thisArg: e }),
                      new ar(v, f)
                    );
                  }
                  return p && g
            ...
            Oe(["pop", "push", "shift", "sort", "splice", "unshift"], function(
              t
            ) {
              var e = Qt[t],
            ...
            Ir(ur.prototype, function(t, e) {
              var n = ir[e];
              if (n) {
                var r = n.name + "";
                (Vn[r] || (Vn[r] = [])).push({ name: e, func: n });
              }
            }),
            (Vn[Zi(e, h).name] = [{ name: "wrapper", func: e }]),
            (ur.prototype.clone = function() {
              var t = new ur(this.__wrapped__);
              return (
                (t.__actions__ = Hi(this.__actions__)),
            ...
            (ur.prototype.value = function() {
              ...
              if (!n || (!r && i == u && d == u))
                return Ai(t, this.__actions__);
              var p = [];
              t: for (; u-- && f < d; ) {
                for (var g = -1, v = t[(l += e)]; ++g < h; ) {
                  var y = c[g],
                    m = y.iteratee,
                    x = y.type,
                    w = m(v);
            ...
            (ir.prototype.plant = function(t) {
              for (var n, r = this; r instanceof sr; ) {
                var i = Jo(r);
                (i.__index__ = 0),
                  (i.__values__ = e),
            ...
            _n &&
              (ir.prototype[_n] = function() {
                return this;
              }),
            ir
          );
        })();
      ke ? (((ke.exports = wn)._ = wn), (be._ = wn)) : (we._ = wn);
    }.call(this));
  }.call(
    this,
    "undefined" != typeof global
  ...
  (g = "undefined" != typeof window ? window : this),
    (v = function(t, e) {
      ...
      if (
        ...
        (n.supported =
          !!e.createElementNS &&
          !!e.createElementNS(n.ns, "svg").createSVGRect),
        !n.supported)
      )
        return !1;
      (n.did = 1e3),
        (n.eid = function(t) {
          return "Svgjs" + c(t) + n.did++;
        }),
        (n.create = function(t) {
        ...
        (n.extend = function() {
          var t, e, r, i;
          for (
            e = (t = [].slice.call(arguments)).pop(), i = t.length - 1;
            i >= 0;
            i--
          )
            if (t[i]) for (r in e) t[i].prototype[r] = e[r];
        ...
        (n.prepare = function() {
          var t = e.getElementsByTagName("body")[0],
            r = (t ? new n.Doc(t) : n.adopt(e.documentElement).nested()).size(
              2,
              0
            );
          n.parser = {
        ...
        n.extend(n.Array, {
          ...
          settle: function() {
            for (var t = 0, e = this.value.length, n = []; t < e; t++)
              -1 == n.indexOf(this.value[t]) && n.push(this.value[t]);
            return (this.value = n);
          },
          at: function(t) {
            if (!this.destination) return this;
            for (var e = 0, r = this.value.length, i = []; e < r; e++)
          ...
          clone: function() {
            ...
            return (
              (t.value = (function t(e) {
                for (var n = e.slice(0), r = n.length; r--; )
        ...
        n.extend(n.PointArray, {
          ...
          size: function(t, e) {
            ...
            for (n = this.value.length - 1; n >= 0; n--)
              r.width &&
                (this.value[n][0] =
                  ((this.value[n][0] - r.x) * t) / r.width + r.x),
                r.height &&
                  (this.value[n][1] =
                    ((this.value[n][1] - r.y) * e) / r.height + r.y);
            return this;
          },
          bbox: function() {
            return (
      ...
      (n.PathArray = function(t, e) {
        ...
        n.extend(n.PathArray, {
          ...
          move: function(t, e) {
            ...
            if (((t -= n.x), (e -= n.y), !isNaN(t) && !isNaN(e)))
              for (var r, i = this.value.length - 1; i >= 0; i--)
                "M" == (r = this.value[i][0]) || "L" == r || "T" == r
                  ? ((this.value[i][1] += t), (this.value[i][2] += e))
                  : "H" == r
                  ? (this.value[i][1] += t)
                  : "V" == r
                  ? (this.value[i][1] += e)
                  ...
                  ? ((this.value[i][1] += t),
                    ...
                    (this.value[i][4] += e),
                    "C" == r &&
                      ((this.value[i][5] += t), (this.value[i][6] += e)))
                  : "A" == r &&
                    ((this.value[i][6] += t), (this.value[i][7] += e));
            return this;
          },
          size: function(t, e) {
            var n,
              ...
              i = this.bbox();
            for (n = this.value.length - 1; n >= 0; n--)
              "M" == (r = this.value[n][0]) || "L" == r || "T" == r
                ? ((this.value[n][1] =
                    ((this.value[n][1] - i.x) * t) / i.width + i.x),
                  (this.value[n][2] =
                    ((this.value[n][2] - i.y) * e) / i.height + i.y))
                : "H" == r
                ? (this.value[n][1] =
                    ((this.value[n][1] - i.x) * t) / i.width + i.x)
                : "V" == r
                ? (this.value[n][1] =
                    ((this.value[n][1] - i.y) * e) / i.height + i.y)
                : "C" == r || "S" == r || "Q" == r
                ? ((this.value[n][1] =
                    ((this.value[n][1] - i.x) * t) / i.width + i.x),
                  (this.value[n][2] =
                    ((this.value[n][2] - i.y) * e) / i.height + i.y),
                  (this.value[n][3] =
                    ((this.value[n][3] - i.x) * t) / i.width + i.x),
                  (this.value[n][4] =
                    ((this.value[n][4] - i.y) * e) / i.height + i.y),
                  "C" == r &&
                    ((this.value[n][5] =
                      ((this.value[n][5] - i.x) * t) / i.width + i.x),
                    (this.value[n][6] =
                      ((this.value[n][6] - i.y) * e) / i.height + i.y)))
                : "A" == r &&
                  ((this.value[n][1] = (this.value[n][1] * t) / i.width),
                  (this.value[n][2] = (this.value[n][2] * e) / i.height),
                  (this.value[n][6] =
                    ((this.value[n][6] - i.x) * t) / i.width + i.x),
                  (this.value[n][7] =
                    ((this.value[n][7] - i.y) * e) / i.height + i.y));
            return this;
          },
          ...
          at: function(t) {
            ...
            for (e = 0, r = s.length; e < r; e++) {
              for (u[e] = [s[e][0]], i = 1, o = s[e].length; i < o; i++)
                u[e][i] = s[e][i] + (a[e][i] - s[e][i]) * t;
              "A" === u[e][0] &&
          ...
          parse: function(t) {
            ...
            t =
              "string" == typeof t
                ? t
                    .replace(n.regex.numbersWithDots, u)
        ...
        (n.Element = n.invent({
          ...
          extend: {
            ...
            size: function(t, e) {
              var r = f(this, t, e);
              return this.width(new n.Number(r.width)).height(
                new n.Number(r.height)
              );
            },
            clone: function(t) {
              this.writeDataToDom();
            ...
            parent: function(e) {
              ...
              for (; r && r.node instanceof t.SVGElement; ) {
                if ("string" == typeof e ? r.matches(e) : r instanceof e)
                  return r;
                if (
                  !r.node.parentNode ||
                  "#document" == r.node.parentNode.nodeName ||
                  "#document-fragment" == r.node.parentNode.nodeName
                )
                  return null;
            ...
            svg: function(t) {
              ...
              if (!(t && this instanceof n.Parent))
                return (
                  ...
                  r.innerHTML.replace(/^<svg>/, "").replace(/<\/svg>$/, "")
                );
              r.innerHTML =
                "<svg>" +
                t
                  ...
                  .replace(/<([\w:-]+)([^<]+?)\/>/g, "<$1$2></$1>") +
                "</svg>";
              for (var i = 0, o = r.firstChild.childNodes.length; i < o; i++)
                this.node.appendChild(r.firstChild.firstChild);
              return this;
            },
        ...
        (n.FX = n.invent({
          ...
          extend: {
            animate: function(t, e, r) {
              "object" == typeof t &&
                ((e = t.ease), (r = t.delay), (t = t.duration));
            ...
            after: function(t) {
              var e = this.last();
              return (
                this.target().on("finished.fx", function n(r) {
                  r.detail.situation == e &&
            ...
            step: function(t) {
                  ...
                  ? ((e = Math.max(this.absPos, 0)),
                    ...
                    this.situation.reversing &&
                      (this.situation.reversed =
                        this.situation.reversed !=
                        Boolean((this.situation.loop - r) % 2)))
              ...
              for (var o in this.situation.once)
                o > this.lastPos &&
                  o <= i &&
                  (this.situation.once[o].call(this.target(), this.pos, i),
            ...
            eachAt: function() {
              ...
              if (s.transforms.length) {
                for (
                  r = s.initialTransformation, t = 0, e = s.transforms.length;
                  t < e;
                  t++
                ) {
                  var a = s.transforms[t];
                  a instanceof n.Matrix
                    ? (r = a.relative
                        ? r.multiply(
                            new n.Matrix().morph(a).at(s.ease(this.pos))
                          )
                        : r.morph(a).at(s.ease(this.pos)))
                    : (a.relative || a.undo(r.extract()),
                      (r = r.multiply(a.at(s.ease(this.pos)))));
                }
                o.matrix(r);
              }
              return this;
        ...
        n.extend(n.FX, {
          attr: function(t, e, n) {
            if ("object" == typeof t) for (var r in t) this.attr(r, t[r]);
            else this.add(t, e, "attrs");
            return this;
          },
          style: function(t, e) {
            if ("object" == typeof t) for (var n in t) this.style(n, t[n]);
          ...
          size: function(t, e) {
            var r;
            return (
              this.target() instanceof n.Text
                ? this.attr("font-size", t)
                : ((t && e) || (r = this.target().bbox()),
                  t || (t = (r.width / r.height) * e),
                  e || (e = (r.height / r.width) * t),
                  this.add("width", new n.Number(t)).add(
                    "height",
                    new n.Number(e)
                  )),
              this
          ...
          leading: function(t) {
            return this.target().leading
              ? this.add("leading", new n.Number(t))
              : this;
          },
          viewbox: function(t, e, r, i) {
            return (
              this.target() instanceof n.Container &&
          ...
          update: function(t) {
            if (this.target() instanceof n.Stop) {
              if ("number" == typeof t || t instanceof n.Number)
                return this.update({
                  offset: arguments[0],
                  color: arguments[1],
                  opacity: arguments[2]
        ...
        (n.Box = n.invent({
          create: function(t, e, r, i) {
            if (!("object" != typeof t || t instanceof n.Element))
              return n.Box.call(
                this,
          ...
          extend: {
            ...
            transform: function(t) {
              ...
              return (
                [
                  new n.Point(this.x, this.y),
                  new n.Point(this.x2, this.y),
                  new n.Point(this.x, this.y2),
                  new n.Point(this.x2, this.y2)
                ].forEach(function(e) {
                  (e = e.transform(t)),
                    (r = Math.min(r, e.x)),
                    (i = Math.max(i, e.x)),
        ...
        (n.RBox = n.invent({
          ...
          construct: {
            rbox: function(t) {
              return t
                ? new n.RBox(this).transform(t.screenCTM().inverse())
            ...
            for (
              t =
                t instanceof n.Element
                  ? t.matrixify()
                  : "string" == typeof t
                  ? p(t.split(n.regex.delimiter).map(parseFloat))
                  : 6 == arguments.length
              ...
              this[x[e]] = null != t[x[e]] ? t[x[e]] : r[x[e]];
          },
          extend: {
            extract: function() {
              var t = d(this, 0, 1),
              ...
              return {
                ...
                y: this.f,
                transformedX:
                  (this.e * Math.cos((r * Math.PI) / 180) +
                    this.f * Math.sin((r * Math.PI) / 180)) /
                  Math.sqrt(this.a * this.a + this.b * this.b),
                transformedY:
                  (this.f * Math.cos((r * Math.PI) / 180) +
                    this.e * Math.sin((-r * Math.PI) / 180)) /
            ...
            scale: function(t, e, r, i) {
              return (
                1 == arguments.length
                  ? (e = t)
                  : 3 == arguments.length && ((i = r), (r = e), (e = t)),
                this.around(r, i, new n.Matrix(t, 0, 0, e, 0, 0))
              );
            },
            ...
            skew: function(t, e, r, i) {
              return (
                ...
                this.around(
                  r,
                  i,
                  new n.Matrix(1, Math.tan(e), Math.tan(t), 1, 0, 0)
                )
              );
            },
            ...
            around: function(t, e, r) {
              return this.multiply(new n.Matrix(1, 0, 0, 1, t || 0, e || 0))
                .multiply(r)
                .multiply(new n.Matrix(1, 0, 0, 1, -t || 0, -e || 0));
            },
            native: function() {
              for (
                var t = n.parser.native.createSVGMatrix(), e = x.length - 1;
                e >= 0;
                e--
              )
                t[x[e]] = this[x[e]];
        ...
        n.extend(n.Element, {
          attr: function(t, e, r) {
            if (null == t) {
              for (
                t = {}, r = (e = this.node.attributes).length - 1;
                r >= 0;
                r--
              )
                t[e[r].nodeName] = n.regex.isNumber.test(e[r].nodeValue)
                  ? parseFloat(e[r].nodeValue)
                  : e[r].nodeValue;
              return t;
            }
            if ("object" == typeof t) for (e in t) this.attr(e, t[e]);
              ...
              "stroke-width" == t
                ...
                "leading" == t
                  ...
                  : "string" == typeof r
                  ? this.node.setAttributeNS(r, t, e.toString())
        ...
        n.extend(n.Element, {
          transform: function(t, e) {
            ...
            if ("object" != typeof t)
              return (
                (r = new n.Matrix(this).extract()),
                "string" == typeof t ? r[t] : r
              );
            if (
              ((r = new n.Matrix(this)), (e = !!e || !!t.relative), null != t.a)
            )
              r = e ? r.multiply(new n.Matrix(t)) : new n.Matrix(t);
            else if (null != t.rotation)
              g(t, this),
                (r = e
                  ? r.rotate(t.rotation, t.cx, t.cy)
                  : r.rotate(t.rotation - r.extract().rotation, t.cx, t.cy));
              ...
              if (
                ...
                var o = r.extract();
                (t.scaleX = (1 * t.scaleX) / o.scaleX),
                  (t.scaleY = (1 * t.scaleY) / o.scaleY);
              }
              ...
              null != t.skew || null != t.skewX || null != t.skewY
                ? (g(t, this),
                  ...
                  e ||
                    ...
                    (r = r.multiply(
                      new n.Matrix()
                        .skew(o.skewX, o.skewY, t.cx, t.cy)
                        .inverse()
                    ))),
                ...
                ? ("x" == t.flip || "y" == t.flip
                    ? (t.offset =
                        null == t.offset ? this.bbox()["c" + t.flip] : t.offset)
                    : null == t.offset
                    ? ((i = this.bbox()), (t.flip = i.cx), (t.offset = i.cy))
                    : (t.flip = t.offset),
                  (r = new n.Matrix().flip(t.flip, t.offset)))
                : (null == t.x && null == t.y) ||
                  (e
                    ? (r = r.translate(t.x, t.y))
                    : (null != t.x && (r.e = t.x), null != t.y && (r.f = t.y)));
        ...
        n.extend(n.FX, {
          transform: function(t, e) {
            var r,
              ...
              o = this.target();
            return "object" != typeof t
              ? ((r = new n.Matrix(o).extract()),
                "string" == typeof t ? r[t] : r)
              : ((e = !!e || !!t.relative),
                null != t.a
                  ? (r = new n.Matrix(t))
                  : null != t.rotation
                  ? (g(t, o), (r = new n.Rotate(t.rotation, t.cx, t.cy)))
                  ...
                  ? (g(t, o),
                    ...
                    (t.scaleY =
                      null != t.scale
                        ...
                        ? t.scaleY
                        : 1),
                    (r = new n.Scale(t.scaleX, t.scaleY, t.cx, t.cy)))
                  : null != t.skewX || null != t.skewY
                  ? (g(t, o),
                    (t.skewX = null != t.skewX ? t.skewX : 0),
                    (t.skewY = null != t.skewY ? t.skewY : 0),
                    (r = new n.Skew(t.skewX, t.skewY, t.cx, t.cy)))
                  : t.flip
                  ? ("x" == t.flip || "y" == t.flip
                      ? (t.offset =
                          null == t.offset ? o.bbox()["c" + t.flip] : t.offset)
                      : null == t.offset
                      ? ((i = o.bbox()), (t.flip = i.cx), (t.offset = i.cy))
                      : (t.flip = t.offset),
                    (r = new n.Matrix().flip(t.flip, t.offset)))
                  : (null == t.x && null == t.y) ||
                    (r = new n.Translate(t.x, t.y)),
                r
                  ? ((r.relative = e),
                    this.last().transforms.push(r),
                    this._callStart())
                  : this);
          }
        }),
        ...
        (n.Transformation = n.invent({
          create: function(t, e) {
            ...
            if (Array.isArray(t))
              ...
              for (n = 0, r = this.arguments.length; n < r; ++n)
          ...
          extend: {
            ...
            method: "",
            at: function(t) {
              for (var e = [], r = 0, i = this.arguments.length; r < i; ++r)
                e.push(this[this.arguments[r]]);
              var o = this._undo || new n.Matrix();
              return (
                (o = new n.Matrix()
                  .morph(n.Matrix.prototype[this.method].apply(o, e))
                  .at(t)),
                this.inversed ? o.inverse() : o
              );
            },
            undo: function(t) {
              ...
              return (
                (t.cx = this.cx),
                (t.cy = this.cy),
                (this._undo = new n[(c(this.method))](t, !0).at(1)),
                this
              );
            }
          }
          ...
          extend: {
            ...
            each: function(t, e) {
              ...
              for (r = 0, i = o.length; r < i; r++)
                o[r] instanceof n.Element && t.apply(o[r], [r, o]),
                  e && o[r] instanceof n.Container && o[r].each(t, e);
              return this;
            },
        ...
        n.extend(n.Parent, {
          ungroup: function(t, e) {
            return 0 === e ||
              ...
              ? this
              : ((t =
                  t || (this instanceof n.Doc ? this : this.parent(n.Parent))),
                (e = e || 1 / 0),
                this.each(function() {
          ...
          create: function(t) {
            ...
            if (t instanceof n.Element) {
              for (
                a = t,
                  u = t,
                  s = (t.attr("viewBox") || "").match(h),
                  t.bbox,
                  i = new n.Number(t.width()),
          ...
          construct: {
            viewbox: function(t, e, r, i) {
              return 0 == arguments.length
                ? new n.ViewBox(this)
                : this.attr("viewBox", new n.ViewBox(t, e, r, i));
            }
          }
        })),
        [
        ...
        (n.listenerId = 0),
        (n.on = function(t, e, r, i, o) {
          var s = r.bind(i || t),
            a = t instanceof n.Element ? t.node : t;
          a.instance = a.instance || { _events: {} };
          var u = a.instance._events;
          r._svgjsListenerId || (r._svgjsListenerId = ++n.listenerId),
            e.split(n.regex.delimiter).forEach(function(t) {
              var e = t.split(".")[0],
                n = t.split(".")[1] || "*";
              (u[e] = u[e] || {}),
                (u[e][n] = u[e][n] || {}),
                (u[e][n][r._svgjsListenerId] = s),
                a.addEventListener(e, s, o || !1);
            });
        }),
        (n.off = function(t, e, r, i) {
          ...
          if (
            o.instance &&
            ("function" != typeof r || (r = r._svgjsListenerId))
          ) {
            ...
            (e || "").split(n.regex.delimiter).forEach(function(t) {
              ...
              if (r)
                s[u] &&
                  s[u][l || "*"] &&
                  (o.removeEventListener(u, s[u][l || "*"][r], i || !1),
                  delete s[u][l || "*"][r]);
              else if (u && l) {
                if (s[u] && s[u][l]) {
                  for (a in s[u][l]) n.off(o, [u, l].join("."), a);
                  delete s[u][l];
                }
              } else if (l)
                for (t in s)
                  for (e in s[t]) l === e && n.off(o, [t, l].join("."));
              else if (u) {
                if (s[u]) {
                  for (e in s[u]) n.off(o, [u, e].join("."));
                  delete s[u];
                }
              } else {
            ...
            return (
              e instanceof t.Event
                ...
                : this.node.dispatchEvent(
                    (e = new n.CustomEvent(e, { detail: r, cancelable: !0 }))
                  ),
              (this._event = e),
              this
            );
        ...
        (n.Mask = n.invent({
          ...
          extend: {
            remove: function() {
              ...
              return (
                (this.targets = []), n.Element.prototype.remove.call(this), this
              );
            }
          },
          construct: {
          ...
          extend: {
            ...
            attr: function(t, e, r) {
              return (
                ...
                n.Container.prototype.attr.call(this, t, e, r)
              );
            }
          },
          construct: {
          ...
          extend: {
            update: function(t) {
              return (
                ...
                null != t.opacity && this.attr("stop-opacity", t.opacity),
                null != t.color && this.attr("stop-color", t.color),
                null != t.offset && this.attr("offset", new n.Number(t.offset)),
                this
              );
            }
          }
        ...
        n.extend(n.Circle, n.Ellipse, {
          ...
          size: function(t, e) {
            var r = f(this, t, e);
            return this.rx(new n.Number(r.width).divide(2)).ry(
              new n.Number(r.height).divide(2)
            );
          }
        }),
        (n.Line = n.invent({
              ...
              return (
                n.on(i, "load", function() {
                  ...
                  null !== t &&
                    (0 == r.width() &&
                      0 == r.height() &&
                      r.size(i.width, i.height),
                    t &&
                      0 == t.width() &&
                      0 == t.height() &&
                      t.size(r.width(), r.height()),
                    "function" == typeof r._loaded &&
                      r._loaded.call(r, {
                        width: i.width,
                        height: i.height,
          ...
          extend: {
            ...
            y: function(t) {
              ...
              return null == t
                ? "number" == typeof e
                  ? e - n
                  : e
                : this.attr("y", "number" == typeof t.valueOf() ? t + n : t);
            },
            cx: function(t) {
              return null == t
                ? this.bbox().cx
            ...
            text: function(t) {
              if (void 0 === t) {
                t = "";
                for (
                  var e = this.node.childNodes, r = 0, i = e.length;
                  r < i;
                  ++r
                )
                  0 != r &&
                    3 != e[r].nodeType &&
                    1 == n.adopt(e[r]).dom.newLined &&
                    (t += "\n"),
                    (t += e[r].textContent);
                return t;
              }
        ...
        n.extend(n.Line, n.Polyline, n.Polygon, n.Path, {
          marker: function(t, e, r, i) {
            ...
            return (
              ...
              (o = o.join("-")),
              (t =
                arguments[1] instanceof n.Marker
                  ? arguments[1]
                  : this.doc().marker(e, r, i)),
              this.attr(o, t)
            );
          }
        });
      ...
      function v(e) {
        for (var r = e.childNodes.length - 1; r >= 0; r--)
          e.childNodes[r] instanceof t.SVGElement && v(e.childNodes[r]);
      ...
      ["fill", "stroke"].forEach(function(t) {
        ...
        (r[t] = function(r) {
          ...
          if (
            "string" == typeof r ||
            n.Color.isRgb(r) ||
            (r && "function" == typeof r.fill)
          )
            this.attr(t, r);
          else
            for (e = a[t].length - 1; e >= 0; e--)
              null != r[a[t][e]] && this.attr(a.prefix(t, a[t][e]), r[a[t][e]]);
          return this;
        }),
        ...
        n.extend(n.Element, n.FX, {
          ...
          skew: function(t, e, n, r) {
            return 1 == arguments.length || 3 == arguments.length
              ? this.transform({ skew: t, cx: e, cy: n })
              : this.transform({ skewX: t, skewY: e, cx: n, cy: r });
          },
          scale: function(t, e, n, r) {
            return 1 == arguments.length || 3 == arguments.length
              ? this.transform({ scale: t, cx: e, cy: n })
          ...
          matrix: function(t) {
            return this.attr(
              "transform",
              new n.Matrix(6 == arguments.length ? [].slice.call(arguments) : t)
            );
          },
          opacity: function(t) {
        ...
        n.extend(n.Rect, n.Ellipse, n.Circle, n.Gradient, n.FX, {
          radius: function(t, e) {
            ...
            return "radial" == r || "circle" == r
              ? this.attr("r", new n.Number(t))
        ...
        (n.Set.inherit = function() {
          ...
          for (var e in (t.forEach(function(t) {
            n.Set.prototype[t] = function() {
              for (var e = 0, r = this.members.length; e < r; e++)
                this.members[e] &&
        ...
        (n.get = function(t) {
          var r = e.getElementById(
            (function(e) {
              var r = (t || "").toString().match(n.regex.reference);
              if (r) return r[1];
            })() || t
          );
          return n.adopt(r);
        ...
        (n.select = function(t, r) {
          return new n.Set(
            n.utils.map((r || e).querySelectorAll(t), function(t) {
              return n.adopt(t);
            })
          );
        }),
      ...
      if ("function" != typeof t.CustomEvent) {
        ...
        (w.prototype = t.Event.prototype), (n.CustomEvent = w);
      } else n.CustomEvent = t.CustomEvent;
      return (
        (function(e) {
          for (
            var n = 0, r = ["moz", "webkit"], i = 0;
    ...
    "object" == typeof y
      ? (y = g.document
          ? v(g, g.document)
          : function(t) {
              return v(t, t.document);
            })
      : (g.SVG = v(g, g.document));
  var m = {};
  ...
  m.default = function t() {
    (0, x.default)(this, t),
      ...
      (this.compactRows = !1),
      (this.showTopLinksOnMove = !0),
      (this.showBottomLinksOnMove = !1),
      (this.showTopMainLabel = !0),
      (this.showTopArgLabels = !1),
      (this.showBottomMainLabel = !0),
      (this.showBottomArgLabels = !1),
        ...
        (0, k.default)(t, [
          {
            key: "addEventId",
            value: function(t) {
              this.eventIds.indexOf(t) < 0 && this.eventIds.push(t);
            }
          },
          {
            key: "text",
            value: function(t) {
              if (void 0 === t) return this.svgText;
              if (
                ((this.val = t),
          ...
          },
          {
            ...
            value: function(t, e) {
              var n = this,
                r = this.endpoints.indexOf(t);
              if (!(r < 0)) {
                (this.main = e), (this.config = e.config);
                var i = e.svg;
                if (!this.svgs[r]) {
                  var o = (this.svgs[r] = i
                    .group()
                  ...
                  (this.lines[r] = o.path().addClass("tag-element")),
                    0 === r &&
                      ((this.svgText = o.text(this.val).leading(1)),
                      (this._textBbox = this.svgText.bbox()),
                      (this.svgText.node.oncontextmenu = function(t) {
                        t.preventDefault(),
                          i.fire("tag-right-click", { object: n, event: t });
                      }),
                      this.svgText.click(function() {
                        return i.fire("tag-edit", { object: n });
                      }));
                }
                this.lines[1] && this.endpoints[1].row && this.draw();
              }
            }
          },
          {
            ...
            value: function() {
              ...
              if (this.lines[1] && this.endpoints[1].row) {
                var e = this.endpoints[0],
                  ...
                  i = n.x + n.boxWidth;
                if (e.row === n.row) {
                  var o = this.getBaseY(e.row),
                    s =
                      o - this.config.wordTopTagPadding - this._textBbox.height,
                    a = (r + i) / 2;
                  this.svgText.move(a, s),
                    (this._textBbox = this.svgText.bbox());
                  var u = (i - r) / 2 / 2,
                    l = Math.min(u, this.config.linkCurveWidth),
                    c = -this.config.wordTopTagPadding / 2;
                  this.lines[0].plot(
                    "M" +
                      [r, o] +
                      "c" +
                  ...
                  var h =
                    ...
                    f = (r + e.row.rw) / 2;
                  this.svgText.move(f, h),
                    (this._textBbox = this.svgText.bbox());
                  var d = this.getBaseY(e.row),
                    p = (e.row.rw - r) / 2,
                    g = p / 2,
                    v = Math.min(g, this.config.linkCurveWidth),
                    y = -this.config.wordTopTagPadding / 2;
                  this.lines[0].plot(
                    "M" +
                      [r, d] +
                      "c" +
                  ...
                  var m = "";
                  m +=
                    "M" + [e.row.rw, d + y] + "c" + [-p + v, 0, -p, 0, -p, y];
                  for (var x = e.row.idx + 1; x < n.row.idx; x++) {
                    var w = this.main.rowManager.rows[x],
                      b = this.getBaseY(w);
                    m += "M" + [0, b + y] + "L" + [w.rw, b + y];
                  }
                  (m +=
                    "M" +
                    [i, this.getBaseY(n.row)] +
                    "c" +
                    [0, y, -v, y, -i, y]),
                    this.lines[1].plot(m);
                }
          ...
          },
          {
            ...
            value: function() {
              var t = this;
              this.svgs.forEach(function(t) {
                return t.remove();
              }),
                this.words.forEach(function(e) {
                  var n = e.clusters.indexOf(t);
                  n > -1 && e.clusters.splice(n, 1);
                });
            }
          },
          {
          ...
          },
          {
            key: "absoluteY",
            get: function() {
              var t = this.svgs[0].bbox().height;
              return this.endpoints[0].absoluteY - t;
            }
          },
          {
            key: "fullHeight",
            get: function() {
              var t = this.svgs[0].bbox().height;
              return this.endpoints[0].boxHeight + t;
            }
          },
          {
            key: "idx",
      ...
      return (
        (0, A.default)(t, [
            ...
            value: function() {
              ...
              this.svg && this.remove(),
                ...
                (this.svgText = this.svg
                  ...
                  .leading(1));
              var e,
                n = this.word.main.svg;
              (this.svgText.node.oncontextmenu = function(e) {
                e.preventDefault(),
                  n.fire("tag-right-click", { object: t, event: e });
              }),
                this.svgText.click(function() {
                  return n.fire("tag-edit", { object: t });
                }),
                ...
                (e = this.top
                  ? -this.word.textHeight -
                    ...
                    this.config.wordTopTagPadding
                  : this.config.wordBottomTagPadding),
                this.svgText.y(e),
                this.line.cy(
                  (this.svgText.bbox().y2 + this.word.svgText.bbox().y) / 2
                );
            }
          },
          {
          ...
          },
          {
            ...
            value: function() {
              if (this.top) {
                var t = this.word.textWidth;
                if (t < this.config.wordBraceThreshold)
                  this.line.plot("M 0,0, 0," + this.config.wordTagLineLength);
                else {
                  var e = this.config.wordTagLineLength,
                    n = t / 2;
                  this.line.plot(
                    "M0,0c" +
                      [0, e, n, 0, n, e] +
          ...
          },
          {
            ...
            value: function(t) {
              if (void 0 === t) return this.svgText;
              if (
                ((this.val = t), this.svgText.text(this.val), this.editingRect)
              ) {
                var e = this.svgText.bbox();
                e.width > 0
                  ? this.editingRect
          ...
          },
          {
            ...
            value: function() {
              (this.isEditing = !1),
                ...
                (this.editingRect = null),
                (this.val = this.val.trim()),
                this.val ? this.word.alignBox() : this.remove();
            }
          },
          {
            key: "drawBbox",
    ...
    (t.prototype.init = function(t, e) {
      ...
      (t.prototype.drag = function(t) {
        var e = this.getBBox(),
          ...
          i = this.startPoints.box.y + n.y - this.startPoints.point.y,
          o = this.constraint,
          s = n.x - this.startPoints.point.x,
          a = n.y - this.startPoints.point.y;
        if (
        ...
        if ("function" == typeof o) {
          var u = o.call(this.el, r, i, this.m);
          "boolean" == typeof u && (u = { x: u, y: u }),
            !0 === u.x ? this.el.x(r) : !1 !== u.x && this.el.x(u.x),
            !0 === u.y ? this.el.y(i) : !1 !== u.y && this.el.y(u.y);
        } else
          "object" == typeof o &&
            (null != o.minX && r < o.minX
              ? (s = (r = o.minX) - this.startPoints.box.x)
              : null != o.maxX &&
                r > o.maxX - e.width &&
                (s = (r = o.maxX - e.width) - this.startPoints.box.x),
            null != o.minY && i < o.minY
              ? (a = (i = o.minY) - this.startPoints.box.y)
              : null != o.maxY &&
                i > o.maxY - e.height &&
                (a = (i = o.maxY - e.height) - this.startPoints.box.y),
            null != o.snapToGrid &&
              ((r -= r % o.snapToGrid),
              (i -= i % o.snapToGrid),
              (s -= s % o.snapToGrid),
    ...
    getCssRules: function(t) {
      ...
      try {
        for (
          ...
          var l = a.value;
          try {
            var c = l.rules || e.cssRules,
              h = !0,
              f = !1,
              d = void 0;
            try {
              for (
                var p, g = c[Symbol.iterator]();
                !(h = (p = g.next()).done);
                h = !0
              ) {
                var v = p.value;
                if (v.type !== CSSRule.IMPORT_RULE) {
                  var y = !0,
                    m = !1,
                    x = void 0;
                  try {
                    for (
                      var w, b = t[Symbol.iterator]();
                      !(y = (w = b.next()).done);
                      y = !0
                    ) {
                      var k = w.value;
      ...
      return M.default.uniq(r.concat(n));
    },
    sortForSlotting: function(t) {
      var e = t.map(function(t, e) {
        var n = t.endpoints;
        return { idx: e, leftAnchor: n[0].idx, width: n[1].idx - n[0].idx + 1 };
      });
      return (
        e.sort(function(t, e) {
        ...
        e.sort(function(t, e) {
          return t.leftAnchor - e.leftAnchor;
        }),
        e.map(function(e) {
          return t[e.idx];
        })
    ...
    R = (function() {
      function t(e, n, r, i) {
        ...
        (0, N.default)(this, t),
          ...
          (this.enabled = !1),
          (this.slot = null),
          (this.calculatingSlot = !1),
          this.trigger && this.trigger.links.push(this),
          this.arguments.forEach(function(t) {
            t.anchor.links.push(o);
          }),
          (this.initialised = !1),
          (this.main = null),
          (this.config = null),
        ...
        (0, P.default)(t, [
          {
            ...
            value: function(e) {
              ...
              (this.main = e),
                ...
                this.trigger && this.handles.push(new W(this.trigger, this)),
                this.arguments.forEach(function(t) {
                  n.handles.push(new W(t.anchor, n));
                  var e = new B(n.mainSvg, n.svg, t.type, "link-arg-label");
                  n.argLabels.push(e);
                }),
                (this.linkLabel = new B(
                  this.mainSvg,
                  this.svg,
                  this.reltype,
                  "link-main-label"
              ...
              this.path
                ...
                .on("dragstart", function(t) {
                  ...
                  try {
                    for (
                      var l, c = n.handles[Symbol.iterator]();
                      !(s = (l = c.next()).done);
                      s = !0
                    ) {
                      var h = l.value;
                      if (n.top) {
                        if (o < n.getLineY(h.row) - 5 || o > h.y + 5) continue;
                      } else if (o < h.y - 5 || o > n.getLineY(h.row) + 5)
                        continue;
                      var f = Math.abs(h.x - e);
                      f > n.config.linkArrowWidth ||
                        ((!r || f < Math.abs(r.x - e)) &&
                          ((r = h), (i = t.detail.p.x)));
                    }
                  } catch (d) {
                ...
                .on("dragmove", function(e) {
                  if ((e.preventDefault(), r)) {
                    var o = e.detail.p.x - i;
                    (i = e.detail.p.x), (r.offset += o);
                    var s,
                      a = r.anchor;
                    a instanceof t
                      ? ((r.offset = Math.min(r.offset, a.width)),
                        (r.offset = Math.max(r.offset, 0)))
                      : ((s =
                          n.top && a.topTag instanceof O.default
                            ? a.topTag.textWidth / 2
                            : !n.top && a.bottomTag instanceof O.default
                            ? a.bottomTag.textWidth / 2
                            : n.top && a instanceof D.default
                            ? a.textWidth / 2
                            : a.boxWidth / 2),
                        (r.offset = Math.min(r.offset, s - 3)),
                        (r.offset = Math.max(r.offset, 3 - s))),
                      n.draw(a);
                  }
                })
                .on("dragend", function() {
                ...
                this.path.dblclick(function(t) {
                  return n.mainSvg.fire("build-tree", { object: n, event: t });
                }),
                (this.path.node.oncontextmenu = function(t) {
                  t.preventDefault(),
                    n.mainSvg.fire("link-right-click", {
                      object: n,
                      type: "link",
                      event: t
                    });
          ...
          },
          {
            ...
            value: function() {
              (this.enabled = !0),
                this.svg && !this.svg.visible() && this.svg.show(),
                this.draw(),
                (this.visible = !0);
            }
          },
          {
            ...
            value: function() {
              (this.enabled = !1),
                this.svg && this.svg.visible() && this.svg.hide(),
                (this.visible = !1);
            }
          },
          {
          ...
          },
          {
            key: "showArgLabels",
            value: function() {
              this.argLabels.forEach(function(t) {
                return t.show();
              }),
                this.draw();
            }
              ...
              if (this.initialised && this.enabled) {
                ...
                try {
                  for (
                    ...
                    var c = u.value.anchor;
                    c instanceof t && !c.visible && c.show();
                  }
                } catch (O) {
                  (s = !0), (a = O);
                } finally {
                ...
                try {
                  for (
                    ...
                    if (y instanceof t) {
                      var m = y.leftHandle;
                      (v.offset = Math.min(v.offset, y.width)),
                        (v.offset = Math.max(v.offset, 0));
                      for (var x = v.offset, w = m.row, b = m.x; x > w.rw - b; )
                        (x -= w.rw - b),
                          (b = 0),
                          (w = this.main.rowManager.rows[w.idx + 1]);
                      var k = b + x,
                        _ = y.getLineY(w);
                      (v.x === k && v.y === _) ||
                        ((v.x = k), (v.y = _), (v.row = w), i.push(v));
                    } else {
                      var C = y.cx + v.offset,
                        T = this.top ? y.absoluteY : y.absoluteDescent;
                      (v.x === C && v.y === T) ||
                        ((v.x = C), (v.y = T), (v.row = y.row), i.push(v));
                    }
                  }
                } catch (O) {
                  (f = !0), (d = O);
                ...
                if (null === this.lastDrawnWidth)
                  this.lastDrawnWidth = this.width;
                else {
                  var A = this.width - this.lastDrawnWidth;
                  if (
                    ((this.lastDrawnWidth = this.width),
                    1 === i.length && i[0] === this.leftHandle)
                  ) {
                    var S = !0,
                      E = !1,
                      M = void 0;
                    try {
                      for (
                        var L, j = this.links[Symbol.iterator]();
                        !(S = (L = j.next()).done);
                        S = !0
                      ) {
                        var N = L.value,
                          P = N.handles.find(function(t) {
                            return t.anchor === n;
                          });
                        (P.offset += A),
                          (P.offset = Math.max(P.offset, 0)),
                          N.draw(this);
                      }
                    } catch (O) {
                      (E = !0), (M = O);
                ...
                this.trigger ? this._drawAsEvent() : this._drawAsRelation();
              }
            }
          },
          {
            ...
            value: function() {
              ...
              function e(e) {
                ...
                n > -1 && e.links.splice(n, 1);
              }
              this.trigger && e(this.trigger),
                this.arguments.forEach(function(t) {
                  return e(t.anchor);
                });
            }
          ...
          },
          {
            ...
            value: function(e) {
              ...
              if (this.calculatingSlot) return 0;
              this.calculatingSlot = !0;
              var n = [],
                r = e.slice(this.endpoints[0].idx + 1, this.endpoints[1].idx);
              e[this.endpoints[0].idx].passingLinks.push(this),
                e[this.endpoints[1].idx].passingLinks.push(this);
              var i = !0,
                o = !1,
                s = void 0;
              try {
                for (
                  ...
                  var l = a.value;
                  l.passingLinks.push(this);
                  var c = !0,
                    h = !1,
                    f = void 0;
                  try {
                    for (
                      var d, p = l.links[Symbol.iterator]();
                      !(c = (d = p.next()).done);
                      c = !0
                    ) {
                      var g = d.value;
                  ...
                  try {
                    for (
                      var x, w = l.clusters[Symbol.iterator]();
                      !(v = (x = w.next()).done);
                      v = !0
                    ) {
                      var b = x.value,
                      ...
                      try {
                        for (
                          var T, A = b.links[Symbol.iterator]();
                          !(k = (T = A.next()).done);
                          k = !0
                        ) {
                          var S = T.value;
              ...
              try {
                for (
                  var j, N = this.arguments[Symbol.iterator]();
                  !(E = (j = N.next()).done);
                  E = !0
                ) {
                  var P = j.value;
                  P.anchor instanceof t &&
                    n.indexOf(P.anchor) < 0 &&
                    n.push(P.anchor);
                }
              } catch (D) {
                (M = !0), (L = D);
              ...
              var O = (n = I.default.sortForSlotting(n))
                .map(function(t) {
                  return t.calculateSlot(e);
                })
                .reduce(function(t, e) {
                  return (e = Math.abs(e)) > t ? e : t;
                }, 0);
              return (
                (this.slot = O + 1),
                this.top || (this.slot = -1 * this.slot),
                (this.calculatingSlot = !1),
                this.slot
              );
            }
          },
          {
            ...
            value: function(t) {
              this.isEditing = !0;
              var e = t.detail.text.bbox();
              t.detail.text.addClass("tag-element").addClass("editing-text"),
                (this.editingText = t.detail.text),
                (this.editingRect = this.svg
                  .rect(e.width + 8, e.height + 4)
                  .x(e.x - 4)
                  .y(e.y - 2)
                  .rx(2)
                  .ry(2)
          ...
          },
          {
            ...
            value: function(t) {
              if (this.editingText) {
                if (void 0 === t) return this.editingText;
                this.editingText.text(t);
              }
            }
          },
          {
          ...
          },
          {
            ...
            value: function() {
              ...
              try {
                for (
                  var c, h = this.handles[Symbol.iterator]();
                  !(a = (c = h.next()).done);
                  a = !0
                ) {
                  var f = c.value;
                  f !== n && (f.precedes(n) ? o.push(f) : s.push(f));
                }
              } catch (Z) {
                (u = !0), (l = Z);
              } finally {
              ...
              for (var d = 0, p = o; d < p.length; d++) {
                ...
                e += "M" + [v.x, v.y];
                var y = this.getLineY(g.row),
                  m = v.x + this.config.linkCurveWidth,
                  x = this.top
                    ? y + this.config.linkCurveWidth
                    : y - this.config.linkCurveWidth;
                if (((e += "L" + [v.x, x] + "Q" + [v.x, y, m, y]), t)) {
                  if (g.row.idx !== t.row.idx) {
                    e += "L" + [g.row.rw, y];
                    for (var w = g.row.idx + 1; w < t.row.idx; w++) {
                      var b = this.main.rowManager.rows[w],
                        k = this.getLineY(b);
                      e += "M" + [0, k] + "L" + [b.rw, k];
                    }
                    e += "M" + [0, this.getLineY(t.row)];
                  }
                  e += "L" + [t.x, t.y];
                }
                if (null === t) {
                  var _ = y;
                  if (g.row.idx !== n.row.idx) {
                    e += "L" + [g.row.rw, y];
                    for (var C = g.row.idx + 1; C < n.row.idx; C++) {
                      var T = this.main.rowManager.rows[C],
                        A = this.getLineY(T);
                      e += "M" + [0, A] + "L" + [T.rw, A];
                    }
                    e += "M" + [0, (_ = this.getLineY(n.row))];
                  }
                  e +=
                    "L" +
                    [r - this.config.linkCurveWidth, _] +
                    "Q" +
                    [
                      r,
                      _,
                ...
                (t = {
                  x: Math.min(v.x + this.config.linkCurveWidth, g.row.rw),
                  y: y,
                  row: g.row
                }),
                  (e += this._arrowhead(v));
                var S = this.argLabels[this.handles.indexOf(g) - 1],
                  E = v.x;
                E + S.length() / 2 > g.row.rw &&
                  (E = g.row.rw - S.length() / 2),
                  E - S.length() / 2 < 0 && (E = S.length() / 2),
                  S.move(E, (v.y + y) / 2);
              }
              t = null;
              for (var M = 0, L = s; M < L.length; M++) {
                var j = L[M],
                  N = {
                    x: j.x,
                    y: this.top
                  ...
                  P = Math.max(N.x - this.config.linkCurveWidth, 0),
                  O = this.getLineY(j.row);
                e += "M" + [P, O];
                var D = N.x - this.config.linkCurveWidth,
                  I = this.top
                    ? O + this.config.linkCurveWidth
                    : O - this.config.linkCurveWidth;
                if (
                  ((e +=
                    "L" + [D, O] + "Q" + [N.x, O, N.x, I] + "L" + [N.x, N.y]),
                  t)
                ) {
                  if (((e += "M" + [t.x, t.y]), t.row.idx !== j.row.idx)) {
                    e += "L" + [t.row.rw, t.y];
                    for (var R = t.row.idx + 1; R < j.row.idx; R++) {
                      var W = this.main.rowManager.rows[R],
                        B = this.getLineY(W);
                      e += "M" + [0, B] + "L" + [W.rw, B];
                    }
                    e += "M" + [0, O];
                ...
                if (null === t) {
                  e += "M" + [r, i];
                  var F = this.getLineY(n.row),
                    H = r + this.config.linkCurveWidth;
                  if (
                    ((e +=
                      "L" +
                      [
                    ...
                    e += "L" + [n.row.rw, F];
                    for (var q = n.row.idx + 1; q < j.row.idx; q++) {
                      var z = this.main.rowManager.rows[q],
                        Y = this.getLineY(z);
                      e += "M" + [0, Y] + "L" + [z.rw, Y];
                    }
                    e += "M" + [0, O];
                ...
                (t = { x: P, y: O, row: j.row }), (e += this._arrowhead(N));
                var $ = this.argLabels[this.handles.indexOf(j) - 1],
                  U = N.x;
                U + $.length() / 2 > j.row.rw &&
                  (U = j.row.rw - $.length() / 2),
                  U - $.length() / 2 < 0 && (U = $.length() / 2),
                  $.move(U, (N.y + O) / 2);
              }
              o.length > 0 &&
                s.length > 0 &&
              ...
              var G = this.getLineY(n.row);
              if (o.length > 0 && s.length > 0) this.linkLabel.move(n.x, G);
              else if (0 === o.length) {
                var X = s[0],
                  V =
                    X.row.idx === n.row.idx
                      ? (n.x + X.x) / 2
                      : (n.x + n.row.rw) / 2;
                this.linkLabel.move(V, G);
              } else if (0 === s.length) {
                var K = o[0],
                  Q = K.row.idx === n.row.idx ? (n.x + K.x) / 2 : n.x / 2;
                this.linkLabel.move(Q, G);
              }
              this.lastPathString !== e &&
                (this.path.plot(e), (this.lastPathString = e));
            }
          },
          {
            key: "_drawAsRelation",
            value: function() {
              var t = "",
                ...
                o = e.row.idx === n.row.idx,
                s = this.linkLabel.length(),
                a = this.getLineY(e.row),
                u = o ? (r.x + i.x) / 2 : (r.x + e.row.rw) / 2;
              u + s / 2 > e.row.rw && (u = e.row.rw - s / 2),
                (t += "M" + [r.x, r.y]);
              var l = this.getLineY(e.row),
                c = r.x + this.config.linkCurveWidth;
              c = Math.min(c, e.row.rw);
              var h = this.top
                ? l + this.config.linkCurveWidth
                : l - this.config.linkCurveWidth;
              t += "L" + [r.x, h] + "Q" + [r.x, l, c, l];
              var f = this.argLabels[this.handles.indexOf(e)],
                d = r.x;
              d + f.length() / 2 > e.row.rw && (d = e.row.rw - f.length() / 2),
                d - f.length() / 2 < 0 && (d = f.length() / 2),
                f.move(d, (r.y + l) / 2);
              var p = l;
              if (!o) {
                t += "L" + [e.row.rw, l];
                for (var g = e.row.idx + 1; g < n.row.idx; g++) {
                  var v = this.main.rowManager.rows[g],
                    y = this.getLineY(v);
                  t += "M" + [0, y] + "L" + [v.rw, y];
                }
                t += "M" + [0, (p = this.getLineY(n.row))];
              }
              var m = i.x - this.config.linkCurveWidth,
                x = this.top
                  ? p + this.config.linkCurveWidth
                  : p - this.config.linkCurveWidth;
              t += "L" + [m, p] + "Q" + [i.x, p, i.x, x] + "L" + [i.x, i.y];
              var w = this.argLabels[this.handles.indexOf(n)],
                b = i.x;
              b + w.length() / 2 > n.row.rw && (b = n.row.rw - w.length() / 2),
                b - w.length() / 2 < 0 && (b = w.length() / 2),
                w.move(b, (i.y + p) / 2),
                (t += this._arrowhead(r) + this._arrowhead(i)),
                this.linkLabel.move(u, a),
                this.lastPathString !== t &&
                  (this.path.plot(t), (this.lastPathString = t));
            }
          },
          {
            key: "_arrowhead",
            value: function(t) {
              var e = this.config.linkArrowWidth;
              return this.top
                ? "M" + [t.x - e, t.y - 5] + "l" + [e, 5] + "l" + [e, -5]
                : "M" + [t.x - e, t.y + 5] + "l" + [e, -5] + "l" + [e, 5];
            }
          },
          {
          ...
          },
          {
            ...
            get: function() {
              var e = null,
                n = null;
              return (
                this.trigger && (e = n = this.trigger),
                this.arguments.forEach(function(r) {
                  if (r.anchor instanceof t) {
                    var i = r.anchor.endpoints;
                    (!e || e.idx > i[0].idx) && (e = i[0]),
                      (!n || n.idx < i[1].idx) && (n = i[1]);
                  } else (!e || e.idx > r.anchor.idx) && (e = r.anchor), (!n || n.idx < r.anchor.idx) && (n = r.anchor);
                }),
                [e, n]
              );
            }
          },
          {
            ...
            get: function() {
              ...
              var t = 0;
              t += this.leftHandle.row.rw - this.leftHandle.x;
              for (
                var e = this.leftHandle.row.idx + 1;
                e < this.rightHandle.row.idx;
                e++
              )
                t += this.main.rowManager.rows[e].rw;
              return t + this.rightHandle.x;
            }
          },
          {
            key: "leftHandle",
            get: function() {
              return this.handles.reduce(function(t, e) {
                return t.precedes(e) ? t : e;
              }, this.handles[0]);
            }
          },
          {
          ...
          },
          {
            ...
            get: function() {
              var t = this;
              return this.trigger
                ? this.handles.find(function(e) {
                    return e.anchor === t.trigger;
                  })
                : null;
            }
          }
    ...
    W = (function() {
      function t(e, n) {
        ...
        var r = e.links
          ...
          .sort(function(t, e) {
            return Math.abs(e.slot) - Math.abs(t.slot);
          });
        if (r.length > 1)
          if (e instanceof R)
            this.offset = (15 * r.indexOf(n)) / (r.length - 1);
          else {
            var i = [],
              o = [],
              s = !0,
            ...
            try {
              for (
                ...
                var h = l.value;
                e.idx > h.endpoints[0].idx ? i.push(h) : o.push(h);
              }
            } catch (f) {
              (a = !0), (u = f);
            } finally {
            ...
            i.sort(function(t, e) {
              return Math.abs(t.slot) - Math.abs(e.slot);
            }),
              (r = i.concat(o)),
              (this.offset = (15 * r.indexOf(n)) / (r.length - 1) - 7.5);
          }
        this.row = e instanceof R ? e.endpoints[0].row : e.row;
      }
      return (
        (0, P.default)(t, [
          {
            ...
            value: function(t) {
              return (
                !(!this.row || !t.row) &&
                (this.row.idx < t.row.idx ||
                  (this.row.idx === t.row.idx && this.x < t.x))
              );
            }
          }
        ]),
      ...
      function t(e, n, r, i) {
        ...
        (0, N.default)(this, t),
          ...
          (this.svgText.node.oncontextmenu = function(t) {
            (o.selectedLabel = r),
              t.preventDefault(),
              o.mainSvg.fire("link-label-right-click", {
                object: o.svgText,
                type: "text",
                event: t
              });
          }),
          this.svgText.click(function(t) {
            return o.mainSvg.fire("link-label-edit", {
              object: o.svgText,
              text: r,
              event: t
            });
          }),
          this.svgText.dblclick(function(t) {
            return o.mainSvg.fire("build-tree", {
              object: o.svgText,
              event: t
            });
          }),
        ...
        (0, P.default)(t, [
          {
            key: "show",
            value: function() {
              this.svgBackground.show(), this.svgText.show();
            }
          },
          {
            key: "hide",
            value: function() {
              this.svgBackground.hide(), this.svgText.hide();
            }
          },
          {
            key: "move",
            value: function(t, e) {
              this.svgBackground.move(t, e), this.svgText.attr({ x: t, y: e });
            }
          },
          {
            key: "centre",
            value: function(t, e) {
              return this.move(t, e + this.baselineYOffset);
            }
          },
          {
            key: "length",
  ...
  var H = t(n),
    ...
    z = (function() {
      var t,
        ...
        s = Object.values(o);
      function a(t) {
        (e = t.detail.object).listenForEdit(t),
          (r = t.detail.object.val),
          (n = null);
      }
      function u() {
        if (e && e.isEditing) {
          var i = e.text();
          !i ||
            e instanceof q.default ||
            t.fire("label-updated", { object: i, label: i.text() }),
            e.stopEditing(),
            (e = null),
            (r = n = null);
        }
      ...
      function l(t) {
        (n = t.slice(0, i)), e.text(n);
      }
      return (
        document.addEventListener("keydown", function(t) {
          if (e && e.isEditing && s.indexOf(t.keyCode) > -1)
            switch (t.keyCode) {
              case o.delete:
                null === n && (n = r), l(n.slice(0, -1));
                break;
              case o.tab:
                break;
              case o.enter:
        ...
        document.addEventListener("keypress", function(t) {
          e &&
            ...
            t.which > 31 &&
              ...
              !t.metaKey &&
              !t.altKey &&
              (null === n && (n = ""), l(n + String.fromCharCode(t.which))));
        }),
        ...
        (0, U.default)(t, [
          {
            ...
            value: function(t) {
              ...
              this.draggable
                ...
                .on("dragmove", function(r) {
                  r.preventDefault();
                  var i = r.detail.p.y - n;
                  (n = r.detail.p.y), t.fire("row-resize", { object: e, y: i });
                });
            }
          },
          {
          ...
          },
          {
            key: "dy",
            value: function(t) {
              (this.ry += t), this.svg.transform({ y: this.baseline });
            }
          },
          {
            key: "move",
          ...
          },
          {
            key: "height",
            value: function(t) {
              (this.rh = t), this.svg.transform({ y: this.baseline });
            }
          },
          {
            key: "width",
            value: function(t) {
              (this.rw = t), this.draggable.attr("x2", this.rw);
            }
          },
          {
            key: "addWord",
            value: function(t, e, n) {
              var r;
              if (
                (isNaN(e) && (e = this.words.length),
                (t.row = this),
                this.words.splice(e, 0, t),
                this.wordGroup.add(t.svg),
                (t.x = -1),
                0 === e)
              )
                r = this.config.rowEdgePadding;
              else {
                var i = this.words[e - 1];
                (r = i.x + i.minWidth),
                  t.isPunct
                    ? (r += this.config.wordPunctPadding)
                    : (r += this.config.wordPadding);
              }
              return n && (r = n), this.positionWord(t, r);
            }
          },
          {
            key: "positionWord",
            value: function(t, e) {
              var n = this.words.indexOf(t),
                r = this.words[n - 1],
                i = this.words[n + 1],
                o = this.words.length;
              if (r) {
              ...
              if (i) {
                var a = i.isPunct
                  ...
                  : this.config.wordPadding;
                i.x - a < e + t.minWidth &&
                  (o = this.positionWord(i, e + t.minWidth + a));
              }
              return e + t.minWidth > this.rw - this.config.rowEdgePadding
                ? n
                : (t.move(e), o);
            }
          },
          {
            ...
            value: function(t) {
              return (
                this.lastRemovedWord !== t && (this.lastRemovedWord = t),
                this.words.splice(this.words.indexOf(t), 1),
                this.wordGroup.removeElement(t.svg),
                t
              );
            }
          },
          ...
          },
          {
            ...
            value: function() {
              ...
              try {
                for (
                  var i, o = this.words[Symbol.iterator]();
                  !(e = (i = o.next()).done);
                  e = !0
                ) {
                  var s = i.value,
                  ...
                  try {
                    for (
                      var c, h = s.passingLinks[Symbol.iterator]();
                      !(a = (c = h.next()).done);
                      a = !0
                    ) {
                      var f = c.value;
                  ...
                  try {
                    for (
                      var v, y = s.clusters[Symbol.iterator]();
                      !(d = (v = y.next()).done);
                      d = !0
                    ) {
                      var m = v.value;
          ...
          },
          {
            ...
            get: function() {
              var t = this.words;
              0 === t.length &&
                null !== this.lastRemovedWord &&
                (t = [this.lastRemovedWord]);
              var e = 0,
                n = !0,
                r = !1,
                i = void 0;
              try {
                for (
                  ...
                  try {
                    for (
                      var h, f = a.passingLinks[Symbol.iterator]();
                      !(u = (h = f.next()).done);
                      u = !0
                    ) {
                      var d = h.value;
            ...
            get: function() {
              ...
              try {
                for (
                  ...
                  var s = i.value;
                  if (((t = Math.max(t, s.boxHeight)), s.clusters.length > 0)) {
                    var a = !0,
                      u = !1,
                      l = void 0;
                    try {
                      for (
                        var c, h = s.clusters[Symbol.iterator]();
                        !(a = (c = h.next()).done);
                        a = !0
                      ) {
                        var f = c.value;
                        t = Math.max(t, f.fullHeight);
                      }
                    } catch (x) {
                      (u = !0), (l = x);
                    } finally {
              ...
              if (
                0 === t &&
                this.lastRemovedWord &&
                ((t = this.lastRemovedWord.boxHeight),
                this.lastRemovedWord.clusters.length > 0)
              ) {
                var d = !0,
                  p = !1,
                  g = void 0;
                try {
                  for (
                    var v, y = this.lastRemovedWord.clusters[Symbol.iterator]();
                    !(d = (v = y.next()).done);
                    d = !0
                  ) {
                    var m = v.value;
                    t = Math.max(t, m.fullHeight);
                  }
                } catch (x) {
                  (p = !0), (g = x);
                } finally {
          ...
          },
          {
            key: "minHeight",
            get: function() {
              var t = this.wordHeight + this.config.rowVerticalPadding,
                e = 0,
                n = this.words;
              0 === n.length &&
                null !== this.lastRemovedWord &&
                (n = [this.lastRemovedWord]);
              var r = !0,
                i = !1,
                o = void 0;
              try {
                for (
                  ...
                  try {
                    for (
                      var f,
                        d = u.links.concat(u.passingLinks)[Symbol.iterator]();
                      !(l = (f = d.next()).done);
                      l = !0
                    ) {
                      var p = f.value;
                      p.top && p.visible && (e = Math.max(e, p.slot));
                    }
                  } catch (g) {
                    (c = !0), (h = g);
                  } finally {
              ...
              return e > 0
                ? t +
                    e * this.config.linkSlotInterval +
          ...
          },
          {
            key: "minDescent",
            get: function() {
              var t = this.wordDescent + this.config.rowVerticalPadding,
                e = 0,
                n = this.words;
              0 === n.length &&
                null !== this.lastRemovedWord &&
                ...
                for (
                  ...
                  try {
                    for (
                      ...
                      var p = f.value;
                      !p.top && p.visible && (e = Math.min(e, p.slot));
                    }
                  } catch (g) {
                    (c = !0), (h = g);
                  } finally {
              ...
              return e < 0 ? t + Math.abs(e) * this.config.linkSlotInterval : t;
            }
          },
          {
            key: "availableSpace",
            get: function() {
              if (0 === this.words.length)
                return this.rw - 2 * this.config.rowEdgePadding;
              var t = this.words[this.words.length - 1];
              return this.rw - this.config.rowEdgePadding - t.x - t.minWidth;
            }
          }
        ]),
        t
        ...
        (0, K.default)(t, [
          {
            key: "resizeAll",
            value: function() {
              this.width(this._svg.width()), this.resizeRow(0), this.fitWords();
            }
          },
          {
            key: "resizeRow",
            value: function(t) {
              var e =
                ...
                n = this._rows[t];
              if (n) {
                var r = this.config.compactRows
                  ? n.minHeight
                  : Math.max(n.rh + e, n.minHeight);
                for (
                  n.rh !== r && (n.height(r), n.redrawLinksAndClusters()),
                    t += 1;
                  t < this._rows.length;
                  t++
                ) {
                  var i = this._rows[t - 1],
                    o = this._rows[t],
                    s = !1,
                    a = this.config.compactRows
                      ? o.minHeight
                      : Math.max(o.rh, o.minHeight);
                  o.rh !== a && (o.height(a), (s = !0)),
                    o.ry !== i.ry2 && (o.move(i.ry2), (s = !0)),
                    s && o.redrawLinksAndClusters();
                }
          ...
          },
          {
            ...
            value: function(t) {
              var e = this;
              this._rows.forEach(function(n) {
                n.width(t);
                var r = n.words.findIndex(function(n) {
                  return n.x + n.minWidth > t - e.config.rowEdgePadding;
                });
                if (r > 0)
                  for (; r < n.words.length; ) e.moveLastWordDown(n.idx);
                else n.redrawLinksAndClusters();
              });
            }
          },
          {
            ...
            value: function() {
              ...
              try {
                for (
                  var r, i = this._rows[Symbol.iterator]();
                  !(t = (r = i.next()).done);
                  t = !0
                )
                  for (var o = r.value, s = 1; s < o.words.length; s++) {
                    var a = o.words[s - 1],
                      u = o.words[s],
                      l = u.isPunct
                        ? this.config.wordPunctPadding
                        : this.config.wordPadding,
                      c = a.x + a.minWidth + l - u.x;
                    if (c > 0)
          ...
          },
          {
            ...
            value: function() {
              var t = this.lastRow,
                e = t
                  ? new Q.default(this._svg, this.config, t.idx + 1, t.ry2)
                  : new Q.default(this._svg, this.config);
              return this._rows.push(e), this._svg.height(e.ry2 + 20), e;
            }
          },
          {
            key: "removeLastRow",
            value: function() {
              this._rows.pop().remove(),
                this.lastRow && this._svg.height(this.lastRow.ry2 + 20);
            }
          },
          {
            key: "addWordToRow",
            value: function(t, e, n, r) {
              isNaN(n) && (n = e.words.length);
              for (var i = e.addWord(t, n, r); i < e.words.length; )
                this.moveLastWordDown(e.idx);
              this.resizeRow(e.idx);
            }
          },
          {
            key: "moveWordOnRow",
              ...
              s
                ? ((e = s.x),
                  (e -= s.isPunct
                    ? this.config.wordPunctPadding
                    : this.config.wordPadding))
                : (e = n.rw - this.config.rowEdgePadding),
                i <= e - (o.x + o.minWidth)
                  ? o.dx(i)
                  : s
                  ? (this.moveWordRight({ row: n, wordIndex: r + 1, dx: i }),
                    this.moveWordRight(t))
                  : this.moveLastWordDown(n.idx);
            }
          },
          {
            key: "moveWordLeft",
            value: function(t) {
              ...
              if (
                r <=
                (a -= o ? o.x + o.minWidth + s : this.config.rowEdgePadding)
              )
                return i.dx(-r), !0;
              if (0 === n) {
                var u = this._rows[e.idx - 1];
                if (!u) return !1;
                if (u.availableSpace >= i.minWidth + s)
                  return this.moveFirstWordUp(e.idx), !0;
                var l = i.minWidth + s - u.availableSpace;
                return (
                  !!this.moveWordLeft({
                    row: u,
                    wordIndex: u.words.length - 1,
                    dx: l
                  }) && (this.moveFirstWordUp(e.idx), !0)
                );
              }
              return (
                !!this.moveWordLeft({ row: e, wordIndex: n - 1, dx: r }) &&
                this.moveWordLeft({
                  row: e,
                  wordIndex: e.words.indexOf(i),
                  dx: r
                })
              );
            }
          },
          {
            ...
            value: function(t) {
              ...
              if (e && n) {
                var r = e.words[0],
                  i = n.rw - this.config.rowEdgePadding - r.minWidth;
                e.removeWord(r),
                  this.addWordToRow(r, n, void 0, i),
                  r.redrawClusters(),
                  r.redrawLinks(),
                  e === this.lastRow &&
                    0 === e.words.length &&
          ...
          },
          {
            ...
            value: function(t) {
              var e = this._rows[t + 1] || this.appendRow();
              this.addWordToRow(this._rows[t].removeLastWord(), e, 0);
            }
          },
          {
            key: "lastRow",
  ...
  (J.isNothing = tt),
    (J.isObject = function(t) {
      return "object" == typeof t && null !== t;
    }),
    (J.toArray = function(t) {
      return Array.isArray(t) ? t : tt(t) ? [] : [t];
    }),
    (J.repeat = function(t, e) {
      var n,
        r = "";
      for (n = 0; n < e; n += 1) r += t;
      return r;
    }),
    (J.isNegativeZero = function(t) {
  ...
  function ut(t) {
    (this.include = t.include || []),
      ...
      (this.compiledImplicit = at(this, "implicit", [])),
      (this.compiledExplicit = at(this, "explicit", [])),
  ...
  (ut.DEFAULT = null),
    (ut.create = function() {
      ...
      switch (arguments.length) {
        case 1:
          (t = ut.DEFAULT), (e = arguments[0]);
          break;
        case 2:
          (t = arguments[0]), (e = arguments[1]);
          break;
        default:
          throw new et("Wrong number of arguments for Schema.create function");
      }
      if (
        ((t = J.toArray(t)),
        (e = J.toArray(e)),
      ...
      return new ut({ include: t, explicit: e });
    }),
    (st = ut);
  var lt = new ot("tag:yaml.org,2002:map", {
      kind: "mapping",
      construct: function(t) {
        return null !== t ? t : {};
      }
    }),
    ct = new ot("tag:yaml.org,2002:seq", {
      kind: "sequence",
      construct: function(t) {
        return null !== t ? t : [];
      }
    ...
    ft = new ot("tag:yaml.org,2002:bool", {
      kind: "scalar",
      resolve: function(t) {
        if (null === t) return !1;
        var e = t.length;
    ...
    pt = /^[-+]?[0-9]+e/,
    gt = new ot("tag:yaml.org,2002:float", {
      kind: "scalar",
      resolve: function(t) {
      ...
      represent: function(t, e) {
        ...
        return (n = t.toString(10)), pt.test(n) ? n.replace("e", ".e") : n;
      },
      defaultStyle: "lowercase"
    });
  function vt(t) {
  ...
  var mt,
    xt = new ot("tag:yaml.org,2002:int", {
      kind: "scalar",
      resolve: function(t) {
        if (null === t) return !1;
        var e,
  ...
  var _t,
    ...
    Tt = new ot("tag:yaml.org,2002:binary", {
      kind: "scalar",
      resolve: function(t) {
        if (null === t) return !1;
        var e,
      ...
      construct: function(t) {
        ...
        for (e = 0; e < i; e++)
          e % 4 == 0 &&
            e &&
            (a.push((s >> 16) & 255), a.push((s >> 8) & 255), a.push(255 & s)),
        ...
        return (
          0 == (n = (i % 4) * 6)
            ...
            : 12 === n && a.push((s >> 4) & 255),
          mt ? (mt.from ? mt.from(a) : new mt(a)) : a
        );
      },
      predicate: function(t) {
        return mt && mt.isBuffer(t);
      },
    ...
    At = new ot("tag:yaml.org,2002:merge", {
      kind: "scalar",
      resolve: function(t) {
        return "<<" === t || null === t;
      }
    ...
    Mt = new ot("tag:yaml.org,2002:omap", {
      kind: "sequence",
      resolve: function(t) {
        if (null === t) return !0;
        var e,
        ...
        for (e = 0, n = a.length; e < n; e += 1) {
          if (((r = a[e]), (o = !1), "[object Object]" !== Et.call(r)))
            return !1;
          for (i in r)
            if (St.call(r, i)) {
              if (o) return !1;
    ...
    jt = new ot("tag:yaml.org,2002:pairs", {
      kind: "sequence",
      resolve: function(t) {
        if (null === t) return !0;
        var e,
        ...
        for (o = new Array(s.length), e = 0, n = s.length; e < n; e += 1) {
          if (((r = s[e]), "[object Object]" !== Lt.call(r))) return !1;
    ...
    Pt = new ot("tag:yaml.org,2002:set", {
      kind: "mapping",
      resolve: function(t) {
        if (null === t) return !0;
        var e,
          n = t;
        for (e in n) if (Nt.call(n, e) && null !== n[e]) return !1;
        return !0;
      },
      construct: function(t) {
        return null !== t ? t : {};
    ...
    Ot = new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),
    Dt = new RegExp(
    ...
    It = new st({
      include: [bt],
      implicit: [
        new ot("tag:yaml.org,2002:timestamp", {
          kind: "scalar",
          resolve: function(t) {
            return null !== t && (null !== Ot.exec(t) || null !== Dt.exec(t));
          },
          construct: function(t) {
            var e,
              n,
              ...
              l = 0,
              c = null;
            if ((null === (e = Ot.exec(t)) && (e = Dt.exec(t)), null === e))
            ...
            return (
              e[9] &&
                ...
                "-" === e[9] && (c = -c)),
              (u = new Date(Date.UTC(n, r, i, o, s, a, l))),
      ...
      explicit: [Tt, Mt, jt, Pt]
    });
  try {
    var Rt = require;
    _t = Rt("esprima");
  } catch (Wr) {
    "undefined" != typeof window && (_t = window.esprima);
  }
  var Wt = new ot("tag:yaml.org,2002:js/function", {
      kind: "scalar",
      resolve: function(t) {
        if (null === t) return !1;
        try {
          var e = "(" + t + ")",
            n = _t.parse(e, { range: !0 });
          return (
            "Program" === n.type &&
            1 === n.body.length &&
      ...
      construct: function(t) {
        ...
        return (
          ...
          "BlockStatement" === r.body[0].expression.body.type
            ...
            : new Function(i, "return " + n.slice(e[0], e[1]))
        );
      },
      predicate: function(t) {
    ...
    Bt = new ot("tag:yaml.org,2002:js/regexp", {
      kind: "scalar",
      resolve: function(t) {
        if (null === t) return !1;
    ...
    Ft = new ot("tag:yaml.org,2002:js/undefined", {
      kind: "scalar",
      resolve: function() {
        return !0;
      },
    ...
    Ht = (st.DEFAULT = new st({ include: [It], explicit: [Ft, Bt, Wt] })),
    qt = {},
  ...
  function ge(t) {
    ...
    return "\\" + n + J.repeat("0", r - e.length) + e;
  }
  function ve(t) {
    (this.schema = t.schema || Ht),
  ...
  function ye(t, e) {
    for (
      var n, r = J.repeat(" ", e), i = 0, o = -1, s = "", a = t.length;
      i < a;
  ...
  function Ee(t, e, n, r) {
    t.dump = (function() {
      ...
      if (!t.noCompatMode && -1 !== pe.indexOf(e)) return "'" + e + "'";
      ...
      switch (
        (function(t, e, n, r, i) {
          var o,
            ...
            f =
              ...
              a !== se &&
              a !== le &&
              !xe(t.charCodeAt(t.length - 1));
          if (e)
            for (o = 0; o < t.length; o++) {
              if (!we((s = t.charCodeAt(o)))) return Se;
              f = f && be(s);
            }
          else {
            for (o = 0; o < t.length; o++) {
              if ((s = t.charCodeAt(o)) === Ut)
                (u = !0),
                  c &&
                    ((l = l || (o - h - 1 > r && " " !== t[h + 1])), (h = o));
              else if (!we(s)) return Se;
              f = f && be(s);
            }
            l = l || (c && o - h - 1 > r && " " !== t[h + 1]);
          }
        ...
        case Ce:
          return "'" + e.replace(/'/g, "''") + "'";
        case Te:
          return "|" + Me(e, t.indent) + Le(ye(e, i));
        case Ae:
          return (
            ">" +
            Me(e, t.indent) +
          ...
          return (
            ...
            (function(t) {
              for (var e, n, r, i = "", o = 0; o < t.length; o++)
                ...
                n <= 57343
                  ? ((i += ge(1024 * (e - 55296) + n - 56320 + 65536)), o++)
                  : (i += !(r = de[e]) && we(e) ? t[o] : r || ge(e));
              return i;
            })(e) +
            '"'
          );
  ...
  function Ne(t, e, n) {
    var r, i, o, s, a, u;
    for (
      o = 0, s = (i = n ? t.explicitTypes : t.implicitTypes).length;
      o < s;
      o += 1
    )
      if (
        ...
        if (((t.tag = n ? a.tag : "?"), a.represent)) {
          if (
            ...
            "[object Function]" === zt.call(a.represent))
          )
            r = a.represent(e, u);
          else {
            if (!Yt.call(a.represent, u))
              throw new et(
  ...
  function Pe(t, e) {
    ...
    return (
      ...
      (function t(e, n, r, i, o, s) {
        (e.tag = null), (e.dump = r), Ne(e, r, !1) || Ne(e, r, !0);
        var a = zt.call(e.dump);
        i && (i = e.flowLevel < 0 || e.flowLevel > n);
        var u,
          l,
          c = "[object Object]" === a || "[object Array]" === a;
        if (
          (c && (l = -1 !== (u = e.duplicates.indexOf(r))),
          ((null !== e.tag && "?" !== e.tag) ||
            l ||
            (2 !== e.indent && n > 0)) &&
            (o = !1),
          ...
          if (
            (c && l && !e.usedDuplicates[u] && (e.usedDuplicates[u] = !0),
            "[object Object]" === a)
          )
                    ...
                    (u = e.condenseFlow ? '"' : ""),
                      ...
                      t(e, n, s, !1, !1) &&
                        ...
                        (u +=
                          ...
                          ":" +
                          (e.condenseFlow ? "" : " ")),
                        t(e, n, a, !1, !1) && (l += u += e.dump));
                  (e.tag = c), (e.dump = "{" + l + "}");
                })(e, n, e.dump),
                l && (e.dump = "&ref_" + u + " " + e.dump));
          else if ("[object Array]" === a) {
            var h = e.noArrayIndent && n > 0 ? n - 1 : n;
            i && 0 !== e.dump.length
              ? ((function(e, n, r, i) {
                  var o,
                    s,
  ...
  (qt.dump = Pe),
    (qt.safeDump = function(t, e) {
      return Pe(t, J.extend({ schema: It }, e));
    });
  var Oe = {};
  ...
  (De.prototype.getSnippet = function(t, e) {
    var n, r, i, o, s;
    ...
    return (
      ...
      J.repeat(" ", t) +
        ...
        i +
        "\n" +
        J.repeat(" ", t + this.position - r + n.length) +
        "^"
    );
  }),
  ...
  var Ie = {},
    ...
    ze = 2,
    Ye = 3,
    $e = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,
    Ue = /[\x85\u2028\u2029]/,
    Ge = /[,\[\]\{\}]/,
    Xe = /^(?:!|!!|![a-z\-]+!)$/i,
  ...
  for (var on = new Array(256), sn = new Array(256), an = 0; an < 256; an++)
    (on[an] = nn(an) ? 1 : 0), (sn[an] = nn(an));
  function un(t, e) {
    (this.input = t),
      (this.filename = e.filename || null),
      (this.schema = e.schema || Ht),
  ...
  function ln(t, e) {
    return new et(
      e,
      new Oe(t.filename, t.input, t.position, t.line, t.position - t.lineStart)
    );
  }
  function cn(t, e) {
    throw ln(t, e);
  ...
  function hn(t, e) {
    t.onWarning && t.onWarning.call(null, ln(t, e));
  }
  var fn = {
    YAML: function(t, e, n) {
      var r, i, o;
      null !== t.version && cn(t, "duplication of %YAML directive"),
        1 !== n.length && cn(t, "YAML directive accepts exactly one argument"),
        null === (r = /^([0-9]+)\.([0-9]+)$/.exec(n[0])) &&
          cn(t, "ill-formed argument of the YAML directive"),
        (i = parseInt(r[1], 10)),
        (o = parseInt(r[2], 10)),
        1 !== i && cn(t, "unacceptable YAML version of the document"),
        (t.version = n[0]),
        (t.checkLineBreaks = o < 2),
        1 !== o && 2 !== o && hn(t, "unsupported YAML version of the document");
    },
    TAG: function(t, e, n) {
      var r, i;
      2 !== n.length && cn(t, "TAG directive accepts exactly two arguments"),
        (r = n[0]),
        (i = n[1]),
        Xe.test(r) ||
          cn(t, "ill-formed tag handle (first argument) of the TAG directive"),
        Re.call(t.tagMap, r) &&
          cn(
            t,
        ...
        Ve.test(i) ||
          cn(t, "ill-formed tag prefix (second argument) of the TAG directive"),
        (t.tagMap[r] = i);
    }
  };
  function dn(t, e, n, r) {
    ...
    if (e < n) {
      if (((a = t.input.slice(e, n)), r))
        for (i = 0, o = a.length; i < o; i += 1)
          9 === (s = a.charCodeAt(i)) ||
            (32 <= s && s <= 1114111) ||
            cn(t, "expected valid JSON character");
      else $e.test(a) && cn(t, "the stream contains non-printable characters");
      t.result += a;
    }
  }
  function pn(t, e, n, r) {
    ...
    for (
      ...
      (o = i[s]), Re.call(e, o) || ((e[o] = n[o]), (r[o] = !0));
  }
  function gn(t, e, n, r, i, o, s, a) {
    ...
    if (Array.isArray(i))
      for (u = 0, l = (i = Array.prototype.slice.call(i)).length; u < l; u += 1)
        Array.isArray(i[u]) &&
          cn(t, "nested arrays are not supported inside keys"),
          "object" == typeof i &&
            "[object Object]" === Ke(i[u]) &&
            (i[u] = "[object Object]");
    if (
      ("object" == typeof i &&
        "[object Object]" === Ke(i) &&
      ...
      if (Array.isArray(o))
        for (u = 0, l = o.length; u < l; u += 1) pn(t, e, o[u], n);
      else pn(t, e, o, n);
    else
      t.json ||
        Re.call(n, i) ||
  ...
  function vn(t) {
    ...
    10 === (e = t.input.charCodeAt(t.position))
      ...
      : cn(t, "a line break is expected"),
      (t.line += 1),
      (t.lineStart = t.position);
  }
  function yn(t, e, n) {
    for (var r = 0, i = t.input.charCodeAt(t.position); 0 !== i; ) {
      for (; Ze(i); ) i = t.input.charCodeAt(++t.position);
      if (e && 35 === i)
        do {
      ...
      if (!Qe(i)) break;
      for (
        vn(t), i = t.input.charCodeAt(t.position), r++, t.lineIndent = 0;
        32 === i;
    ...
    return (
      -1 !== n && 0 !== r && t.lineIndent < n && hn(t, "deficient indentation"),
      r
    );
  }
  function mn(t) {
    ...
    return !(
      ...
      ((n += 3), 0 !== (e = t.input.charCodeAt(n)) && !Je(e))
    );
  }
  function xn(t, e) {
  ...
  function wn(t, e) {
    ...
    for (
      ...
      0 !== r && 45 === r && Je(t.input.charCodeAt(t.position + 1));

    )
      if (((a = !0), t.position++, yn(t, !0, -1) && t.lineIndent <= e))
        ...
        cn(t, "bad indentation of a sequence entry");
      else if (t.lineIndent < e) break;
    return (
      !!a &&
      ((t.tag = i), (t.anchor = o), (t.kind = "sequence"), (t.result = s), !0)
    );
  }
  function bn(t) {
    var e,
    ...
    if (
      (null !== t.tag && cn(t, "duplication of a tag property"),
      ...
      t.position < t.length
        ? ((r = t.input.slice(e, t.position)),
          (i = t.input.charCodeAt(++t.position)))
        : cn(t, "unexpected end of the stream within a verbatim tag");
    } else {
      for (; 0 !== i && !Je(i); )
        33 === i &&
          (s
            ? cn(t, "tag suffix cannot contain exclamation marks")
            : ((n = t.input.slice(e - 1, t.position + 1)),
              Xe.test(n) ||
                cn(t, "named tag handle cannot contain such characters"),
              (s = !0),
              (e = t.position + 1))),
          (i = t.input.charCodeAt(++t.position));
      (r = t.input.slice(e, t.position)),
        Ge.test(r) &&
          cn(t, "tag suffix cannot contain flow indicator characters");
    }
    return (
      r &&
        !Ve.test(r) &&
        cn(t, "tag name cannot contain such characters: " + r),
      o
        ? (t.tag = r)
        : Re.call(t.tagMap, n)
        ? (t.tag = t.tagMap[n] + r)
  ...
  function kn(t) {
    ...
    for (
      null !== t.anchor && cn(t, "duplication of an anchor property"),
    ...
    return (
      t.position === e &&
        cn(t, "name of an anchor node must contain at least one character"),
  ...
  function _n(t, e, n, r, i) {
    ...
    if (
          ...
          ? (a &&
                ...
                (function(t, e, n) {
                  ...
                  for (
                    ...
                    if (
                      ...
                      if (!_n(t, n, Be, !1, !0)) break;
                      if (t.line === o) {
                        for (a = t.input.charCodeAt(t.position); Ze(a); )
                          a = t.input.charCodeAt(++t.position);
                        if (58 === a)
                          Je((a = t.input.charCodeAt(++t.position))) ||
                            cn(
                              t,
                              "a whitespace character is expected after the key-value separator within a block mapping"
                            ),
                            g && (gn(t, c, h, f, d, null), (f = d = p = null)),
                            (v = !0),
                            (g = !1),
                            (i = !1),
                            (f = t.tag),
                    ...
                    if (
                      ((t.line === o || t.lineIndent > e) &&
                        (_n(t, e, He, !0, i) &&
                          (g ? (d = t.result) : (p = t.result)),
                        g || (gn(t, c, h, f, d, p, o, s), (f = d = p = null)),
                        yn(t, !0, -1),
                        (a = t.input.charCodeAt(t.position))),
                      t.lineIndent > e && 0 !== a)
                    )
                      cn(t, "bad indentation of a mapping entry");
                    else if (t.lineIndent < e) break;
                  }
                  return (
                    g && gn(t, c, h, f, d, null),
            ...
            (function(t, e) {
              ...
              for (
                ...
                if ((yn(t, !0, e), (h = t.input.charCodeAt(t.position)) === i))
                  return (
                    t.position++,
                    (t.tag = d),
                    (t.anchor = p),
                ...
                f || cn(t, "missed comma between flow collection entries"),
                  (c = null),
                  (o = s = !1),
                  63 === h &&
                    Je(t.input.charCodeAt(t.position + 1)) &&
                    ((o = s = !0), t.position++, yn(t, !0, e)),
                  (n = t.line),
                  _n(t, e, We, !1, !0),
                  (l = t.tag),
                  (u = t.result),
              ...
              cn(t, "unexpected end of the stream within a flow collection");
            })(t, h)
            ? (g = !0)
            : ((s &&
                (function(t, e) {
                  ...
                  for (t.kind = "scalar", t.result = ""; 0 !== o; )
                    if (
                      ...
                      qe === a
                        ? (a = 43 === o ? Ye : ze)
                        : cn(t, "repeat of a chomping mode identifier");
                    else {
                      ...
                      0 === i
                        ...
                        : l
                        ? cn(t, "repeat of an indentation width identifier")
                        : ((c = e + i - 1), (l = !0));
                    }
                  if (Ze(o)) {
                    do {
                  ...
                  for (; 0 !== o; ) {
                    for (
                      vn(t),
                        t.lineIndent = 0,
                        o = t.input.charCodeAt(t.position);
                      (!l || t.lineIndent < c) && 32 === o;

                    )
                      t.lineIndent++, (o = t.input.charCodeAt(++t.position));
                    if ((!l && t.lineIndent > c && (c = t.lineIndent), Qe(o)))
                      h++;
                    else {
                      if (t.lineIndent < c) {
                        a === Ye
              ...
              (function(t, e) {
                ...
                for (
                  ...
                  if (34 === a)
                    return dn(t, n, t.position, !0), t.position++, !0;
                  if (92 === a) {
                    if (
                      (dn(t, n, t.position, !0),
                      Qe((a = t.input.charCodeAt(++t.position))))
                    )
                      yn(t, !1, e);
                    else if (a < 256 && on[a])
                      (t.result += sn[a]), t.position++;
                    else if (
                      (s =
                        120 === (u = a)
                          ? 2
                      ...
                      for (i = s, o = 0; i > 0; i--)
                        (s = en((a = t.input.charCodeAt(++t.position)))) >= 0
                          ? (o = (o << 4) + s)
                          : cn(t, "expected hexadecimal character");
                      (t.result += rn(o)), t.position++;
                    } else cn(t, "unknown escape sequence");
                    n = r = t.position;
                  } else
                    Qe(a)
                      ? (dn(t, n, r, !0),
                ...
                ? ((g = !0),
                  (null === t.tag && null === t.anchor) ||
                    cn(t, "alias node should not have any properties"))
                : (function(t, e, n) {
                    var r,
                      i,
                      o,
                      ...
                      f = t.result;
                    if (
                      Je((c = t.input.charCodeAt(t.position))) ||
                      tn(c) ||
                      35 === c ||
                      38 === c ||
                      42 === c ||
                    ...
                    if (
                      (63 === c || 45 === c) &&
                      (Je((r = t.input.charCodeAt(t.position + 1))) ||
                        (n && tn(r)))
                    )
                      return !1;
                    for (
                      ...
                      if (58 === c) {
                        ...
                        if (Je(t.input.charCodeAt(t.position - 1))) break;
                      } else {
                        if (
                          (t.position === t.lineStart && mn(t)) ||
                          (n && tn(c))
      ...
      if ("?" === t.tag) {
        for (u = 0, l = t.implicitTypes.length; u < l; u += 1)
          if ((c = t.implicitTypes[u]).resolve(t.result)) {
        ...
        Re.call(t.typeMap[t.kind || "fallback"], t.tag)
  ...
  function Cn(t) {
    ...
    for (
      ...
      0 !== i && vn(t),
        Re.call(fn, n)
          ? fn[n](t, n, r)
          : hn(t, 'unknown document directive "' + n + '"');
    }
    yn(t, !0, -1),
      0 === t.lineIndent &&
      ...
      45 === t.input.charCodeAt(t.position + 2)
        ? ((t.position += 3), yn(t, !0, -1))
        : s && cn(t, "directives end mark is expected"),
      _n(t, t.lineIndent - 1, He, !1, !0),
      yn(t, !0, -1),
      t.checkLineBreaks &&
        Ue.test(t.input.slice(o, t.position)) &&
        hn(t, "non-ASCII line breaks are interpreted as content"),
      t.documents.push(t.result),
      t.position === t.lineStart && mn(t)
        ? 46 === t.input.charCodeAt(t.position) &&
          ((t.position += 3), yn(t, !0, -1))
        : t.position < t.length - 1 &&
          cn(t, "end of the stream or a document separator is expected");
  }
  function Tn(t, e) {
    (e = e || {}),
      0 !== (t = String(t)).length &&
    ...
    for (; n.position < n.length - 1; ) Cn(n);
    return n.documents;
  }
  function An(t, e, n) {
    var r,
  ...
  (Ie.loadAll = An),
    (Ie.load = Sn),
    (Ie.safeLoadAll = function(t, e, n) {
      if ("function" != typeof e) return An(t, J.extend({ schema: It }, n));
      An(t, e, J.extend({ schema: It }, n));
    }),
    (Ie.safeLoad = function(t, e) {
      return Sn(t, J.extend({ schema: It }, e));
    });
  var En = {};
  function Mn(t) {
    return function() {
  ...
  (En.Type = ot),
    (En.Schema = st),
    (En.FAILSAFE_SCHEMA = ht),
    (En.JSON_SCHEMA = wt),
    (En.CORE_SCHEMA = bt),
    (En.DEFAULT_SAFE_SCHEMA = It),
    (En.DEFAULT_FULL_SCHEMA = Ht),
    (En.load = Ie.load),
    (En.loadAll = Ie.loadAll),
    (En.safeLoad = Ie.safeLoad),
    (En.safeLoadAll = Ie.safeLoadAll),
    (En.dump = qt.dump),
    (En.safeDump = qt.safeDump),
    (En.YAMLException = et),
    (En.MINIMAL_SCHEMA = ht),
    (En.SAFE_SCHEMA = It),
    (En.DEFAULT_SCHEMA = Ht),
    (En.scan = Mn("scan")),
    (En.parse = Mn("parse")),
    (En.compose = Mn("compose")),
    (En.addConstructor = Mn("addConstructor"));
  var Ln = En,
    jn = { exports: {} };
  !(function(t, e) {
    if ("object" == typeof jn.exports) {
      var n = e();
      jn && jn.exports && (jn.exports = jn.exports = n),
        (jn.exports.randomColor = n);
    } else t.randomColor = e();
  })(this, function() {
    var t = null,
      e = {};
    ...
    var n = [],
      r = function(s) {
        if (
          void 0 !== (s = s || {}).seed &&
          null !== s.seed &&
          s.seed === parseInt(s.seed, 10)
        )
          t = s.seed;
        else if ("string" == typeof s.seed)
          t = (function(t) {
            for (
              var e = 0, n = 0;
          ...
          if (void 0 !== s.seed && null !== s.seed)
            throw new TypeError("The seed value must be an integer or string");
          t = null;
        }
        var c, h;
        if (null !== s.count && void 0 !== s.count) {
          for (var f = s.count, d = [], p = 0; p < s.count; p++) n.push(!1);
          for (s.count = null; f > d.length; )
            t && s.seed && (s.seed += 1), d.push(r(s));
          return (s.count = f), d;
        }
        return (function(t, e) {
          switch (e.format) {
          ...
          [
            (c = (function(t) {
              if (n.length > 0) {
                var r = o(
                      ...
                      if (isNaN(t)) {
                        if ("string" == typeof t)
                          if (e[t]) {
                            ...
                            return i(u(t)[0]).hueRange;
                          }
                      } else {
                        var r = parseInt(t);
                        if (r < 360 && r > 0) return i(t).hueRange;
                      }
                      return [0, 360];
                    })(t.hue))
                  ),
                  ...
                  a = parseInt((r - l[0]) / s);
                return (
                  !0 === n[a] ? (a = (a + 2) % n.length) : (n[a] = !0),
                  (r = o(
                    (l = [(l[0] + a * s) % 359, (l[0] + (a + 1) * s) % 359])
                  )) < 0 && (r = 360 + r),
                  r
                );
              }
            ...
            (h = (function(t, e) {
              ...
              if ("random" === e.luminosity) return o([0, 100]);
              var n = (function(t) {
                  return i(t).saturationRange;
                })(t),
                r = n[0],
                s = n[1];
              switch (e.luminosity) {
            ...
            (function(t, e, n) {
              var r = (function(t, e) {
                  for (var n = i(t).lowerBounds, r = 0; r < n.length - 1; r++) {
                    var o = n[r][0],
                      s = n[r][1],
                      a = n[r + 1][0],
                      u = n[r + 1][1];
    ...
    function o(e) {
      if (null === t) {
        ...
        return (
          (n += 0.618033988749895),
          (n %= 1),
          Math.floor(e[0] + n * (e[1] + 1 - e[0]))
        );
      }
      var r = e[1] || 1,
        i = e[0] || 0,
        o = (t = (9301 * t + 49297) % 233280) / 233280;
      return Math.floor(i + o * (r - i));
    }
    function s(t, n, r) {
      var i = r[0][0],
        o = r[r.length - 1][0],
    ...
    function u(t) {
      t =
        3 === (t = t.replace(/^#/, "")).length ? t.replace(/(.)/g, "$1$1") : t;
      ...
      switch (i) {
        case e:
          return [(((n - r) / o) % 6) * 60 || 0, s, i];
        case n:
          return [60 * ((r - e) / o + 2) || 0, s, i];
        case r:
          return [60 * ((e - n) / o + 4) || 0, s, i];
      }
    }
    function l(t) {
      var e = t[0],
      ...
      return [
        e,
        Math.round(((n * r) / (i < 1 ? i : 2 - i)) * 1e4) / 100,
        (i / 2) * 100
      ];
    }
    return r;
      ...
      return (
        (0, In.default)(t, [
          ...
          },
          {
            ...
            value: function(t) {
              this.topTag && (this.topTag.remove(), (this.topTag = null)),
                this.registeredTags[t] &&
                  ((this.topTagCategory = t),
                  this.initialised &&
                    ((this.topTag = new Rn.default(
                      this.registeredTags[t],
                      this,
                      this.config
                    )),
          ...
          },
          {
            ...
            value: function(t) {
              this.bottomTag &&
                (this.bottomTag.remove(), (this.bottomTag = null)),
                this.registeredTags[t] &&
                  ((this.bottomTagCategory = t),
                  this.initialised &&
                    ((this.bottomTag = new Rn.default(
                      this.registeredTags[t],
                      this,
                      this.config,
                      !1
          ...
          },
          {
            ...
            value: function(t) {
              var e = this;
              (this.main = t), (this.config = t.config);
              var n = t.svg;
              (this.svg = n
                .group()
                .addClass("tag-element")
                ...
                (this.svgText = this.svg
                  ...
                  .addClass("word-text")
                  .leading(1));
              var r = this.svgText.bbox();
              this.svgText.move(-r.x, -r.height),
                (this._textBbox = this.svgText.bbox()),
                this.topTagCategory &&
                  (this.topTag = new Rn.default(
              ...
              this.svgText
                .draggable()
                .on("dragstart", function(t) {
                  (o = !1), (i = t.detail.p.x), n.fire("word-move-start");
                })
                .on("dragmove", function(t) {
                  t.preventDefault();
                  var r = t.detail.p.x - i;
                  (i = t.detail.p.x),
                    n.fire("word-move", { object: e, x: r }),
                    0 !== r && (o = !0);
                })
                .on("dragend", function() {
                  n.fire("word-move-end", { object: e, clicked: !1 === o });
                }),
                this.svgText.dblclick(function(t) {
                  return n.fire("build-tree", { object: e, event: t });
                }),
                (this.svgText.node.oncontextmenu = function(t) {
                  t.preventDefault(),
                    n.fire("word-right-click", { object: e, event: t });
                }),
                (this.initialised = !0);
            }
          },
          ...
          },
          {
            ...
            value: function() {
              ...
              this.clusters.forEach(function(e) {
                e.endpoints.indexOf(t) > -1 && e.draw();
              });
            }
          },
          {
          ...
          },
          {
            ...
            value: function() {
              ...
              var t = this.svgText.bbox();
              this.svgText.move(-t.x, -t.height),
                (this._textBbox = this.svgText.bbox()),
                this.topTag && this.topTag.centre(),
                this.bottomTag && this.bottomTag.centre(),
              ...
              e <= 0 ||
                ((function t(e, n) {
                  ...
                  try {
                    for (
                      var s, a = e.children()[Symbol.iterator]();
                      !(r = (s = a.next()).done);
                      r = !0
                    ) {
                      var u = s.value;
                      u.children && u.children() ? t(u, n) : u.dx(n);
                    }
                  } catch (l) {
                    (i = !0), (o = l);
                  } finally {
          ...
          },
          {
            ...
            get: function() {
              ...
              try {
                for (
                  var i, o = this.clusters[Symbol.iterator]();
                  !(e = (i = o.next()).done);
                  e = !0
                ) {
                  var s = i.value,
                    a = (0, On.default)(s.endpoints, 2),
                    u = a[0],
                    l = a[1];
                  if (u.row === l.row) {
                    var c =
                        s.endpoints[1].x +
                        s.endpoints[1].boxWidth -
                        s.endpoints[0].x,
                      h = s.svgText.bbox().width;
                    h > c && (t = Math.max(t, h / s.words.length));
                  }
                }
              } catch (f) {
                (n = !0), (r = f);
          ...
          },
          {
            key: "isPunct",
            get: function() {
              return 1 === this.text.length && this.text.charCodeAt(0) < 65;
            }
          }
        ]),
        t
    ...
    Un = (function() {
      function t(e) {
        (0, Fn.default)(this, t),
          ...
          (this.taxonomyYaml = ""),
          (this.tagColours = {}),
          (this.defaultColours = qn.default.cloneDeep(e.tagDefaultColours));
      }
      return (
        (0, Hn.default)(
          t,
          [
            {
              ...
              value: function(t) {
                (this.taxonomy = Yn.default.safeLoad(t)),
                  (this.taxonomyYaml = t);
              }
            },
            {
            ...
            },
            {
              ...
              value: function(e) {
                ...
                e.forEach(function(e) {
                  e.topTag &&
                    (n.tagColours[e.topTag.val] ||
                      n.assignColour(e.topTag.val, n.getNewColour()),
                    t.setColour(e, n.tagColours[e.topTag.val])),
                    e.clusters.length > 0 &&
                      e.clusters.forEach(function(e) {
                        n.tagColours[e.val] ||
                          n.assignColour(e.val, n.getNewColour()),
                          t.setColour(e, n.tagColours[e.val]);
                      });
                });
              }
            },
            ...
            },
            {
              key: "getColour",
              value: function(t) {
                return this.tagColours[t];
              }
            },
            {
              key: "getNewColour",
              value: function() {
                return this.defaultColours.length > 0
                  ? this.defaultColours.shift()
                  : (0, zn.default)();
              }
            },
            {
              ...
              value: function() {
                this.defaultColours = qn.default.cloneDeep(
                  this.config.tagDefaultColours
                );
              }
            }
          ],
          [
            {
              ...
              value: function(t, e) {
                t instanceof $n.default
                  ? (t.topTag.svgText.node.style.fill = e)
                  : (t.svgText.node.style.fill = e);
              }
            }
          ]
        ),
        ...
        (0, Kn.default)(t, [
          {
            ...
            value: function(t, e, n) {
              ...
              if (((this.mentions = {}), e))
                ...
                var o = t.split("\n");
                (this.text = o[0]), (r = o.slice(1));
              }
              r.forEach(function(t) {
                var e = t.trim().split(/\s+/);
                e[0] &&
                  e[0].match(/[TER]\d+/) &&
                  (i.mentions[e[0]] = { annotation: e, object: null });
              });
              var s = { words: [], links: [], clusters: [] };
              for (var a in ((this.textArray = [
                { charStart: 0, charEnd: this.text.length, entity: null }
              ]),
              this.mentions))
                this.mentions[a] &&
                  null === this.mentions[a].object &&
                  this.parseAnnotation(a, s);
              s.words.length;
              var u = 0;
              this.textArray.forEach(function(t, e) {
                if (null === t.entity) {
                  var n = i.text.slice(t.charStart, t.charEnd).trim();
                  if ("" === n) return;
                  n.split(/\s+/).forEach(function(t) {
                    var e = new Qn.default(t, u);
                    s.words.push(e), u++;
                  });
                } else (t.entity.idx = u), u++;
              }),
                s.words.sort(function(t, e) {
                  return t.idx - e.idx;
                }),
                (this.data = s);
            }
          },
          {
            key: "parseAnnotation",
            value: function(t, e) {
              var n = this.mentions[t];
              if (void 0 === n) return null;
              if (null !== n.object) return n.object;
              var r = n.annotation;
              switch (r[0].charAt(0)) {
                case "T":
                  var i = this.parseTextMention(r);
                  return null === i
                    ? (delete this.mentions[t], null)
                    : (e.words.push(i), (n.object = i), i);
                case "E":
                  var o = this.parseEventMention(r, e);
                  return null === o
                    ? (delete this.mentions[t], null)
                    : (e.links.push(o), (n.object = o), o);
                case "R":
                  var s = this.parseRelationMention(r, e);
                  return null === s
                    ? (delete this.mentions[t], null)
                    : (e.links.push(s), (n.object = s), s);
              }
              return null;
            }
          },
          {
            ...
            value: function(t) {
              var e = t[0].slice(1),
                ...
                r = Number(t[2]),
                i = Number(t[3]);
              if (r >= 0 && r < i && i <= this.text.length) {
                var o = new Qn.default(this.text.slice(r, i), Number(e));
                o.registerTag("default", n), o.addEventId(e);
                var s = { charStart: r, charEnd: i, entity: o },
                  a = this.textArray.findIndex(function(t) {
                    return t.charEnd > r;
                  });
                if (-1 === a) console.log("// mistake in tokenizing string");
                else if (this.textArray[a].charStart < r) {
                  var u = this.textArray[a].charEnd;
                  (this.textArray[a].charEnd = r),
                    u > i
                      ? this.textArray.splice(a + 1, 0, s, {
                          charStart: i,
                          charEnd: u,
                          entity: null
                        })
                  ...
                  this.textArray[a].charEnd === i
                    ? (this.textArray[a].entity = o)
                    : (this.textArray.splice(a, 0, s),
                      (this.textArray[a + 1].charStart = i),
                      (this.textArray[a + 1].entity = null));
                return o;
              }
              return null;
            }
          ...
          },
          {
            ...
            value: function(t, e) {
              ...
              return r && o.length > 1
                ? new Zn.default(i, o[0].anchor, o.slice(1))
                : null;
            }
          },
          {
            ...
            value: function(t, e) {
              ...
              var r = !0,
                i = t[0],
                o = t[1],
                s = t.slice(2, 4).map(function(t) {
                  var i = t.split(n.re),
                    o = (0, Xn.default)(i, 2),
                    s = o[0],
                    a = o[1],
                    u = n.parseAnnotation(a, e);
                  if (null !== u) return { type: s, anchor: u };
                  r = !1;
                });
              return !0 === r ? new Zn.default(i, null, s, o) : null;
            }
          }
        ]),
        t
  ...
  var er = t(Nn),
    ...
    ar = (function() {
      function t() {
        (0, nr.default)(this, t),
          (this.data = { words: [], links: [], clusters: [] }),
        ...
        (0, rr.default)(t, [
          {
            ...
            value: function(t) {
              this.reset();
              var e = Object.keys(t.documents).sort(),
                n = !0,
                r = !1,
                i = void 0;
              try {
                for (
                  ...
                  var a = o.value;
                  this.parsedDocuments[a] = this._parseDocument(
                    t.documents[a],
                    a
                  );
                }
              ...
              try {
                for (
                  var h, f = t.mentions[Symbol.iterator]();
                  !(u = (h = f.next()).done);
                  u = !0
                ) {
                  var d = h.value;
                  this._parseMention(d);
                }
              } catch (p) {
                (l = !0), (c = p);
              } finally {
          ...
          },
          {
            ...
            value: function(t, e) {
              ...
              try {
                for (
                  var s, a = t.sentences.entries()[Symbol.iterator]();
                  !(r = (s = a.next()).done);
                  r = !0
                ) {
                  for (
                    var u = (0, er.default)(s.value, 2),
                      l = u[0],
                      c = u[1],
                      h = [],
                      f = 0;
                    ...
                    var d = new ir.default(
                      c.words[f],
                      f + this.lastWordIdx + 1
                    );
                    c.raw && d.registerTag("raw", c.raw[f]),
                      c.tags && d.registerTag("POS", c.tags[f]),
                      c.lemmas && d.registerTag("lemma", c.lemmas[f]),
                      c.entities && d.registerTag("entity", c.entities[f]),
                      c.norms && d.registerTag("norm", c.norms[f]),
                      c.chunks && d.registerTag("chunk", c.chunks[f]),
                      h.push(d),
                      this.data.words.push(d);
                  }
                  this.lastWordIdx += c.words.length;
                  for (
                    var p = Object.keys(c.graphs), g = 0, v = p;
                    g < v.length;
                    g++
                  ) {
                    var y = v[g],
                    ...
                    try {
                      for (
                        var k, _ = m.edges.entries()[Symbol.iterator]();
                        !(x = (k = _.next()).done);
                        x = !0
                      ) {
                        var C = (0, er.default)(k.value, 2),
                          T = C[0],
                          A = C[1];
                        this.data.links.push(
                          new or.default(
                            ""
                              ...
                              .concat(T),
                            h[A.source],
                            [{ anchor: h[A.destination], type: A.relation }],
                            A.relation,
                            !1,
                            y
                          )
          ...
          },
          {
            key: "_parseMention",
            value: function(t) {
              if (this.parsedMentions[t.id]) return this.parsedMentions[t.id];
              if ("TextBoundMention" === t.type) {
                var e = this.parsedDocuments[t.document].sentences[
                    t.sentence
                  ].slice(t.tokenInterval.start, t.tokenInterval.end),
                  n = t.labels[0];
                if (1 === e.length)
                  return (
                    e[0].registerTag("default", n),
                    (this.parsedMentions[t.id] = e[0]),
                    e[0]
                  );
                var r = new sr.default(e, n);
                return (
                  this.data.clusters.push(r), (this.parsedMentions[t.id] = r), r
                );
              }
              if ("EventMention" === t.type || "RelationMention" === t.type) {
                var i = null;
                t.trigger && (i = this._parseMention(t.trigger));
                for (
                  var o = t.labels[0],
                    s = [],
                    a = 0,
                    u = Object.entries(t.arguments);
                  a < u.length;
                  a++
                ) {
                  var l = (0, er.default)(u[a], 2),
                    c = l[0],
                    h = l[1],
                    f = !0,
                    d = !1,
                  ...
                  try {
                    for (
                      var g, v = h[Symbol.iterator]();
                      !(f = (g = v.next()).done);
                      f = !0
                    ) {
                      var y = g.value,
                        m = this._parseMention(y);
                      s.push({ anchor: m, type: c });
                    }
                  } catch (w) {
                    (d = !0), (p = w);
                  } finally {
                ...
                var x = new or.default(t.id, i, s, o, !0);
                return (
                  this.data.links.push(x), (this.parsedMentions[t.id] = x), x
                );
              }
            }
          }
  ...
  var lr = t(n),
    ...
    gr = (function() {
      function t() {
        (0, lr.default)(this, t),
          (this._parsedData = { words: [], links: [], clusters: [] }),
          (this.ann = new fr.default()),
          (this.odin = new dr.default());
      }
      return (
        (0, cr.default)(t, [
          {
            key: "loadData",
            value: function(t, e) {
              if ("brat" === e) this.parseBrat(t);
              else {
                if ("odin" !== e) throw "Unknown annotation format: ".concat(e);
                this.parseOdin(t);
              }
          ...
          },
          {
            ...
            value: function(t, e) {
              if (1 === t.length) {
                var n = t[0];
                if ("brat" === e) this.parseBrat(n.content);
                else {
                  if ("odin" !== e)
                    throw "Unknown annotation format: ".concat(e);
                  this.parseOdin(JSON.parse(n.content));
                }
              } else {
                t.sort(function(t, e) {
                ...
                for (
                  var r = [], i = t[0].name.match(pr), o = 1;
                  o < t.length;
                  ++o
                ) {
                  var s = t[o].name.match(pr);
                  if (s[1] && s[0] === i[0]) {
                    r.push(t[0], t[o]);
                    for (var a = o + 1; a < t.length; ) {
                      var u = t[a].name.match(pr);
                      if (!u[1] || u[0] !== i[0]) break;
                      r.push(t[a]), ++a;
                    }
                    break;
                  }
                ...
                if (2 === r.length) {
                  var l = r.find(function(t) {
                      return t.name.endsWith(".txt");
                    }),
                    c = r.find(function(t) {
                      return !t.name.endsWith(".txt");
                    });
                  this.parseBrat(l.content, c.content);
                } else {
                  var h = r.find(function(t) {
                      return t.name.endsWith(".txt");
                    }),
                    f = r.find(function(t) {
                      return t.name.endsWith(".a1");
                    }),
                    d = r.find(function(t) {
                      return t.name.endsWith(".a2");
                    });
                  if (!(h && d && f))
                    throw "Wrong number/type of files for Brat format";
                  this.parseBrat(h.content, f.content, d.content);
                }
              }
              return this.getParsedData();
            }
          },
          {
            key: "getParsedData",
            value: function() {
              return hr.default.cloneDeep(this._parsedData);
            }
          },
          {
            key: "parseBrat",
          ...
          },
          {
            key: "parseOdin",
            value: function(t) {
              this.odin.parse(t), (this._parsedData = this.odin.data);
            }
          }
        ]),
        t
          ...
          function t(e) {
            var n =
              arguments.length > 1 && void 0 !== arguments[1]
                ...
                : {};
            (0, wr.default)(this, t),
              (this.config = kr.default.defaults(n, new Mr.default())),
              kr.default.hasIn(e, "jquery") && (e = e[0]),
              (this.svg = new Cr.Doc(e)),
              (this.$container = (0, _r.default)(this.svg.node).parent()),
              (this.parser = new Tr.default()),
              (this.rowManager = new Ar.default(this.svg, this.config)),
              (this.labelManager = new Sr.default(this.svg)),
              (this.taxonomyManager = new Er.default(this.config)),
              (this.words = []),
              (this.links = []),
              this.resize(),
            ...
            (0, br.default)(t, [
              {
                key: "loadData",
                value: function(t, e) {
                  this.parser.loadData(t, e), this.redraw();
                }
              },
              {
                key: "loadUrlAsync",
                value: ((n = (0, xr.default)(
                  mr.default.mark(function t(e, n) {
                    var r;
                    return mr.default.wrap(
                      function(t) {
                        for (;;)
                          switch ((t.prev = t.next)) {
                            case 0:
                              return (t.next = 2), _r.default.ajax(e);
                            case 2:
                              (r = t.sent),
                                this.parser.loadData(r, n),
                                this.redraw();
                            case 5:
                            case "end":
                              return t.stop();
              ...
              },
              {
                ...
                value: function() {
                  var t = this,
                    e = this.parser.getParsedData();
                  (this.words = e.words),
                    (this.links = e.links),
                    (this.links = Lr.default.sortForSlotting(this.links)),
                    this.links.forEach(function(e) {
                      return e.calculateSlot(t.words);
                    }),
                    this.words.length > 0 &&
                      !this.rowManager.lastRow &&
                      this.rowManager.appendRow(),
                    this.words.forEach(function(e) {
                      e.setTopTagCategory(t.config.topTagCategory),
                        e.setBottomTagCategory(t.config.bottomTagCategory),
                        e.init(t),
                        t.rowManager.addWordToRow(e, t.rowManager.lastRow);
                    }),
                    this.links.forEach(function(e) {
                      e.init(t);
                    });
              ...
              },
              {
                ...
                value: function() {
                  var t = this;
                  this.links.forEach(function(e) {
                    ((e.top && e.category === t.config.topLinkCategory) ||
                      (!e.top && e.category === t.config.bottomLinkCategory)) &&
                      e.show(),
                      (e.top && t.config.showTopMainLabel) ||
                      (!e.top && t.config.showBottomMainLabel)
                        ? e.showMainLabel()
                        : e.hideMainLabel(),
                      (e.top && t.config.showTopArgLabels) ||
                      (!e.top && t.config.showBottomArgLabels)
                        ? e.showArgLabels()
                        : e.hideArgLabels();
                  }),
                    this.rowManager.resizeAll(),
                    this.rowManager.rows.forEach(function(e) {
                      t.config.compactRows
                        ? e.draggable.addClass("row-drag-compact")
                        : e.draggable.removeClass("row-drag-compact");
                    }),
              ...
              },
              {
                key: "clear",
                value: function() {
                  for (; this.rowManager.rows.length > 0; )
                    this.rowManager.removeLastRow();
                  this.links.forEach(function(t) {
                    return t.svg && t.svg.remove();
                  }),
              ...
              },
              {
                key: "loadTaxonomyYaml",
                value: function(t) {
                  return this.taxonomyManager.loadTaxonomyYaml(t);
                }
              },
              {
                key: "getTaxonomyYaml",
              ...
              },
              {
                key: "getColour",
                value: function(t) {
                  return this.taxonomyManager.getColour(t);
                }
              },
              {
                key: "setColour",
                value: function(t, e) {
                  this.taxonomyManager.assignColour(t, e),
                    this.taxonomyManager.colour(this.words);
                }
              },
              {
                ...
                value: function() {
                  ...
                  (t =
                    ...
                    t.slice(n)),
                    (0, _r.default)(
                      '<a \n      href="data:image/svg+xml;charset=utf-8,'.concat(
                        encodeURIComponent(t),
                        '"\n      download="tag.svg"></a>'
                      )
                    )
                      .appendTo((0, _r.default)("body"))[0]
                      .click();
                }
              },
              {
              ...
              },
              {
                ...
                value: function() {
                  ...
                  return kr.default.uniq(t);
                }
              },
              {
                key: "setTopLinkCategory",
                value: function(t) {
                  this.setOption("topLinkCategory", t),
                    this.links
                      .filter(function(t) {
                        return t.top;
                      })
                      .forEach(function(e) {
                        e.category === t ? e.show() : e.hide();
                      }),
                    this.rowManager.resizeAll();
                }
              },
              ...
              },
              {
                ...
                value: function(t) {
                  this.setOption("bottomLinkCategory", t),
                    this.links
                      .filter(function(t) {
                        return !t.top;
                      })
              ...
              },
              {
                key: "getTagCategories",
                value: function() {
                  var t = this.words.flatMap(function(t) {
                    return t.getTagCategories();
                  });
                  return kr.default.uniq(t);
                }
              },
              {
                key: "setTopTagCategory",
                value: function(t) {
                  this.setOption("topTagCategory", t),
                    this.words.forEach(function(e) {
                      e.setTopTagCategory(t),
                        e.passingLinks.forEach(function(t) {
                          return t.draw();
                        });
                    }),
                    this.taxonomyManager.colour(this.words),
              ...
              },
              {
                key: "setBottomTagCategory",
                value: function(t) {
                  this.setOption("bottomTagCategory", t),
                    this.words.forEach(function(e) {
                      e.setBottomTagCategory(t),
                        e.passingLinks.forEach(function(t) {
                          return t.draw();
                        });
                    }),
              ...
              },
              {
                ...
                value: function(t) {
                  this.setOption("showTopMainLabel", t),
                    t
                      ? this.links
                          .filter(function(t) {
                            return t.top;
              ...
              },
              {
                ...
                value: function(t) {
                  this.setOption("showTopArgLabels", t),
                    t
                      ? this.links
                          .filter(function(t) {
                            return t.top;
              ...
              },
              {
                ...
                value: function(t) {
                  this.setOption("showBottomMainLabel", t),
                    t
                      ? this.links
                          .filter(function(t) {
                            return !t.top;
              ...
              },
              {
                ...
                value: function(t) {
                  this.setOption("showBottomArgLabels", t),
                    t
                      ? this.links
                          .filter(function(t) {
                            return !t.top;
              ...
              },
              {
                ...
                value: function() {
                  var t = this;
                  this.svg.on("row-resize", function(e) {
                    t.labelManager.stopEditing(),
                      t.rowManager.resizeRow(e.detail.object.idx, e.detail.y);
                  }),
                    this.svg.on("word-move-start", function() {
                      t.links.forEach(function(e) {
                        ((e.top && !t.config.showTopLinksOnMove) ||
                          (!e.top && !t.config.showBottomLinksOnMove)) &&
                          e.hide();
                      });
                    }),
                    this.svg.on("word-move", function(e) {
                      t.labelManager.stopEditing(),
                        t.rowManager.moveWordOnRow(e.detail.object, e.detail.x);
                    }),
                    this.svg.on("word-move-end", function() {
                      t.links.forEach(function(e) {
                        ((e.top && e.category === t.config.topLinkCategory) ||
                          (!e.top &&
                            e.category === t.config.bottomLinkCategory)) &&
                          e.show();
                      });
                    });
                }
              },
              {
                ...
                value: function() {
                  var t = this;
                  (0, _r.default)(window).on(
                    "resize",
                    kr.default.throttle(function() {
                      t.resize();
                    }, 50)
                  );
                }
              },
              {
                key: "xLine",
                value: function(t) {
                  this.svg.line(t, 0, t, 1e3).stroke({ width: 1 });
                }
              },
              {
                key: "yLine",
                value: function(t) {
                  this.svg.line(0, t, 1e3, t).stroke({ width: 1 });
                }
              }
            ]),
            t
  ...
  var Pr = t(vr);
  function Or(t) {
    if (!t.container) throw "No TAG container element specified.";
    t.options || (t.options = {});
    var e = new Pr.default(t.container, t.options);
    return t.data && t.format && e.loadData(t.data, t.format), e;
  }
  var Dr = { tag: Or };
  return (Nr.default = Dr), (Nr = { tag: Or });
});
